...
public class FormMixer extends BForm {
    ...
    public VolumeTracker getVolumeTracker(int track) {
        ...
        if ((1 <= track) && (track < vsq.Track.size()) && (0 <= (track - 1)) &&
                ((track - 1) < m_tracker.size())) {
    ...
    private void updateSoloMute() {
        ...
        for (int track = 1; track < vsq.Track.size(); track++) {
            if (soloSpecificationExists) {
                if (vsq.getSolo(track)) {
                    ...
                    m_tracker.get(track - 1)
                             .setMuted(masterMuted ? true : vsq.getMute(track));
                } else {
        ...
        for (int i = 0; i < vsq.BgmFiles.size(); i++) {
            m_tracker.get(offset + i)
                     .setMuted(masterMuted ? true : (vsq.BgmFiles.get(i).mute == 1));
        }
    ...
    public void updateStatus() {
        ...
        int max_num = (int) Math.floor(max_client_width / (VolumeTracker.WIDTH +
                1.0f));
        num++;
        ...
        int num_vtracker_on_panel = vsq.Mixer.Slave.size() +
            AppManager.getBgmCount();
        ...
        for (Iterator<VsqMixerEntry> itr = vsq.Mixer.Slave.iterator();
                itr.hasNext();) {
            ...
            tracker.setSoloButtonVisible(true);
            tracker.setPreferredSize(new Dimension(VolumeTracker.WIDTH,
                    VolumeTracker.HEIGHT));
        ...
        if (num_changed) {
            ...
            scrollSlaves.setPreferredSize(new Dimension(
                    (VolumeTracker.WIDTH + 1) * (screen_num - 1),
                    VolumeTracker.HEIGHT));
    ...
    private void unregisterEventHandlers() {
        ...
        for (int i = 0; i < size; i++) {
            ...
            item.panpotChangedEvent.remove(new PanpotChangedEventHandler(this,
                    "FormMixer_PanpotChanged"));
            item.federChangedEvent.remove(new FederChangedEventHandler(this,
                    "FormMixer_FederChanged"));
            item.muteButtonClickEvent.remove(new BEventHandler(this,
                    "FormMixer_MuteButtonClick"));
            item.soloButtonClickEvent.remove(new BEventHandler(this,
                    "FormMixer_SoloButtonClick"));
        }

        volumeMaster.panpotChangedEvent.remove(new PanpotChangedEventHandler(
                this, "volumeMaster_PanpotChanged"));
        volumeMaster.federChangedEvent.remove(new FederChangedEventHandler(
                this, "volumeMaster_FederChanged"));
        volumeMaster.muteButtonClickEvent.remove(new BEventHandler(this,
                "volumeMaster_MuteButtonClick"));
    }
    ...
    private void reregisterEventHandlers() {
        ...
        for (int i = 0; i < size; i++) {
            VolumeTracker item = m_tracker.get(i);
            item.panpotChangedEvent.add(new PanpotChangedEventHandler(this,
                    "FormMixer_PanpotChanged"));
            item.federChangedEvent.add(new FederChangedEventHandler(this,
                    "FormMixer_FederChanged"));
            item.muteButtonClickEvent.add(new BEventHandler(this,
                    "FormMixer_MuteButtonClick"));
            item.soloButtonClickEvent.add(new BEventHandler(this,
                    "FormMixer_SoloButtonClick"));
        }

        volumeMaster.panpotChangedEvent.add(new PanpotChangedEventHandler(
                this, "volumeMaster_PanpotChanged"));
        volumeMaster.federChangedEvent.add(new FederChangedEventHandler(this,
                "volumeMaster_FederChanged"));
        volumeMaster.muteButtonClickEvent.add(new BEventHandler(this,
                "volumeMaster_MuteButtonClick"));
    }

    private void registerEventHandlers() {
        menuVisualReturn.clickEvent.add(new BEventHandler(this,
                "menuVisualReturn_Click"));
        this.formClosingEvent.add(new BFormClosingEventHandler(this,
                "FormMixer_FormClosing"));
    ...
    public void FormMixer_PanpotChanged(int track, int panpot) {
        try {
            ...
            Logger.write(FormMixer.class + ".FormMixer_PanpotChanged; ex=" +
                ex + "\n");
    ...
    public void FormMixer_SoloButtonClick(Object sender, BEventArgs e) {
        ...
        try {
            ...
            Logger.write(FormMixer.class + ".FormMixer_SoloButtonClick; ex=" +
                ex + "\n");
    ...
    public void FormMixer_MuteButtonClick(Object sender, BEventArgs e) {
        ...
        try {
            ...
            Logger.write(FormMixer.class + ".FormMixer_MuteButtonClick; ex=" +
                ex + "\n");
    ...
    public void volumeMaster_FederChanged(int track, int feder) {
        try {
            ...
            Logger.write(FormMixer.class + ".volumeMaster_FederChanged; ex=" +
                ex + "\n");
    ...
    public void volumeMaster_PanpotChanged(int track, int panpot) {
        try {
            ...
            Logger.write(FormMixer.class + ".volumeMaster_PanpotChanged; ex=" +
                ex + "\n");
    ...
    public void volumeMaster_MuteButtonClick(Object sender, BEventArgs e) {
        try {
            ...
            Logger.write(FormMixer.class +
                ".volumeMaster_MuteButtonClick; ex=" + ex + "\n");
    ...
    */
    ...
    private JScrollPane getScrollSlaves() {
        if (scrollSlaves == null) {
            ...
            scrollSlaves.setViewportBorder(BorderFactory.createEmptyBorder(0,
                    0, 0, 0));
