...
class FormWorkerThread extends Thread {
    ...
    public FormWorkerThread(Object invoker, String method_name,
        FormWorkerJobArgument arg, ProgressBarWithLabel progress_bar,
        double job_amount, int index, FormWorker worker) {
        try {
            mDelegate = new BDelegate(invoker, method_name, Void.TYPE,
                    WorkerState.class, Object.class);
        } catch (Exception ex) {
...
public class FormWorker implements IFormWorkerControl {
    ...
    public void addJob(Object obj, String method_name, String job_description,
        double job_amount, Object argument) {
        // プログレスバーのUIを作成
        ...
        FormWorkerThread worker = new FormWorkerThread(obj, method_name, arg,
