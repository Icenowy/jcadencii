...
public class VsqBPListComparisonContext implements IComparisonContext {
    ...
    public Object getElementAt1(int index) {
        if (index <= 0) {
            ...
            return new WrappedVsqBPPair(list1.getElementB(index - 1),
                list1.getKeyClock(index - 1));
        }
    }
    ...
    public Object getElementAt2(int index) {
        if (index <= 0) {
            ...
            return new WrappedVsqBPPair(list2.getElementB(index - 1),
                list2.getKeyClock(index - 1));
        }
    }
    ...
    public boolean equals(Object obj1, Object obj2) {
        ...
        if (!(obj1 instanceof WrappedVsqBPPair) ||
                !(obj2 instanceof WrappedVsqBPPair)) {
            return false;
        }
