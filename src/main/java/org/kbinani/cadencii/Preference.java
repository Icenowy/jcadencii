...
public class Preference extends BDialog {
    ...
    public Preference() {
        ...
        for (Iterator<VibratoHandle> itr = VocaloSysUtil.vibratoConfigIterator(
        ...
        for (Iterator<VibratoHandle> itr = VocaloSysUtil.vibratoConfigIterator(
                    SynthesizerType.VOCALOID2); itr.hasNext();) {
            VibratoHandle vconfig = itr.next();
        ...
        for (Iterator<ClockResolution> itr = ClockResolutionUtility.iterator();
                itr.hasNext();) {
        ...
        txtVOCALOID1.setText(VocaloSysUtil.getDllPathVsti(
                SynthesizerType.VOCALOID1));
        txtVOCALOID2.setText(VocaloSysUtil.getDllPathVsti(
    ...
    public void applyLanguage() {
        ...
        lblAutoVibratoThresholdLength.setText(gettext(
                "Minimum note length for Automatic Vibrato"));
        lblAutoVibratoThresholdLength.setMnemonic(KeyEvent.VK_M,
            txtAutoVibratoThresholdLength);

        lblAutoVibratoType.setText(gettext("Auto Vibrato Type"));
        groupVocaloidEditorCompatible.setTitle(gettext(
                "VOCALOID Editor Compatible"));
        groupUserDefined.setTitle(gettext("User Defined"));
        radioVocaloidEditorCompatible.setText(gettext(
                "VOCALOID Editor Compatible"));
        ...
        lblBufferSize.setText("msec(" + EditorConfig.MIN_BUFFER_MILLIXEC + "-" +
            EditorConfig.MAX_BUFFER_MILLISEC + ")");
        ...
        chkScrollHorizontal.setText(gettext(
                "Horizontal Scroll when Mouse wheel"));
        chkKeepLyricInputMode.setText(gettext("Keep Lyric Input Mode"));
        chkPlayPreviewWhenRightClick.setText(gettext(
                "Play Preview On Right Click"));
        chkCurveSelectingQuantized.setText(gettext(
                "Enable Quantize for Curve Selecting"));
        chkUseSpaceKeyAsMiddleButtonModifier.setText(gettext(
                "Use space key as Middle button modifier"));
        ...
        checkEnableWideCharacterWorkaround.setText(gettext(
                "Enable Workaround for Wide-Character Path"));

        listSingers.setColumnHeaders(new String[] {
                gettext("Program Change"), gettext("Name"), gettext("Path")
            });
    ...
    public void setBaseFont(java.awt.Font value) {
        m_super_font = value;
        labelMenuFontName.setText(m_super_font.getName());
        UpdateFonts(m_super_font.getName());
    }
    ...
    public void copyResamplersConfig(Vector<String> ret,
        Vector<Boolean> with_wine) {
    ...
    public void setResamplersConfig(Vector<String> path,
        Vector<Boolean> with_wine) {
        ...
        for (int i = 0; i < vec.size(path); i++) {
            listResampler.addRow(new String[] { vec.get(path, i) },
                vec.get(with_wine, i));
        }
    }
    ...
    public void btnOK_Click(Object sender, BEventArgs e) {
        ...
        if (was_modified) {
            AppManager.showMessageBox(gettext(
                    "Restart Cadencii to complete your changes\n(restart will NOT be automatically done)"),
                "Cadencii",
    ...
    public void buttonResamplerAdd_Click(Object sender, BEventArgs e) {
        ...
        if (dr == BFileChooser.APPROVE_OPTION) {
            ...
            if (str.compare(txtWavtool.getText(), "")) {
                ...
                String wavtool = fsys.combine(PortUtil.getDirectoryName(path),
                        "wavtool.exe");
    ...
    public void buttonResamplerUpDown_Click(Object sender, BEventArgs e) {
        int delta = 1;
        ...
        listResampler.setItemAt(index, 0,
            listResampler.getItemAt(index + delta, 0));
        listResampler.setRowChecked(index,
            listResampler.isRowChecked(index + delta));
    ...
    public void buttonResamplerRemove_Click(Object sender, BEventArgs e) {
        int index = listResampler.getSelectedRow();
        int count = listResampler.getItemCountRow();
    ...
    public void btnWavtool_Click(Object sender, BEventArgs e) {
        if (!txtWavtool.getText().equals("") &&
                fsys.isDirectoryExists(PortUtil.getDirectoryName(
                        txtWavtool.getText()))) {
        ...
        if (dr == BFileChooser.APPROVE_OPTION) {
            ...
            if (listResampler.getItemCountRow() == 0) {
                String resampler = fsys.combine(PortUtil.getDirectoryName(path),
                        "resampler.exe");
    ...
    public void btnAquesTone_Click(Object sender, BEventArgs e) {
        ...
        if (!txtAquesTone.getText().equals("") &&
                fsys.isDirectoryExists(PortUtil.getDirectoryName(
                        txtAquesTone.getText()))) {
    ...
    public void listSingers_SelectedIndexChanged(Object sender, BEventArgs e) {
        ...
        if (index < 0) {
            ...
            btnUp.setEnabled((0 <= (index - 1)) &&
                ((index - 1) < m_utau_singers.size()));
            btnDown.setEnabled((0 <= (index + 1)) &&
                ((index + 1) < m_utau_singers.size()));
        }
    }
    ...
    public void btnDown_Click(Object sender, BEventArgs e) {
        ...
        if ((0 <= index) && ((index + 1) < m_utau_singers.size())) {
            ...
            m_utau_singers.set(index,
                (SingerConfig) m_utau_singers.get(index + 1).clone());
    ...
    private void updateMidiDevice() {
        ...
        for (MidiDevice.Info info : midiins) {
    ...
    private void registerEventHandlers() {
        btnChangeScreenFont.clickEvent.add(new BEventHandler(this,
                "btnChangeScreenFont_Click"));
        btnChangeMenuFont.clickEvent.add(new BEventHandler(this,
                "btnChangeMenuFont_Click"));
        btnWavtool.clickEvent.add(new BEventHandler(this, "btnWavtool_Click"));
        buttonResamplerAdd.clickEvent.add(new BEventHandler(this,
                "buttonResamplerAdd_Click"));
        buttonResamplerRemove.clickEvent.add(new BEventHandler(this,
                "buttonResamplerRemove_Click"));
        buttonResamplerUp.clickEvent.add(new BEventHandler(this,
                "buttonResamplerUpDown_Click"));
        buttonResamplerDown.clickEvent.add(new BEventHandler(this,
                "buttonResamplerUpDown_Click"));
        ...
        listSingers.selectedIndexChangedEvent.add(new BEventHandler(this,
                "listSingers_SelectedIndexChanged"));
        chkAutoBackup.checkedChangedEvent.add(new BEventHandler(this,
                "chkAutoBackup_CheckedChanged"));
        btnOK.clickEvent.add(new BEventHandler(this, "btnOK_Click"));
        this.formClosingEvent.add(new BFormClosingEventHandler(this,
                "Preference_FormClosing"));
        btnCancel.clickEvent.add(new BEventHandler(this, "btnCancel_Click"));
        radioVocaloidEditorCompatible.checkedChangedEvent.add(new BEventHandler(
                this, "commonChangeAutoVibratoType"));
        buttonWinePrefix.clickEvent.add(new BEventHandler(this,
                "buttonWinePrefix_Click"));
        buttonWineTop.clickEvent.add(new BEventHandler(this,
                "buttonWineTop_Click"));
        radioWineBuiltin.checkedChangedEvent.add(new BEventHandler(this,
                "radioWineBuiltin_CheckedChanged"));
    }
    ...
    private BGroupBox getGroupUserDefined() {
        if (groupUserDefined == null) {
            ...
            groupUserDefined.setBorder(BorderFactory.createTitledBorder(null,
    ...
    private BPanel getJPanel3() {
        if (jPanel3 == null) {
            ...
            lblAutoVibratoThresholdLength.setText(
                "Minimum note length for Automatic Vibrato");
            jPanel3 = new BPanel();
    ...
    private BPanel getJPanel4() {
        if (jPanel4 == null) {
            ...
            lblAutoVibratoType2.setText("Vibrato Class VOCALOID2");
            ...
            lblAutoVibratoType1.setText("Vibrato Class VOCALOID1");
            jPanel4 = new BPanel();
    ...
    private BGroupBox getGroupFont() {
        if (groupFont == null) {
            ...
            groupFont.setBorder(BorderFactory.createTitledBorder(null, "Font",
                    TitledBorder.DEFAULT_JUSTIFICATION,
                    TitledBorder.DEFAULT_POSITION,
                    new Font("Dialog", Font.BOLD, 12), new Color(51, 51, 51)));
    ...
    private BGroupBox getGroupVisibleCurve() {
        if (groupVisibleCurve == null) {
            ...
            groupVisibleCurve.setBorder(BorderFactory.createTitledBorder(null,
                    "Visible Control Curve",
                    TitledBorder.DEFAULT_JUSTIFICATION,
                    TitledBorder.DEFAULT_POSITION,
                    new Font("Dialog", Font.BOLD, 12), new Color(51, 51, 51)));
    ...
    private BGroupBox getGroupPianoroll() {
        if (groupPianoroll == null) {
            ...
            groupPianoroll.setBorder(BorderFactory.createTitledBorder(null,
                    "Piano Roll", TitledBorder.DEFAULT_JUSTIFICATION,
                    TitledBorder.DEFAULT_POSITION,
                    new Font("Dialog", Font.BOLD, 12), new Color(51, 51, 51)));
            ...
            groupPianoroll.add(getChkPlayPreviewWhenRightClick(),
                gridBagConstraints75);
            groupPianoroll.add(getChkCurveSelectingQuantized(),
                gridBagConstraints76);
            groupPianoroll.add(getChkUseSpaceKeyAsMiddleButtonModifier(),
    ...
    private BCheckBox getChkCurveSelectingQuantized() {
        if (chkCurveSelectingQuantized == null) {
            ...
            chkCurveSelectingQuantized.setText(
                "Enable Quantize for Curve Selecting");
        }
    ...
    private BCheckBox getChkUseSpaceKeyAsMiddleButtonModifier() {
        if (chkUseSpaceKeyAsMiddleButtonModifier == null) {
            ...
            chkUseSpaceKeyAsMiddleButtonModifier.setText(
                "Use space key as Middle button modifier");
        }
    ...
    private BGroupBox getGroupMisc() {
        if (groupMisc == null) {
            ...
            groupMisc.setBorder(BorderFactory.createTitledBorder(null, "Misc",
                    TitledBorder.DEFAULT_JUSTIFICATION,
                    TitledBorder.DEFAULT_POSITION,
                    new Font("Dialog", Font.BOLD, 12), new Color(51, 51, 51)));
    ...
    private BGroupBox getGroupVsti() {
        if (groupVsti == null) {
            ...
            groupVsti.setBorder(BorderFactory.createTitledBorder(null,
                    "VST Instruments", TitledBorder.DEFAULT_JUSTIFICATION,
                    TitledBorder.DEFAULT_POSITION,
                    new Font("Dialog", Font.BOLD, 12), new Color(51, 51, 51)));
    ...
    private BGroupBox getGroupUtauCores() {
        if (groupUtauCores == null) {
            ...
            groupUtauCores.setBorder(BorderFactory.createTitledBorder(null,
                    "UTAU Cores", TitledBorder.DEFAULT_JUSTIFICATION,
                    TitledBorder.DEFAULT_POSITION,
                    new Font("Dialog", Font.BOLD, 12), new Color(51, 51, 51)));
            ...
            groupUtauCores.add(getCheckEnableWideCharacterWorkaround(),
                gridBagConstraints138);
        }
    ...
    private BPanel getTabSingingSynth() {
        if (tabSingingSynth == null) {
            ...
            tabSingingSynth.add(getGroupDefaultSynthesizer(),
                gridBagConstraints145);
        }
    ...
    private BGroupBox getGroupSynthesizerDll() {
        if (groupSynthesizerDll == null) {
            ...
            groupSynthesizerDll.setBorder(BorderFactory.createTitledBorder(
                    null, "Synthesizer DLL Usage",
                    TitledBorder.DEFAULT_JUSTIFICATION,
                    TitledBorder.DEFAULT_POSITION,
                    new Font("Dialog", Font.BOLD, 12), new Color(51, 51, 51)));
    ...
    private BPanel getJPanel11() {
        if (jPanel11 == null) {
            ...
            jPanel11.add(getGroupVocaloidEditorCompatible(),
    ...
    private BGroupBox getGroupVocaloidEditorCompatible() {
        if (groupVocaloidEditorCompatible == null) {
            ...
            groupVocaloidEditorCompatible.setBorder(BorderFactory.createTitledBorder(
                    null, "Auto Vibrato Settings",
                    TitledBorder.DEFAULT_JUSTIFICATION,
                    TitledBorder.DEFAULT_POSITION,
                    new Font("Dialog", Font.BOLD, 12), new Color(51, 51, 51)));
            groupVocaloidEditorCompatible.setTitle("VOCALOID Editor Compatible");
            groupVocaloidEditorCompatible.add(getJPanel31(),
                gridBagConstraints144);
    ...
    private JPanel getJPanel21() {
        if (jPanel21 == null) {
            ...
            jPanel21.add(getRadioVocaloidEditorCompatible(),
                gridBagConstraints1281);
    ...
    private BGroupBox getGroupDefaultSynthesizer() {
        if (groupDefaultSynthesizer == null) {
            ...
            groupDefaultSynthesizer.setBorder(BorderFactory.createTitledBorder(
                    null, "VST Instruments",
                    TitledBorder.DEFAULT_JUSTIFICATION,
                    TitledBorder.DEFAULT_POSITION,
                    new Font("Dialog", Font.BOLD, 12), new Color(51, 51, 51)));
            groupDefaultSynthesizer.setTitle("Default Synthesizer");
            groupDefaultSynthesizer.add(getComboDefaultSynthesizer(),
    ...
    private BGroupBox getGroupWine() {
        if (groupWine == null) {
            ...
            groupWine.setBorder(BorderFactory.createTitledBorder(null,
                    "Platform", TitledBorder.DEFAULT_JUSTIFICATION,
                    TitledBorder.DEFAULT_POSITION,
                    new Font("Dialog", Font.BOLD, 12), new Color(51, 51, 51)));
    ...
    private BCheckBox getCheckEnableWideCharacterWorkaround() {
        if (checkEnableWideCharacterWorkaround == null) {
            ...
            checkEnableWideCharacterWorkaround.setText(
                "Enable Workaround for Wide-Character Path");
        }
