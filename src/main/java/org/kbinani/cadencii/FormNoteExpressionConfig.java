...
public class FormNoteExpressionConfig extends BDialog {
    ...
    public FormNoteExpressionConfig(SynthesizerType type,
        NoteHeadHandle note_head_handle) {
        super();
        initialize();
        ...
        for (Iterator<NoteHeadHandle> itr = VocaloSysUtil.attackConfigIterator(
            ...
            if (item.IconID.equals(icon_id)) {
                comboAttackTemplate.setSelectedItem(comboAttackTemplate.getItemAt(comboAttackTemplate.getItemCount() -
                        1));
            }
        }

        comboAttackTemplate.selectedIndexChangedEvent.add(new BEventHandler(
                this, "comboAttackTemplate_SelectedIndexChanged"));
    ...
    public void applyLanguage() {
        ...
        groupAttack.setTitle(gettext("Attack Control (VOCALOID1)"));
        groupDynamicsControl.setTitle(gettext("Dynamics Control (VOCALOID2)"));
        ...
        setTitle(gettext("Expression control property"));
    }
    ...
    private void registerEventHandlers() {
        ...
        txtDepth.textChangedEvent.add(new BEventHandler(this,
                "txtDepth_TextChanged"));
        txtDuration.textChangedEvent.add(new BEventHandler(this,
                "txtDuration_TextChanged"));
        trackDepth.valueChangedEvent.add(new BEventHandler(this,
                "trackDepth_Scroll"));
        trackDuration.valueChangedEvent.add(new BEventHandler(this,
                "trackDuration_Scroll"));
    ...
    public void comboAttackTemplate_SelectedIndexChanged(Object sender,
        BEventArgs e) {
    ...
    public void txtBendDepth_TextChanged(Object sender, BEventArgs e) {
        try {
            ...
            Logger.write(FormNoteExpressionConfig.class +
                ".txtBendDepth_TextChanged; ex=" + ex + "\n");
        }
    }
    ...
    public void txtBendLength_TextChanged(Object sender, BEventArgs e) {
        try {
            ...
            Logger.write(FormNoteExpressionConfig.class +
                ".txtBendLength_TextChanged; ex=" + ex + "\n");
        }
    }
