...
public class FormCurvePointEdit extends BDialog {
    ...
    public FormCurvePointEdit(FormMain main_window, long editing_id,
        CurveType curve) {
        super();
        initialize();
        ...
        VsqBPPairSearchContext context = AppManager.getVsqFile().Track.get(AppManager.getSelected())
                                                                      .getCurve(m_curve.getName())
                                                                      .findElement(m_editing_id);
    ...
    private void registerEventHandlers() {
        ...
        txtDataPointClock.textChangedEvent.add(new BEventHandler(this,
                "commonTextBox_TextChanged"));
        txtDataPointClock.keyUpEvent.add(new BKeyEventHandler(this,
                "commonTextBox_KeyUp"));
        txtDataPointValue.textChangedEvent.add(new BEventHandler(this,
                "commonTextBox_TextChanged"));
        txtDataPointValue.keyUpEvent.add(new BKeyEventHandler(this,
                "commonTextBox_KeyUp"));
    ...
    public void commonButton_Click(Object sender, BEventArgs e) {
        ...
        txtDataPointClock.textChangedEvent.remove(new BEventHandler(this,
                "commonTextBox_TextChanged"));
        txtDataPointValue.textChangedEvent.remove(new BEventHandler(this,
                "commonTextBox_TextChanged"));
        txtDataPointClock.setText(clock + "");
    ...
    public void handleUndoRedo_Click(Object sender, BEventArgs e) {
        ...
        if (vsq != null) {
            exists = vsq.Track.get(AppManager.getSelected())
                              .getCurve(m_curve.getName())
                              .findElement(m_editing_id).index >= 0;
        }
