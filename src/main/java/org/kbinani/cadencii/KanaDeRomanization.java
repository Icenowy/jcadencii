...
public class KanaDeRomanization {
    ...
    private static String AttachCor(String roman, ByRef<Boolean> trailing) {
        ...
        if (s.equals("a")) {
            return "あ";
        } else if (s.equals("i") || s.equals("yi")) {
            return "い";
        } else if (s.equals("u") || s.equals("wu")) {
            return "う";
        } else if (s.equals("e")) {
            return "え";
        } else if (s.equals("o")) {
            return "お";
        } else if (s.equals("ka") || s.equals("ca")) {
            return "か";
        } else if (s.equals("ki")) {
            return "き";
        } else if (s.equals("ku") || s.equals("cu") || s.equals("qu")) {
            return "く";
        } else if (s.equals("ke")) {
            return "け";
        } else if (s.equals("ko") || s.equals("co")) {
            return "こ";
        } else if (s.equals("sa")) {
            return "さ";
        } else if (s.equals("si") || s.equals("shi") || s.equals("ci")) {
            return "し";
        } else if (s.equals("su")) {
            return "す";
        } else if (s.equals("se") || s.equals("ce")) {
            return "せ";
        } else if (s.equals("so")) {
            return "そ";
        } else if (s.equals("ta")) {
            return "た";
        } else if (s.equals("chi") || s.equals("ti")) {
            return "ち";
        } else if (s.equals("tu") || s.equals("tsu")) {
            return "つ";
        } else if (s.equals("te")) {
            return "て";
        } else if (s.equals("to")) {
            ...
            return "ひ";
        } else if (s.equals("hu") || s.equals("fu")) {
            return "ふ";
        } else if (s.equals("he")) {
            return "へ";
        } else if (s.equals("ho")) {
            ...
            return "を";
        } else if (s.equals("nn") || s.equals("n")) {
            return "ん";
        } else if (s.equals("ga")) {
            return "が";
        } else if (s.equals("gi")) {
            ...
            return "ざ";
        } else if (s.equals("zi") || s.equals("ji")) {
            return "じ";
        } else if (s.equals("zu")) {
            return "ず";
        } else if (s.equals("ze")) {
            ...
            return "しょ";
        } else if (s.equals("cha") || s.equals("tya")) {
            return "ちゃ";
        } else if (s.equals("chu") || s.equals("tyu")) {
            return "ちゅ";
        } else if (s.equals("cho") || s.equals("tyo")) {
            return "ちょ";
            ...
            return "ぎょ";
        } else if (s.equals("zya") || s.equals("ja")) {
            return "じゃ";
        } else if (s.equals("zyu") || s.equals("ju")) {
            return "じゅ";
        } else if (s.equals("zyo") || s.equals("jo")) {
            return "じょ";
            ...
            return "ぴょ";
        } else if (s.equals("la") || s.equals("xa")) {
            return "ぁ";
        } else if (s.equals("li") || s.equals("xi") || s.equals("lyi") ||
                s.equals("xyi")) {
            return "ぃ";
        } else if (s.equals("lu") || s.equals("xu")) {
            return "ぅ";
        } else if (s.equals("le") || s.equals("xe") || s.equals("lye") ||
                s.equals("xye")) {
            return "ぇ";
        } else if (s.equals("lo") || s.equals("xo")) {
            return "ぉ";
        } else if (s.equals("lya") || s.equals("xya")) {
            return "ゃ";
        } else if (s.equals("lyu") || s.equals("xyu")) {
            return "ゅ";
        } else if (s.equals("lyo") || s.equals("xyo")) {
            return "ょ";
        } else if (s.equals("lwa") || s.equals("xwa")) {
            return "ゎ";
        } else if (s.equals("ltu") || s.equals("xtu") || s.equals("xtsu") ||
                s.equals("ltsu")) {
            return "っ";
        } else if (s.equals("va")) {
            return "ゔぁ";
            ...
            return "ゔゅ";
        } else if (s.equals("qq") || s.equals("ww") || s.equals("rr") ||
                s.equals("tt") || s.equals("yy") || s.equals("pp") ||
                s.equals("ss") || s.equals("dd") || s.equals("ff") ||
                s.equals("gg") || s.equals("hh") || s.equals("jj") ||
                s.equals("kk") || s.equals("ll") || s.equals("zz") ||
                s.equals("xx") || s.equals("cc") || s.equals("vv") ||
                s.equals("bb") || s.equals("mm")) {
            trailing.value = true;
            ...
            return "うぉ";
        } else if (s.equals("lka") || s.equals("xka")) {
            return "ヵ";
        } else if (s.equals("lke") || s.equals("xke")) {
            return "ヶ";
            ...
            return "ふぉ";
        } else if (s.equals("fyu") || s.equals("hwyu")) {
            return "ふゅ";
        }
