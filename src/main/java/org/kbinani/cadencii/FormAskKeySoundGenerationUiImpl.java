...
public class FormAskKeySoundGenerationUiImpl extends BDialog
    ...
    private JPanel getJPanel() {
        if (jPanel == null) {
            ...
            lblMessage.setText(
                "It seems some key-board sounds are missing.\nDo you want to re-generate them now?");
    ...
    private JCheckBox getJCheckBox() {
        if (chkAlwaysPerformThisCheck == null) {
            ...
            chkAlwaysPerformThisCheck.setText(
    ...
    public int showDialog(Object parent_form) {
        ...
        if ((parent_form == null) ||
                ((parent_form != null) && !(parent_form instanceof BDialog))) {
