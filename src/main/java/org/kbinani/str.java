...
public class str {
    ...
    public static int split(String s, Vector<String> dst,
        Vector<String> splitter, boolean ignore_empty) {
    ...
    public static int split(String s, Vector<String> dst, String s1,
