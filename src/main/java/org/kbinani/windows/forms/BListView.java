...
public class BListView extends JTable implements KeyListener {
    ...
    private void printData() {
        System.out.println("BListView#printData; mModel.getColumnCount()=" +
            mModel.getColumnCount() + "; mModel.getRowCount()=" +
            mModel.getRowCount());

        for (int row = 0; row < mModel.getRowCount(); row++) {
            for (int column = 0; column < mModel.getColumnCount(); column++) {
                System.out.print(((column == 0) ? "" : ",") + "\"" +
                    mModel.getValueAt(row, column) + "\"");
            }
    ...
    public void setColumnHeaders(String[] headers) {
        System.out.println(
            "BListView#setColumnHeaders; before; width instanceof...");

        for (int i = 0; i < super.getColumnModel().getColumnCount(); i++) {
            TableColumn col = super.getColumnModel().getColumn(i);
            System.out.println("    #" + i + "; " + col.getWidth() +
                "; resizable=" + col.getResizable());
        }
        ...
        //        mModel.get
        System.out.println(
            "BListView#setColumnHeaders; after; width instanceof...");
    ...
    public void setColumnWidth(int column, int width) {
        System.out.println("BListView#setColumnWidth; width=" + width +
            "; before; width=" + getColumnWidth(column));
        this.getColumnModel().getColumn(column + 1).setPreferredWidth(width);
        System.out.println("BListView#setColumnWidth; width=" + width +
            "; after; width=" + getColumnWidth(column));
    }
