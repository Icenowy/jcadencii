...
public class BPictureBox extends JPanel implements MouseListener,
    MouseMotionListener, KeyListener, MouseWheelListener, FocusListener,
    ComponentListener {
    ...
    public void paint(Graphics g1) {
        ...
        if (m_image != null) {
            ...
            g.drawImage(m_image, 0, 0, m_image.getWidth(this),
