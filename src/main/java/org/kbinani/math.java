...
public class math {
    ...
    public static double wnd_flap_top(double x) {
        if ((0.0 <= x) && (x <= 1.0)) {
            ...
            (1.29 * Math.cos(_PI4 * x))) - (0.388 * Math.cos(_PI6 * x)) +
    ...
    public static double wnd_blackman_harris(double x) {
        if ((0.0 <= x) && (x <= 1.0)) {
            ...
            (0.14128 * Math.cos(_PI4 * x))) - (0.01168 * Math.cos(_PI6 * x));
        } else {
            return 0.0;
        }
    }
    ...
    public static double wnd_nuttall(double x) {
        if ((0.0 <= x) && (x <= 1.0)) {
            ...
            (0.144232 * Math.cos(_PI4 * x))) - (0.012604 * Math.cos(_PI6 * x));
        } else {
            return 0.0;
        }
    }
    ...
    public static double wnd_blackman(double x) {
        if ((0.0 <= x) && (x <= 1.0)) {
            return 0.42 - (0.5 * Math.cos(_PI2 * x)) +
            (0.08 * Math.cos(_PI4 * x));
        } else {
            return 0.0;
        }
    }
    ...
    public static double besi0(double x) {
        ...
        double w;
        double wx375;
        double[] a = { 1.0, 3.5156229, 3.0899424, 1.2067492, 0.2659732, 0.0360768 };
        double[] b = {
                0.39894228, 0.013285917, 0.002253187, -0.001575649, 0.009162808,
                -0.020577063, 0.026355372, -0.016476329
            };
    ...
    public enum WindowFunctionType {Hamming,
        rectangular,
        Gauss,
        Hann,
        Blackman,
