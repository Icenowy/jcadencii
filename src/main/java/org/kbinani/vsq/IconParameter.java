...
public class IconParameter implements Serializable {
            ...
            while ((line = sr.readLine()) != null) {
                ...
                if (str.compare(name, "Articulation")) {
                    ...
                    try {
                        ...
                        serr.println("org.kbinani.vsq.IconParameter#.ctor; ex=" +
                            ex);
                    }
    ...
    /// <returns></returns>
    private static VibratoBPList getBPListFromText(String strNum,
        String strBPX, String strBPY) {
        ...
        try {
            ...
            serr.println("org.kbinani.vsq.IconParameter.getBPListFromText; ex=" +
                ex);
            num = 0;
        }
        ...
        if (actNum > 0) {
            ...
            for (int i = 0; i < actNum; i++) {
                try {
                    ...
                    serr.println(
                        "org.kbinani.vsq.IconParameter.getBPListFromText; ex=" +
                        ex);
                }
            }
    ...
    /// アイコン設定の種類を表します。
    /// </summary>
    public enum ArticulationType { /// <summary>
                                   /// ビブラート
                                   /// </summary>
        Vibrato,
