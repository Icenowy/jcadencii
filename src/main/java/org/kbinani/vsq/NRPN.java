...
public class NRPN {
    ...
    /// </summary>
    public static final int CVM_NM_VERSION_AND_DEVICE = 0x5000;

    /// <summary>
    /// (0x5001) Delay in millisec(MSB, LSB)
    /// </summary>
    public static final int CVM_NM_DELAY = 0x5001;

    /// <summary>
    /// (0x5002) Note number(MSB)
    /// </summary>
    public static final int CVM_NM_NOTE_NUMBER = 0x5002;

    /// <summary>
    /// (0x5003) Velocity(MSB)
    /// </summary>
    public static final int CVM_NM_VELOCITY = 0x5003;

    /// <summary>
    /// (0x5004) Note Duration in millisec(MSB, LSB)
    /// </summary>
    public static final int CVM_NM_NOTE_DURATION = 0x5004;

    /// <summary>
    /// (0x5005) Note Location(MSB)
    /// </summary>
    public static final int CVM_NM_NOTE_LOCATION = 0x5005;

    /// <summary>
    /// (0x5006) Attack Type(MSB, LSB)
    /// </summary>
    public static final int CVM_NM_ATTACK_TYPE = 0x5006;

    /// <summary>
    /// (0x5007) Attack Duration in millisec(MSB, LSB)
    /// </summary>
    public static final int CVM_NM_ATTACK_DURATION = 0x5007;

    /// <summary>
    /// (0x5008) Attack Depth(MSB)
    /// </summary>
    public static final int CVM_NM_ATTACK_DEPTH = 0x5008;

    /// <summary>
    /// (0x500c) Index of Vibrato DB(MSB: ID_H00, LSB:ID_L00)
    /// </summary>
    public static final int CVM_NM_INDEX_OF_VIBRATO_DB = 0x500c;

    /// <summary>
    /// (0x500d) Vibrato configuration(MSB: Index of Vibrato Type, LSB: Duration &amp;, Configuration parameter of vibrato)
    /// </summary>
    public static final int CVM_NM_VIBRATO_CONFIG = 0x500d;

    /// <summary>
    /// (0x500e) Vibrato Delay(MSB)
    /// </summary>
    public static final int CVM_NM_VIBRATO_DELAY = 0x500e;
    ...
    /// </summary>
    public static final int CVM_EXNM_ENV_DATA1 = 0x507e;

    /// <summary>
    /// (0x507d) Extended Note message; Envelope: value2(MSB, LSB)
    /// </summary>
    public static final int CVM_EXNM_ENV_DATA2 = 0x507d;

    /// <summary>
    /// (0x507c) Extended Note message; Envelope: value3(MSB)
    /// </summary>
    public static final int CVM_EXNM_ENV_DATA3 = 0x507c;

    /// <summary>
    /// (0x507b) Extended Note message; Envelope: data point continuation(MSB)(MSB, 0x7f=end, 0x00=continue)
    /// </summary>
    public static final int CVM_EXNM_ENV_DATA_CONTINUATION = 0x507b;

    /// <summary>
    /// (0x6000) Version number &amp;, Device number(MSB, LSB)
    /// </summary>
    public static final int CC_BS_VERSION_AND_DEVICE = 0x6000;

    /// <summary>
    /// (0x6001) Delay in millisec(MSB, LSB)
    /// </summary>
    public static final int CC_BS_DELAY = 0x6001;

    /// <summary>
    /// (0x6002) Laugnage type(MSB, optional LSB)
    /// </summary>
    public static final int CC_BS_LANGUAGE_TYPE = 0x6002;

    /// <summary>
    /// (0x6100) Version number &amp;, device number(MSB, LSB)
    /// </summary>
    public static final int CC_CV_VERSION_AND_DEVICE = 0x6100;

    /// <summary>
    /// (0x6101) Delay in millisec(MSB, LSB)
    /// </summary>
    public static final int CC_CV_DELAY = 0x6101;

    /// <summary>
    /// (0x6102) Volume value(MSB)
    /// </summary>
    public static final int CC_CV_VOLUME = 0x6102;

    /// <summary>
    /// (0x6200) Version number &amp;, device number(MSB, LSB)
    /// </summary>
    public static final int CC_P_VERSION_AND_DEVICE = 0x6200;

    /// <summary>
    /// (0x6201) Delay in millisec(MSB, LSB)
    /// </summary>
    public static final int CC_P_DELAY = 0x6201;

    /// <summary>
    /// (0x6202) Pan value(MSB)
    /// </summary>
    public static final int CC_PAN = 0x6202;

    /// <summary>
    /// (0x6300) Version number &amp;, device number(MSB, LSB)
    /// </summary>
    public static final int CC_E_VESION_AND_DEVICE = 0x6300;

    /// <summary>
    /// (0x6301) Delay in millisec(MSB, LSB)
    /// </summary>
    public static final int CC_E_DELAY = 0x6301;

    /// <summary>
    /// (0x6302) Expression vlaue(MSB)
    /// </summary>
    public static final int CC_E_EXPRESSION = 0x6302;

    /// <summary>
    /// (0x6400) Version number &amp;, device number(MSB, LSB)
    /// </summary>
    public static final int CC_VR_VERSION_AND_DEVICE = 0x6400;

    /// <summary>
    /// (0x6401) Delay in millisec(MSB, LSB)
    /// </summary>
    public static final int CC_VR_DELAY = 0x6401;

    /// <summary>
    /// (0x6402) Vibrato Rate value(MSB)
    /// </summary>
    public static final int CC_VR_VIBRATO_RATE = 0x6402;

    /// <summary>
    /// (0x6500) Version number &amp;, device number(MSB, LSB)
    /// </summary>
    public static final int CC_VD_VERSION_AND_DEVICE = 0x6500;

    /// <summary>
    /// (0x6501) Delay in millisec(MSB, LSB)
    /// </summary>
    public static final int CC_VD_DELAY = 0x6501;

    /// <summary>
    /// (0x6502) Vibrato Depth value(MSB)
    /// </summary>
    public static final int CC_VD_VIBRATO_DEPTH = 0x6502;

    /// <summary>
    /// (0x6600) Version number &amp;, device number(MSB, LSB)
    /// </summary>
    public static final int CC_FX2_VERSION_AND_DEVICE = 0x6600;

    /// <summary>
    /// (0x6601) Delay in millisec(MSB, LSB)
    /// </summary>
    public static final int CC_FX2_DELAY = 0x6601;

    /// <summary>
    /// (0x6602) Effect2 Depth(MSB)
    /// </summary>
    public static final int CC_FX2_EFFECT2_DEPTH = 0x6602;

    /// <summary>
    /// (0x6700) Version number &amp;, device number(MSB, LSB)
    /// </summary>
    public static final int CC_PBS_VERSION_AND_DEVICE = 0x6700;

    /// <summary>
    /// (0x6701) Delay in millisec(MSB, LSB)
    /// </summary>
    public static final int CC_PBS_DELAY = 0x6701;

    /// <summary>
    /// (0x6702) Pitch Bend Sensitivity(MSB, LSB)
    /// </summary>
    public static final int CC_PBS_PITCH_BEND_SENSITIVITY = 0x6702;

    /// <summary>
    /// (0x5300) Version number &amp;, device number(MSB, LSB)
    /// </summary>
    public static final int PC_VERSION_AND_DEVICE = 0x5300;

    /// <summary>
    /// (0x5301) Delay in millisec(MSB, LSB)
    /// </summary>
    public static final int PC_DELAY = 0x5301;

    /// <summary>
    /// (0x5302) Voice Type(MSB)
    /// </summary>
    public static final int PC_VOICE_TYPE = 0x5302;

    /// <summary>
    /// (0x5400) Version number &amp;, device number(MSB, LSB)
    /// </summary>
    public static final int PB_VERSION_AND_DEVICE = 0x5400;

    /// <summary>
    /// (0x5401) Delay in millisec(MSB, LSB)
    /// </summary>
    public static final int PB_DELAY = 0x5401;

    /// <summary>
    /// (0x5402) Pitch Bend value(MSB, LSB)
    /// </summary>
    public static final int PB_PITCH_BEND = 0x5402;

    /// <summary>
    /// (0x5500) Version number &amp;, device number(MSB, LSB)
    /// </summary>
    public static final int VCP_VERSION_AND_DEVICE = 0x5500;

    /// <summary>
    /// (0x5501) Delay in millisec(MSB, LSB)
    /// </summary>
    public static final int VCP_DELAY = 0x5501;

    /// <summary>
    /// (0x5502) Voice Change Parameter ID(MSB)
    /// </summary>
    public static final int VCP_VOICE_CHANGE_PARAMETER_ID = 0x5502;

    /// <summary>
    /// (0x5503) Voice Change Parameter value(MSB)
    /// </summary>
    public static final int VCP_VOICE_CHANGE_PARAMETER = 0x5503;
    ...
    public static String getName(int nrpn) {
        for (Iterator<ValuePair<String, Integer>> itr = iterator();
                itr.hasNext();) {
    ...
    public static byte getVoiceChangeParameterID(String curve_name) {
        byte lsb = 0x31;
        curve_name = curve_name.toLowerCase();
