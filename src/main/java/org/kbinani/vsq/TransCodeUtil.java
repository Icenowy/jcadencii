...
public class TransCodeUtil {
    private static final byte[] MAP_L = new byte[] {
            0xA, 0xB, 0x8, 0x9, 0xE, 0xF, 0xC, 0xD, 0x2, 0x3, 0x0, 0x1, 0x6, 0x7,
            0x4, 0x5
        };
    private static final byte[] MAP_R = new byte[] {
            0x1, 0x0, 0x3, 0x2, 0x5, 0x4, 0x7, 0x6, 0x9, 0x8, 0xB, 0xA, 0xD, 0xC,
            0xF, 0xE
        };
