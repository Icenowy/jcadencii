...
public class VsqCommand implements Serializable {
    ...
    public static VsqCommand generateCommandTrackReplace(int track,
        VsqTrack item) {
        VsqCommand command = new VsqCommand();
    ...
    public static VsqCommand generateCommandUpdateTimesig(int bar_count,
        int new_barcount, int numerator, int denominator) {
        VsqCommand command = new VsqCommand();
    ...
    public static VsqCommand generateCommandUpdateTimesigRange(
        int[] bar_counts, int[] new_barcounts, int[] numerators,
        int[] denominators) {
        VsqCommand command = new VsqCommand();
    ...
    public static VsqCommand generateCommandUpdateTempoRange(int[] clocks,
        int[] new_clocks, int[] tempos) {
        VsqCommand command = new VsqCommand();
    ...
    public static VsqCommand generateCommandUpdateTempo(int clock,
        int new_clock, int tempo) {
        VsqCommand command = new VsqCommand();
    ...
    /// <returns></returns>
    public static VsqCommand generateCommandAddTrack(VsqTrack track,
        VsqMixerEntry mixer, int position) {
        VsqCommand command = new VsqCommand();
    ...
    /// <returns></returns>
    public static VsqCommand generateCommandTrackChangeName(int track,
        String new_name) {
        VsqCommand command = new VsqCommand();
    ...
    public static VsqCommand generateCommandTrackChangePlayMode(int track,
        int play_mode, int last_play_mode) {
        VsqCommand command = new VsqCommand();
    ...
    /// <returns></returns>
    public static VsqCommand generateCommandEventChangeClockAndIDContaintsRange(
        int track, int[] internal_ids, int[] clocks, VsqID[] values) {
        VsqCommand command = new VsqCommand();
    ...
    /// <returns></returns>
    public static VsqCommand generateCommandEventChangeClockAndIDContaints(
        int track, int internal_id, int clock, VsqID value) {
        VsqCommand command = new VsqCommand();
    ...
    public static VsqCommand generateCommandEventChangeIDContaintsRange(
        int track, int[] internal_ids, VsqID[] values) {
        VsqCommand command = new VsqCommand();
    ...
    /// <param name="value"></param>
    /// <returns></returns>
    public static VsqCommand generateCommandEventChangeIDContaints(int track,
        int internal_id, VsqID value) {
        VsqCommand command = new VsqCommand();
    ...
    /// <returns></returns>
    public static VsqCommand generateCommandEventChangeClockAndLength(
    ...
    /// <param name="new_length"></param>
    /// <returns></returns>
    public static VsqCommand generateCommandEventChangeLength(int track,
        int internal_id, int new_length) {
        VsqCommand command = new VsqCommand();
    ...
    /// <returns></returns>
    public static VsqCommand generateCommandEventChangeVelocity(int track,
        Vector<ValuePair<Integer, Integer>> velocity) {
        VsqCommand command = new VsqCommand();
        ...
        for (Iterator<ValuePair<Integer, Integer>> itr = velocity.iterator();
                itr.hasNext();) {
            ValuePair<Integer, Integer> item = itr.next();
            list.add(new ValuePair<Integer, Integer>(item.getKey(),
                    item.getValue()));
        }
    ...
    public static VsqCommand generateCommandEventReplace(int track,
        VsqEvent item) {
        VsqCommand command = new VsqCommand();
    ...
    public static VsqCommand generateCommandEventReplaceRange(int track,
        VsqEvent[] items) {
        VsqCommand command = new VsqCommand();
    ...
    /// <returns></returns>
    public static VsqCommand generateCommandEventChangeAccent(int track,
        Vector<ValuePair<Integer, Integer>> accent_list) {
        VsqCommand command = new VsqCommand();
        ...
        for (Iterator<ValuePair<Integer, Integer>> itr = accent_list.iterator();
                itr.hasNext();) {
            ValuePair<Integer, Integer> item = itr.next();
            list.add(new ValuePair<Integer, Integer>(item.getKey(),
                    item.getValue()));
    ...
    /// <returns></returns>
    public static VsqCommand generateCommandEventChangeDecay(int track,
        Vector<ValuePair<Integer, Integer>> decay_list) {
        VsqCommand command = new VsqCommand();
        ...
        for (Iterator<ValuePair<Integer, Integer>> itr = decay_list.iterator();
                itr.hasNext();) {
            ValuePair<Integer, Integer> item = itr.next();
            list.add(new ValuePair<Integer, Integer>(item.getKey(),
                    item.getValue()));
    ...
    public static VsqCommand generateCommandTrackCurveReplaceRange(int track,
        String[] target_curve, VsqBPList[] bplist) {
        VsqCommand command = new VsqCommand();
    ...
    public static VsqCommand generateCommandTrackCurveReplace(int track,
        String target_curve, VsqBPList bplist) {
        VsqCommand command = new VsqCommand();
    ...
    /// <returns></returns>
    public static VsqCommand generateCommandTrackCurveEdit(int track,
        String target, Vector<BPPair> edit) {
        VsqCommand command = new VsqCommand();
    ...
    /// <returns></returns>
    public static VsqCommand generateCommandTrackCurveEdit2(int track,
        String target, Vector<Long> delete, TreeMap<Integer, VsqBPPair> add) {
        VsqCommand command = new VsqCommand();
    ...
    public static VsqCommand generateCommandTrackCurveEditRange(int track,
        Vector<String> targets, Vector<Vector<BPPair>> edits) {
        VsqCommand command = new VsqCommand();
    ...
    /// <param name="add_or_move">追加または移動を行うデータ点のリスト</param>
    /// <returns></returns>
    public static VsqCommand generateCommandTrackCurveEdit2All(int track,
        Vector<String> target, Vector<Vector<Long>> delete,
        Vector<TreeMap<Integer, VsqBPPair>> add) {
        VsqCommand command = new VsqCommand();
        ...
        for (int i = 0; i < c; i++) {
            ...
            for (Iterator<Integer> itr = tmp.keySet().iterator();
                    itr.hasNext();) {
                int clock = itr.next();
    ...
    /// <returns></returns>
    public static VsqCommand generateCommandEventChangeLyric(int track,
        int internal_id, String phrase, String phonetic_symbol,
        boolean protect_symbol) {
        VsqCommand command = new VsqCommand();
    ...
    /// <param name="value"></param>
    /// <returns></returns>
    public static VsqCommand generateCommandEventChangeClock(int track,
        int internal_id, int value) {
        VsqCommand command = new VsqCommand();
    ...
    public static VsqCommand generateCommandEventDeleteRange(int track,
        Vector<Integer> internal_ids) {
        VsqCommand command = new VsqCommand();
    ...
    /// <param name="clock"></param>
    /// <returns></returns>
    public static VsqCommand generateCommandEventDelete(int track,
        int internal_id) {
        VsqCommand command = new VsqCommand();
    ...
    public static VsqCommand generateCommandEventAddRange(int track,
        VsqEvent[] items) {
        VsqCommand command = new VsqCommand();
    ...
    /// <param name="value"></param>
    /// <returns></returns>
    public static VsqCommand generateCommandEventChangeNote(int track,
        int internal_id, int note) {
        VsqCommand command = new VsqCommand();
    ...
    /// <param name="value"></param>
    /// <returns></returns>
    public static VsqCommand generateCommandEventChangeClockAndNote(int track,
        int internal_id, int clock, int note) {
        VsqCommand command = new VsqCommand();
