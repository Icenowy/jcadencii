    ...
    public void read(long index, int length, double[] left, double[] right)
        ...
        if (bRate == aRate) {
            ...
            while (aProcessed < length) {
                int bIndexStart = (int) (((double) bRate * (double) (index +
                    aProcessed)) / (double) aRate);
                int bIndexEnd = (int) (((double) bRate * (double) (index +
                    length)) / (double) aRate) + 1;
                ...
                while (true) {
                    int bIndexRequired = (int) (((double) bRate * (double) (index +
                        aProcessed)) / (double) aRate);
