...
public class BEventHandler {
    ...
    protected BEventHandler(Class<?> invoker, String method_name,
        Class<?> return_type, Class<?> arg1, Class<?> arg2) {
        try {
            m_delegate = new BDelegate(invoker, method_name, return_type, arg1,
                    arg2);
        } catch (Exception ex) {
    ...
    protected BEventHandler(Object invoker, String method_name,
        Class<?> return_type, Class<?> arg1, Class<?> arg2) {
        //m_invoker = invoker;
        try {
            m_delegate = new BDelegate(invoker, method_name, return_type, arg1,
