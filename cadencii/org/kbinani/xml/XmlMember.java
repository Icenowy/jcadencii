...
public class XmlMember {
     ...
     */
    private static Class<?>[] ignoreRecursiveMemberExtraction = new Class<?>[] {
            Object.class, Rectangle.class, Rectangle2D.class, Point.class,
            Point2D.class
        };
     ...
     */
    private static <T extends Annotation> T getMethodAnnotationRecurse(
     ...
     * @return アノテーションが見つかればアノテーションのインスタンス，見つからなければnull
     */
    private static <T extends Annotation> T getFieldAnnotationRecurse(Field f,
        Class<T> annotation) {
    ...
    public static XmlMember[] extractMembers(Class<?> t) {
        ...
        for (Method method : t.getMethods()) {
            ...
            } else if (name.startsWith("instanceof")) {
    ...
    public static XmlMember extract(Class<?> cls, String property_name) {
        ...
        for (Method method : cls.getMethods()) {
            ...
            if (name.startsWith("set") && (setter == null)) {
                ...
                setter = method;
            } else if (name.startsWith("instanceof") && (getter == null)) {
                ...
                if (setter != null) {
                    ...
                    if (!ret_type.equals(Boolean.TYPE) ||
                            !ret_type.equals(Boolean.class)) {
                        return null;
                    }
                }
