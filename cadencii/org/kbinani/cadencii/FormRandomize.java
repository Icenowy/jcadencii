...
public class FormRandomize extends BDialog {
    ...
    private void validateNumRange() {
        ...
        int startClock = startBarClock +
            ((startBeat * 480 * 4) / startTimesig.denominator); // 第startBar小節の第startBeat拍開始位置のゲートタイム
    ...
    private void registerEventHandlers() {
        ...
        numStartBar.valueChangedEvent.add(new BEventHandler(this,
                "numCommon_ValueChanged"));
        numStartBeat.valueChangedEvent.add(new BEventHandler(this,
                "numCommon_ValueChanged"));
        numEndBar.valueChangedEvent.add(new BEventHandler(this,
                "numCommon_ValueChanged"));
        numEndBeat.valueChangedEvent.add(new BEventHandler(this,
                "numCommon_ValueChanged"));
        chkShift.checkedChangedEvent.add(new BEventHandler(this,
                "chkShift_CheckedChanged"));
        chkPit.checkedChangedEvent.add(new BEventHandler(this,
                "chkPit_CheckedChanged"));
    }
