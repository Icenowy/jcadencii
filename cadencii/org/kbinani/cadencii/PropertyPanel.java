...
public class PropertyPanel extends BPanel {
    public final BEvent<CommandExecuteRequiredEventHandler> commandExecuteRequiredEvent =
        new BEvent<CommandExecuteRequiredEventHandler>();
    ...
    public void propertyGrid_PropertyValueChanged(Object s,
        BPropertyValueChangedEventArgs e) {
        ...
        try {
            ...
            serr.println(PropertyPanel.class +
                ".propertyGridPropertyValueChanged; ex=" + ex);
        }
    ...
    private void registerEventHandlers() {
        ...
        propertyGrid.propertyValueChangedEvent.add(new BPropertyValueChangedEventHandler(
                this, "propertyGrid_PropertyValueChanged"));
    }
    ...
    private void initialize() {
        if (propertyGrid == null) {
            ...
            ve.ID = new VsqID();
            propertyGrid.setSelectedObjects(new SelectedEventEntry[] {
                    new SelectedEventEntry(0, ve, ve)
                });
