...
public class TrackSelector extends BPanel {
    ...
    /// ベジエ曲線の制御点の枠色
    /// </summary>
    private static final Color COLOR_BEZIER_DOT_NORMAL_DARK = new Color(153,
            19, 70);
    ...
    private static final Color COLOR_A244R255G023B012 = new Color(255, 23, 12,
            244);
    private static final Color COLOR_A144R255G255B255 = new Color(255, 255,
            255, 144);
    private static final Color COLOR_A072R255G255B255 = new Color(255, 255,
            255, 72);
    private static final Color COLOR_A127R008G166B172 = new Color(8, 166, 172,
            127);
    ...
    /// </summary>
    private static final Color COLOR_SINGERBOX_BORDER_HILIGHT = new Color(246,
            251, 10);
    ...
    /// TrackSelectorの推奨表示高さは，HEIGHT_WITHOUT_CURVE + UNIT_HEIGHT_PER_CURVE * (カーブの個数)となる
    /// </summary>
    static final int HEIGHT_WITHOUT_CURVE = (OFFSET_TRACK_TAB * 2) +
        UNIT_HEIGHT_PER_CURVE;
    ...
    public TrackSelector(FormMain main_window) {
        ...
        setResources();
        mModifierKey = InputEvent.CTRL_MASK;
    ...
    private CurveType getCurveTypeFromMenu(BMenuItem menu) {
        for (Iterator<CurveType> itr = mMenuMap.keySet().iterator();
                itr.hasNext();) {
    ...
    public int getPreferredMinSize() {
        return HEIGHT_WITHOUT_CURVE +
        (UNIT_HEIGHT_PER_CURVE * getRowsPerColumn());
    }
    ...
    public Rectangle getRectFromCurveType(CurveType curve) {
        ...
        int y = centre - ((row_per_column * UNIT_HEIGHT_PER_CURVE) / 2) + 2 +
            (UNIT_HEIGHT_PER_CURVE * iy);
    ...
    public void paint(Graphics graphics) {
        ...
        g.fillRect(0, size.height - (2 * OFFSET_TRACK_TAB), size.width,
            2 * OFFSET_TRACK_TAB);
        ...
        try {
            ...
            g.drawLine(0, size.height - (2 * OFFSET_TRACK_TAB), size.width - 0,
                size.height - (2 * OFFSET_TRACK_TAB));
            g.setFont(AppManager.superFont8);
            g.setColor(brs_string);
            g.drawString("SINGER", 9,
                (size.height - (2 * OFFSET_TRACK_TAB) + (OFFSET_TRACK_TAB / 2)) -
                AppManager.superFont8OffsetHeight);
            ...
            if (vsq_track != null) {
                ...
                if (singer_at_left != null) {
                    Rectangle rc = new Rectangle(x_at_left, ycoord,
                    ...
                    g.setColor(brs_string);
                    g.drawString(singer_at_left.ID.IconHandle.IDS, rc.x,
                        (rc.y + (OFFSET_TRACK_TAB / 2)) -
                        AppManager.superFont8OffsetHeight);
                }
                ...
                for (int i = 0; i < event_count; i++) {
                    ...
                    Rectangle rc = new Rectangle(x, ycoord, SINGER_ITEM_WIDTH,
                            OFFSET_TRACK_TAB - 2);
                    ...
                    g.drawRect(rc.x, rc.y, rc.width, rc.height);
                    g.setColor(brs_string);
                    g.drawString(singer_handle.IDS, rc.x,
                        (rc.y + (OFFSET_TRACK_TAB / 2)) -
                        AppManager.superFont8OffsetHeight);
                }
            }
            ...
            g.setColor(AppManager.COLOR_BORDER);
            g.drawLine(0, size.height - OFFSET_TRACK_TAB, size.width,
                size.height - OFFSET_TRACK_TAB);
            g.setColor(brs_string);
            g.drawString("TRACK", 9,
                (size.height - OFFSET_TRACK_TAB + (OFFSET_TRACK_TAB / 2)) -
                AppManager.superFont8OffsetHeight);
            ...
            if (vsq != null) {
                for (int i = 0; i < 16; i++) {
                    ...
                    drawTrackTab(g,
                        new Rectangle(x, size.height - OFFSET_TRACK_TAB + 1,
                            selecter_width, OFFSET_TRACK_TAB - 1),
                        ((i + 1) < vsq.Track.size())
                        ? ((i + 1) + " " + vsq.Track.get(i + 1).getName()) : "",
                        (i == (selected - 1)),
                        vsq_track.getCommon().PlayMode >= 0,
                        AppManager.getRenderRequired(i + 1),
                        AppManager.HILIGHT[i], AppManager.RENDER[i]);
                }
            }
            ...
            if (mCurveVisible) {
                ...
                g.drawLine(key_width, size.height - 42, size.width - 3,
                    size.height - 42);

                // カーブエディタの上の線
                g.setColor(new Color(46, 47, 50));
                g.drawLine(key_width, HEADER, size.width - 3, HEADER);

                g.setColor(new Color(125, 123, 124));
                g.drawLine(key_width, 0, key_width, size.height - 1);
                ...
                if (vsq != null) {
                    ...
                    for (Iterator<VsqBarLineType> itr = vsq.getBarLineIterator(
                        ...
                        if (blt.isSeparator()) {
                            ...
                            g.setColor(pen);
                            g.drawLine(x, 8, x, 14);
                            g.drawLine(x, size.height - 43, x,
                                size.height - 42 - 6);
                        }

                        if ((dashed_line_step > 1) &&
                                AppManager.isGridVisible()) {
                            ...
                            for (int i = 1; i < numDashedLine; i++) {
                                ...
                                g.drawLine(x2, size.height - 43, x2,
                                    size.height - 43 - 4);
                            }
                        }
                    }
                ...
                if (vsq_track != null) {
                    ...
                    Color front = new Color(color.getRed(), color.getGreen(),
                            color.getBlue(), 150);
                    Color back = new Color(255, 249, 255, 44);
                    Color vel_color = new Color(64, 78, 30);

                    // 後ろに描くカーブ
                    if (mLastSelectedCurve.equals(CurveType.VEL) ||
                            mLastSelectedCurve.equals(CurveType.Accent) ||
                            mLastSelectedCurve.equals(CurveType.Decay)) {
                        drawVEL(g, vsq_track, back, false, mLastSelectedCurve);
                    } else if (mLastSelectedCurve.equals(CurveType.VibratoRate) ||
                            mLastSelectedCurve.equals(CurveType.VibratoDepth)) {
                        drawVibratoControlCurve(g, vsq_track,
                            mLastSelectedCurve, back, false);
                    } else {
                    ...
                    if (mSelectedCurve.equals(CurveType.VEL) ||
                    ...
                    } else if (mSelectedCurve.equals(CurveType.VibratoRate) ||
                            mSelectedCurve.equals(CurveType.VibratoDepth)) {
                        drawVibratoControlCurve(g, vsq_track, mSelectedCurve,
                            front, true);
                        ...
                        if (mSelectedCurve.equals(CurveType.PIT)) {
                            ...
                            Stroke dash_stroke = new BasicStroke(1.0f, 0, 0,
                            ...
                            if ((clock_start < premeasure) &&
                                    (premeasure < clock_end)) {
                        ...
                        drawAttachedCurve(g,
                            vsq.AttachedCurves.get(AppManager.getSelected() -
                                1).get(mSelectedCurve));
                    }
                }

                if (AppManager.isWholeSelectedIntervalEnabled()) {
                    int start = AppManager.xCoordFromClocks(AppManager.mWholeSelectedInterval.getStart()) +
                        2;
                    int end = AppManager.xCoordFromClocks(AppManager.mWholeSelectedInterval.getEnd()) +
                        2;
                ...
                if (mMouseDowned) {
                    ...
                    if (tool == EditTool.LINE) {
                        if (mMouseTracer.size() > 0) {
                            ...
                            g.drawLine(xini, yini,
                                AppManager.xCoordFromClocks(clock_at_mouse),
                                yCoordFromValue(value));
                            g.setStroke(getStrokeDefault());
                        }
                    } else if (tool == EditTool.PENCIL) {
                        if ((mMouseTracer.size() > 0) &&
                                !AppManager.isCurveMode()) {
                            ...
                            (tool == EditTool.ARROW)) {
                        if ((mMouseDownMode == MouseDownMode.CURVE_EDIT) &&
                                mMouseMoved &&
                                (AppManager.mCurveSelectingRectangle.width != 0)) {
                            int xini = AppManager.xCoordFromClocks(AppManager.mCurveSelectingRectangle.x);
                            int xend = AppManager.xCoordFromClocks(AppManager.mCurveSelectingRectangle.x +
                                    AppManager.mCurveSelectingRectangle.width);
                            ...
                            int yend = yCoordFromValue(AppManager.mCurveSelectingRectangle.y +
                                    AppManager.mCurveSelectingRectangle.height);
                            ...
                            if (y_end > (height - 42 - 8)) {
                                y_end = height - 42;
                            }

                            if (x_start < x_end) {
                                g.setColor(COLOR_A144R255G255B255);
                                g.fillRect(x_start, y_start, x_end - x_start,
                                    y_end - y_start);
                            }
                        } else if ((mMouseDownMode == MouseDownMode.VEL_EDIT) &&
                                mVelEditSelected.containsKey(
                                    mVelEditLastSelectedID)) {
                            if (mSelectedCurve.equals(CurveType.VEL)) {
                    ...
                    if ((mMouseDownMode == MouseDownMode.SINGER_LIST) &&
                        ...
                        for (Iterator<SelectedEventEntry> itr = AppManager.itemSelection.getEventIterator();
                            ...
                            g.drawRect(x,
                                size.height - (2 * OFFSET_TRACK_TAB) + 1,
                                SINGER_ITEM_WIDTH, OFFSET_TRACK_TAB - 2);
                        }
                    }
                }
            ...
            if (mCurveVisible) {
                ...
                g.fillRect(0, 0, key_width, size.height -
                    (2 * OFFSET_TRACK_TAB));
                ...
                String name = (is_utau_mode &&
                    mSelectedCurve.equals(CurveType.VEL)) ? "INT"
                                                          : mSelectedCurve.getName();
                g.drawString(name, 7,
                    (text_font_height / 2) - text_font_offset + 1);
                ...
                for (int i = 0; i < mViewingCurves.size(); i++) {
                    ...
                    if (curve.equals(mSelectedCurve) ||
                            curve.equals(mLastSelectedCurve)) {
                    ...
                    int rc_str_x = rc.x + 2;
                    int rc_str_y = (rc.y + (text_font_height / 2)) -
                        text_font_offset + 1;
            ...
            // マウス位置での値
            if (isInRect(mouse.x, mouse.y,
                        new Rectangle(key_width, HEADER, width, graph_height)) &&
                ...
                g.setColor(Color.white);
                PortUtil.drawStringEx(g, mMouseValue + "",
                ...
                if (mSelectedCurve.equals(CurveType.PIT)) {
                    ...
                    PortUtil.drawStringEx(g,
                        ...
                        AppManager.superFont10Bold,
                        new Rectangle(mouse.x - 100, mouse.y, 100, 100), align,
                        valign);
                }
            }
        } catch (Exception ex) {
    ...
    private void drawEnvelope(Graphics2D g, int track_index, Color fill_color) {
        ...
        while (true) {
            ...
            Polygon points = getEnvelopePoints(vsq.TempoTable, prev_item, item,
                    next_item, preutterance, overlap);

            if ((mMouseDownMode == MouseDownMode.ENVELOPE_MOVE) &&
                    (item.InternalID == mEnvelopeEdigintID)) {
                selected_point = new Point(points.xpoints[mEnvelopePointKind],
                        points.ypoints[mEnvelopePointKind]);
                selected_found = true;
            }
            ...
            // 先行発音
            if (!draw_env_points) {
                if ((mMouseDownMode == MouseDownMode.PRE_UTTERANCE_MOVE) &&
                        (item.InternalID == mPreUtteranceEditingID)) {
                    draw_env_points = true;
                }
            }
            ...
            // オーバーラップ
            if (!draw_env_points) {
                if ((mMouseDownMode == MouseDownMode.OVERLAP_MOVE) &&
                        (item.InternalID == mOverlapEditingID)) {
                    draw_env_points = true;
                }
            }
            ...
            if (!draw_env_points) {
                if (search_mouse) {
                    if (((points.xpoints[0] - tolerance) <= mouse.x) &&
                            (mouse.x <= (points.xpoints[points.npoints - 1] +
                            tolerance))) {
                        draw_env_points = true;
                    }
                }
            ...
            if (!draw_env_points && search_sel) {
                if (AppManager.itemSelection.isEventContains(track_index,
                            item.InternalID)) {
                    draw_env_points = true;
                }
            }
            ...
            if (draw_env_points) {
                ...
                for (int i = 1; i < 6; i++) {
                    ...
                    Rectangle rc = new Rectangle(p.x - DOT_WID, p.y - DOT_WID,
                            dotwid, dotwid);
                ...
                // 旗を描く
                drawPreutteranceAndOverlap(g, preutterance.value,
                    overlap.value, item.UstEvent.getPreUtterance(),
                    item.UstEvent.getVoiceOverlap());
            }
        }

        // 選択されている点のハイライト表示
        if (selected_found) {
            Rectangle rc = new Rectangle(selected_point.x - DOT_WID,
                    selected_point.y - DOT_WID, dotwid, dotwid);
            g.setColor(AppManager.getHilightColor());
            g.fillRect(rc.x, rc.y, rc.width, rc.height);
            g.setColor(COLOR_BEZIER_DOT_NORMAL);
            g.drawRect(rc.x, rc.y, rc.width, rc.height);
    ...
    private static String getFlagTitle(boolean flag_is_pre_utterance,
        float value) {
    ...
    private Dimension getFlagBounds(String flag_title) {
        ...
        return new Dimension((int) (str.length(flag_title) * mTextWidthPerLetter),
            mTextHeight);
    }
    ...
    private void drawPreutteranceAndOverlap(Graphics2D g, int px_preutterance,
        int px_overlap, float preutterance, float overlap) {
        int graph_height = getGraphHeight();
        g.setColor(PortUtil.Orange);
        g.drawLine(px_preutterance, HEADER + 1, px_preutterance,
            graph_height + HEADER);
        ...
        Color transp = new Color(PortUtil.Orange.getRed(),
                PortUtil.Orange.getGreen(), PortUtil.Orange.getBlue(), 50);
        g.setColor(transp);
        g.fillRect(px_preutterance, OFFSET_PRE - FLAG_SPACE, pre_bounds.width,
            pre_bounds.height + (FLAG_SPACE * 2));
        g.setColor(pen);
        g.drawRect(px_preutterance, OFFSET_PRE - FLAG_SPACE, pre_bounds.width,
            pre_bounds.height + (FLAG_SPACE * 2));
        transp = new Color(PortUtil.LawnGreen.getRed(),
                PortUtil.LawnGreen.getGreen(), PortUtil.LawnGreen.getBlue(), 50);
        g.setColor(transp);
        g.fillRect(px_overlap, OFFSET_OVL - FLAG_SPACE, ovl_bounds.width,
            ovl_bounds.height + (FLAG_SPACE * 2));
        g.setColor(pen);
        g.drawRect(px_overlap, OFFSET_OVL - FLAG_SPACE, ovl_bounds.width,
            ovl_bounds.height + (FLAG_SPACE * 2));

        g.setFont(font);
        g.setColor(Color.black);
        g.drawString(s_pre, px_preutterance + 1,
            (OFFSET_PRE + (font_height / 2)) - font_offset + 1);
        g.drawString(s_ovl, px_overlap + 1,
            (OFFSET_OVL + (font_height / 2)) - font_offset + 1);
    }
    ...
    private long findDataPointAt(int locx, int locy) {
        ...
        if (mSelectedCurve.equals(CurveType.VibratoDepth) ||
            ...
            VsqBPList list = AppManager.getVsqFile().Track.get(AppManager.getSelected())
                                                          .getCurve(mSelectedCurve.getName());
            int count = list.size();
            int w = (DOT_WID * 2) + 1;
    ...
    private boolean findEnvelopePointAt(int locx, int locy,
        ByRef<Integer> internal_id, ByRef<Integer> point_kind) {
    ...
    private boolean findPreUtteranceOrOverlapAt(int locx, int locy,
        ByRef<Integer> internal_id, ByRef<Boolean> found_flag_was_overlap) {
        return findEnvelopeCore(locx, locy, internal_id, null,
            found_flag_was_overlap);
    }
    ...
    /// <returns></returns>
    private boolean findEnvelopeCore(int locx, int locy,
        ByRef<Integer> internal_id, ByRef<Integer> point_kind,
        ByRef<Boolean> found_flag_was_overlap) {
        internal_id.value = -1;
        ...
        int dotwid = (DOT_WID * 2) + 1;
        VsqFileEx vsq = AppManager.getVsqFile();
        Iterator<VsqEvent> itr = vsq.Track.get(AppManager.getSelected())
                                          .getNoteEventIterator();
        VsqEvent itr_prev = null;
        VsqEvent itr_item = null;
        VsqEvent itr_next = null;
        ...
        while (true) {
            ...
            // エンベロープの点の座標を計算
            Polygon points = getEnvelopePoints(vsq.TempoTable, prev_item, item,
                    next_item, px_preutterance, px_overlap);
            ...
            if (found_flag_was_overlap != null) {
                String title_preutterance = getFlagTitle(true,
                        item.UstEvent.getPreUtterance());
                size = getFlagBounds(title_preutterance);

                if (Utility.isInRect(locx, locy, px_preutterance.value,
                            OFFSET_PRE - FLAG_SPACE, size.width,
                            size.height + (FLAG_SPACE * 2))) {
                    internal_id.value = item.InternalID;
                ...
                // オーバーラップ用の旗の当たり判定
                String title_overlap = getFlagTitle(false,
                        item.UstEvent.getVoiceOverlap());
                size = getFlagBounds(title_overlap);

                if (Utility.isInRect(locx, locy, px_overlap.value,
                            OFFSET_OVL - FLAG_SPACE, size.width,
                            size.height + (FLAG_SPACE * 2))) {
                    internal_id.value = item.InternalID;
    ...
    private Polygon getEnvelopePoints(TempoVector tempo_table,
        ...
        getEnvelopeRegion(tempo_table, prev_item, item, next_item,
            sec_env_start1, sec_env_end1);
        ...
        int px_env_start1 = AppManager.xCoordFromClocks((int) tempo_table.getClockFromSec(
                    sec_env_start1.value, context));
        ...
        double sec_p2 = sec_env_start1.value +
            ((draw_target.p1 + draw_target.p2) / 1000.0);
        double sec_p5 = sec_env_start1.value +
            ((draw_target.p1 + draw_target.p2 + draw_target.p5) / 1000.0);
        double sec_p3 = sec_env_end1.value -
            ((draw_target.p3 + draw_target.p4) / 1000.0);
        double sec_p4 = sec_env_end1.value - (draw_target.p4 / 1000.0);
        int p1 = AppManager.xCoordFromClocks((int) tempo_table.getClockFromSec(
                    sec_p1, context));
        int p2 = AppManager.xCoordFromClocks((int) tempo_table.getClockFromSec(
                    sec_p2, context));
        int p5 = AppManager.xCoordFromClocks((int) tempo_table.getClockFromSec(
                    sec_p5, context));
        int p3 = AppManager.xCoordFromClocks((int) tempo_table.getClockFromSec(
                    sec_p3, context));
        int p4 = AppManager.xCoordFromClocks((int) tempo_table.getClockFromSec(
                    sec_p4, context));
        int px_env_end1 = AppManager.xCoordFromClocks((int) tempo_table.getClockFromSec(
                    sec_env_end1.value, context));

        if (px_overlap != null) {
            px_overlap.value = AppManager.xCoordFromClocks((int) tempo_table.getClockFromSec(sec_env_start1.value +
                        sec_overlap1, context));
        }
        ...
        return new Polygon(new int[] {
                px_env_start1, p1, p2, p5, p3, p4, px_env_end1
            }, new int[] { y, v1, v2, v5, v3, v4, y }, 7);
    }
    ...
    private void getEnvelopeRegion(TempoVector tempo_table, VsqEvent item_prev,
        VsqEvent item, VsqEvent item_next, ByRef<Double> env_start_sec,
        ByRef<Double> env_end_sec) {
        double sec_start1 = tempo_table.getSecFromClock(item.Clock);
        double sec_end1 = tempo_table.getSecFromClock(item.Clock +
                item.ID.getLength());
        UstEvent ust_event1 = item.UstEvent;
    ...
    private void drawTrackTab(Graphics2D g, Rectangle destRect, String name,
        boolean selected, boolean enabled, boolean render_required,
        Color hilight, Color render_button_hilight) {
        int x = destRect.x;
        int panel_width = render_required ? (destRect.width - 10) : destRect.width;
        Color panel_color = enabled ? hilight : new Color(125, 123, 124);
        Color button_color = enabled ? render_button_hilight
                                     : new Color(125, 123, 124);
        ...
        if (selected) {
            ...
            if (render_required && enabled) {
                ...
                g.fillRect((destRect.x + destRect.width) - 10, destRect.y, 10,
                    destRect.height);
            }
        }
        ...
        // 左縦線
        g.setColor(border);
        g.drawLine(destRect.x, destRect.y, destRect.x,
            (destRect.y + destRect.height) - 1);

        if (PortUtil.getStringLength(name) > 0) {
            // 上横線
            g.setColor(border);
            g.drawLine(destRect.x + 1, destRect.y, destRect.x + destRect.width,
                destRect.y);
        }
        ...
        if (render_required) {
            ...
            g.drawLine((destRect.x + destRect.width) - 10, destRect.y,
                (destRect.x + destRect.width) - 10,
                (destRect.y + destRect.height) - 1);
        }

        g.clipRect(destRect.x, destRect.y, destRect.width, destRect.height);

        String title = Utility.trimString(name, AppManager.superFont8,
                panel_width);
        g.setFont(AppManager.superFont8);
        g.setColor(panel_title);
        g.drawString(title, destRect.x + 2,
            (destRect.y + (destRect.height / 2)) -
            AppManager.superFont8OffsetHeight);

        if (render_required) {
            g.setColor(button_title);
            g.drawString("R", (destRect.x + destRect.width) - PX_WIDTH_RENDER,
                (destRect.y + (destRect.height / 2)) -
                AppManager.superFont8OffsetHeight);
        }
    ...
    public void drawVEL(Graphics2D g, VsqTrack track, Color color,
        boolean is_front, CurveType type) {
        Point mouse = pointToClient(PortUtil.getMousePosition());
        ...
        synchronized (AppManager.mDrawObjects) {
            ...
            for (int i = i_start; i < count; i++) {
                ...
                if ((x + VEL_BAR_WIDTH) < 0) {
                    ...
                    int y = oy -
                        ((graph_height * (value - min)) / (max - min));

                    if (is_front &&
                            AppManager.itemSelection.isEventContains(selected,
                                dobj.mInternalID)) {
                        ...
                        if (mMouseDownMode == MouseDownMode.VEL_EDIT) {
                            ...
                            if (mVelEditSelected.containsKey(dobj.mInternalID)) {
                                ...
                                if (mSelectedCurve.equals(CurveType.VEL)) {
                                    if (AppManager.mDrawIsUtau[selected - 1]) {
                                        editing = (ve_editing.UstEvent == null)
                                            ? 100
                                            : ve_editing.UstEvent.getIntensity();
                                    } else {
                                        editing = ve_editing.ID.Dynamics;
                                    }
                                } else if (mSelectedCurve.equals(
                                            CurveType.Accent)) {
                                ...
                                int edit_y = oy -
                                    ((graph_height * (editing - min)) / (max -
                                    min));
                                g.setColor(COLOR_A244R255G023B012);
                                g.fillRect(x, edit_y, VEL_BAR_WIDTH, oy -
                                    edit_y);
                                g.setColor(Color.white);
                                g.drawString(editing + "", x + VEL_BAR_WIDTH,
                                    (edit_y > (oy - 20)) ? (oy - 20) : edit_y);
                            }
                        }
                    } else {
                        g.setColor(color);
    ...
    private void drawAttachedCurve(Graphics2D g, Vector<BezierChain> chains) {
        ...
        int visibleMaxX = mMainWindow.pictPianoRoll.getWidth() +
            AppManager.keyWidth + AppManager.keyOffset;
        ...
        for (int i = 0; i < chains_count; i++) {
            ...
            for (int j = 0; j < target_chain_points_count; j++) {
                ...
                int next_x = AppManager.xCoordFromClocks((int) next.getBase()
                                                                   .getX());
                pxNext = new Point(next_x,
                        yCoordFromValue((int) next.getBase().getY()));

                Point pxControlCurrent = getScreenCoord(current.getControlRight());
                Point pxControlNext = getScreenCoord(next.getControlLeft());

                // ベジエ曲線本体を描く
                if (isVisibleOnScreen(visibleMinX, visibleMaxX, pxCurrent.x,
                            pxNext.x)) {
                    if ((current.getControlRightType() == BezierControlType.None) &&
                        ...
                        Point ctrl1 = (current.getControlRightType() == BezierControlType.None)
                            ? pxCurrent : pxControlCurrent;
                        Point ctrl2 = (next.getControlLeftType() == BezierControlType.None)
                            ? pxNext : pxControlNext;
                        g.setColor(COLOR_BEZIER_CURVE);
                        PortUtil.drawBezier(g, pxCurrent.x, pxCurrent.y,
                            ctrl1.x, ctrl1.y, ctrl2.x, ctrl2.y, pxNext.x,
                            pxNext.y);
                    }
                }
                ...
                if (current.getControlRightType() != BezierControlType.None) {
                    if (isVisibleOnScreen(visibleMinX, visibleMaxX,
                                pxCurrent.x, pxControlCurrent.x)) {
                        g.setColor(COLOR_BEZIER_AUXILIARY);
                        g.drawLine(pxCurrent.x, pxCurrent.y,
                            pxControlCurrent.x, pxControlCurrent.y);
                    }
                ...
                if (next.getControlLeftType() != BezierControlType.None) {
                    if (isVisibleOnScreen(visibleMinX, visibleMaxX,
                                pxControlNext.x, pxNext.x)) {
                        g.setColor(COLOR_BEZIER_AUXILIARY);
                        g.drawLine(pxNext.x, pxNext.y, pxControlNext.x,
                            pxControlNext.y);
                    }
                ...
                if (current.getControlRightType() == BezierControlType.Normal) {
                    Rectangle rc = new Rectangle(pxControlCurrent.x - DOT_WID,
                            pxControlCurrent.y - DOT_WID, (DOT_WID * 2) + 1,
                            (DOT_WID * 2) + 1);

                    if ((chain_id == mEditingChainID) &&
                            (current.getID() == mEditingPointID)) {
                        g.setColor(hilight);
                ...
                if (next.getControlLeftType() == BezierControlType.Normal) {
                    Rectangle rc = new Rectangle(pxControlNext.x - DOT_WID,
                            pxControlNext.y - DOT_WID, (DOT_WID * 2) + 1,
                            (DOT_WID * 2) + 1);

                    if ((chain_id == mEditingChainID) &&
                            (next.getID() == mEditingPointID)) {
                        g.setColor(hilight);
                        g.fillOval(rc.x, rc.y, rc.width, rc.height);
                    } else {
                        g.setColor(COLOR_BEZIER_DOT_NORMAL);
                ...
                Rectangle rc2 = new Rectangle(pxCurrent.x - DOT_WID,
                        pxCurrent.y - DOT_WID, (DOT_WID * 2) + 1,
                        (DOT_WID * 2) + 1);
            ...
            if (!breaked) {
                ...
                Rectangle rc_last = new Rectangle(pxNext.x - DOT_WID,
                        pxNext.y - DOT_WID, (DOT_WID * 2) + 1, (DOT_WID * 2) +
                        1);

                if ((chain_id == mEditingChainID) &&
                        (next.getID() == mEditingPointID)) {
                    g.setColor(hilight);
                    g.fillRect(rc_last.x, rc_last.y, rc_last.width,
                        rc_last.height);
                } else {
                    g.setColor(COLOR_BEZIER_DOT_BASE);
                    g.fillRect(rc_last.x, rc_last.y, rc_last.width,
    ...
    /// <returns></returns>
    private boolean isVisibleOnScreen(int visibleMinX, int visibleMaxX,
        int startX, int endX) {
        return (((visibleMinX <= startX) && (startX <= visibleMaxX)) ||
        ((visibleMinX <= endX) && (endX <= visibleMaxX)) ||
        ((startX < visibleMinX) && (visibleMaxX <= endX)));
    }

    private Point getScreenCoord(PointD pt) {
        return new Point(AppManager.xCoordFromClocks((int) pt.getX()),
            yCoordFromValue((int) pt.getY()));
    }
    ...
    public void drawVibratoControlCurve(Graphics2D g, VsqTrack draw_target,
        CurveType type, Color color, boolean is_front) {
        if (!is_front) {
            return;
        }
        ...
        for (Iterator<VsqEvent> itr = draw_target.getNoteEventIterator();
                itr.hasNext();) {
    ...
    /// <param name="is_front">最前面に表示するモードかどうか</param>
    public void drawVsqBPList(Graphics2D g, VsqBPList list, Color color,
        boolean is_front) {
        ...
        int dot_mode = is_front ? LineGraphDrawer.DOTMODE_NEAR
                                : LineGraphDrawer.DOTMODE_NO;
        ...
        if (mMouseDownMode == MouseDownMode.POINT_MOVE) {
            int dx = (pmouse.x +
                ...
                mMouseDownLocation.x;
            int dy = pmouse.y - mMouseDownLocation.y;

            for (Iterator<BPPair> itr = mMovingPoints.iterator();
                    itr.hasNext();) {
    ...
    public void TrackSelector_MouseClick(Object sender, BMouseEventArgs e) {
        if (mCurveVisible) {
            if (e.Button == BMouseButtons.Left) {
                ...
                if ((0 <= e.X) && (e.X <= AppManager.keyWidth) && (0 <= e.Y) &&
                        (e.Y <= (getHeight() - (2 * OFFSET_TRACK_TAB)))) {
                    ...
                    RendererKind kind = VsqFileEx.getTrackRendererKind(AppManager.getVsqFile().Track.get(
                            ...
                            for (int j = 0; j < sub_tsmi.length; j++) {
                                ...
                                if (tsi2 instanceof BMenuItem) {
                                    ...
                                    if (ct2.equals(mSelectedCurve)) {
                                        ...
                                        if (ct2.equals(CurveType.reso1amp) ||
                                                ct2.equals(CurveType.reso1bw) ||
                                                ct2.equals(CurveType.reso1freq) ||
                                                ct2.equals(CurveType.reso2amp) ||
                                                ct2.equals(CurveType.reso2bw) ||
                                                ct2.equals(CurveType.reso2freq) ||
                                                ct2.equals(CurveType.reso3amp) ||
                                                ct2.equals(CurveType.reso3bw) ||
                                                ct2.equals(CurveType.reso3freq) ||
                                                ct2.equals(CurveType.reso4amp) ||
                                                ct2.equals(CurveType.reso4bw) ||
                                                ct2.equals(CurveType.reso4freq)) {
    ...
    public BezierPoint HandleMouseMoveForBezierMove(int clock, int value,
        int value_raw, BezierPickedSide picked) {
        BezierChain target = AppManager.getVsqFile().AttachedCurves.get(AppManager.getSelected() -
                1)
                                                                   .getBezierChain(mSelectedCurve,
                AppManager.itemSelection.getLastBezier().chainID);
            ...
            if (picked == BezierPickedSide.BASE) {
                ...
                if (item.getControlLeftType() == BezierControlType.Master) {
                    ...
                    if (!BezierChain.isBezierImplicit(target)) {
                        ...
                        item.setControlLeft(new PointD(old_left.getX(),
                                value_raw));
                    ...
                    PointD new_right = getCounterPoint(old_super, old_right,
                            new_left, scale_x, scale_y);
                    ...
                    if (!BezierChain.isBezierImplicit(target)) {
                        ...
                        new_right = getCounterPoint(old_super, old_right,
                                new_left, scale_x, scale_y);
                        item.setControlLeft(new_left);
                        item.setControlRight(new_right);
                ...
                if (item.getControlRightType() == BezierControlType.Master) {
                    ...
                    PointD new_left = getCounterPoint(old_super, old_left,
                            new_right, scale_x, scale_y);
                    item.setControlRight(new_right);
                    item.setControlLeft(new_left);
                    ...
                    if (!BezierChain.isBezierImplicit(target)) {
                        ...
                        new_left = getCounterPoint(old_super, old_left,
                                new_right, scale_x, scale_y);
                        item.setControlRight(new_right);
                        item.setControlLeft(new_left);
    ...
    /// <returns></returns>
    private static PointD getCounterPoint(PointD super_point,
        PointD slave_point_original, PointD moving_point, double scalex,
        double scaley) {
        // 移動後の点と回転軸との為す角を計算
        double theta = Math.atan2((moving_point.getY() - super_point.getY()) * scaley,
        ...
        // 逆サイドの点の座標を計算
        return new PointD(((length * Math.cos(theta)) / scalex) +
            super_point.getX(),
            ((length * Math.sin(theta)) / scaley) + super_point.getY());
    }

    public BezierPoint HandleMouseMoveForBezierMove(BMouseEventArgs e,
        BezierPickedSide picked) {
    ...
    public void TrackSelector_MouseMove(Object sender, BMouseEventArgs e) {
        ...
        if ((((e.X + stdx) != mMouseDownLocation.x) ||
        ...
        if ((e.Button == BMouseButtons.Left) && (0 <= e.Y) &&
                (e.Y <= (getHeight() - (2 * OFFSET_TRACK_TAB))) &&
            ...
            if (selected_tool == EditTool.PENCIL) {
                ...
                AppManager.mCurveSelectingRectangle.width = draft_clock -
                    AppManager.mCurveSelectingRectangle.x;
                AppManager.mCurveSelectingRectangle.height = value -
                    AppManager.mCurveSelectingRectangle.y;
            }
            ...
            if (mSelectedCurve.equals(CurveType.VEL)) {
                if (is_utau_mode) {
                    d_vel = t_value -
                        ((ve_original.UstEvent == null) ? 100
                                                        : ve_original.UstEvent.getIntensity());
                } else {
                    d_vel = t_value - ve_original.ID.Dynamics;
                }
            } else if (mSelectedCurve.equals(CurveType.Accent)) {
                d_vel = t_value -
                    mVelEditSelected.get(mVelEditLastSelectedID).original.ID.DEMaccent;
            } else if (mSelectedCurve.equals(CurveType.Decay)) {
                d_vel = t_value -
                    mVelEditSelected.get(mVelEditLastSelectedID).original.ID.DEMdecGainRate;
            }

            for (Iterator<Integer> itr = mVelEditSelected.keySet().iterator();
                    itr.hasNext();) {
                int id = itr.next();
                ...
                if (mSelectedCurve.equals(CurveType.VEL)) {
                    ...
                    if (is_utau_mode) {
                        new_vel = (item.UstEvent == null) ? (100 + d_vel)
                    ...
                    int new_vel = mVelEditSelected.get(id).original.ID.DEMaccent +
                        d_vel;
                    ...
                    int new_vel = mVelEditSelected.get(id).original.ID.DEMdecGainRate +
                        d_vel;
            ...
            HandleMouseMoveForBezierMove(clock, value, value_raw,
                AppManager.itemSelection.getLastBezier().picked);
        } else if ((mMouseDownMode == MouseDownMode.BEZIER_ADD_NEW) ||
                (mMouseDownMode == MouseDownMode.BEZIER_EDIT)) {
            BezierChain target = vsq.AttachedCurves.get(selected - 1)
                                                   .getBezierChain(mSelectedCurve,
                    AppManager.itemSelection.getLastBezier().chainID);
            int point_id = AppManager.itemSelection.getLastBezier().pointID;
            int index = -1;
            ...
            if (index >= 0) {
                ...
                if ((item.getBase().getX() + dx) >= 0) {
                    ...
                    item.setControlLeft(new PointD(clock + (2 * dx),
                            value_raw + (2 * dy)));
            ...
            if (mEnvelopePointKind == 1) {
                ...
                mEnvelopeEditing.p2 = (int) ((sec - mEnvelopeRangeBegin) * 1000.0) -
                    mEnvelopeEditing.p1;
                mEnvelopeEditing.v2 = v;
            } else if (mEnvelopePointKind == 3) {
                mEnvelopeEditing.p5 = (int) ((sec - mEnvelopeRangeBegin) * 1000.0) -
                    mEnvelopeEditing.p1 - mEnvelopeEditing.p2;
                mEnvelopeEditing.v5 = v;
            } else if (mEnvelopePointKind == 4) {
                mEnvelopeEditing.p3 = (int) ((mEnvelopeRangeEnd - sec) * 1000.0) -
                    mEnvelopeEditing.p4;
            ...
            int clock_at_downed = AppManager.clockFromXCoord(mMouseDownLocation.x -
                    stdx);
            double dsec = vsq.getSecFromClock(clock) -
                vsq.getSecFromClock(clock_at_downed);
            float draft_preutterance = mPreOverlapOriginal.UstEvent.getPreUtterance() -
                (float) (dsec * 1000);
            ...
            double dsec = vsq.getSecFromClock(clock) -
                vsq.getSecFromClock(clock_at_downed);
            float draft_overlap = mPreOverlapOriginal.UstEvent.getVoiceOverlap() +
                (float) (dsec * 1000);
    ...
    private void findBezierPointAt(int locx, int locy,
        Vector<BezierChain> list, ByRef<BezierChain> found_chain,
        ByRef<BezierPoint> found_point, ByRef<BezierPickedSide> found_side,
        int dot_width, int px_tolerance) {
        ...
        for (int i = 0; i < c; i++) {
            ...
            for (Iterator<BezierPoint> itr = bc.points.iterator();
                    itr.hasNext();) {
                BezierPoint bp = itr.next();
                Point p = getScreenCoord(bp.getBase());
                Rectangle r = new Rectangle(p.x - shift, p.y - shift, width,
                        width);
    ...
    private void processMouseDownSelectRegion(BMouseEventArgs e) {
        ...
        if (AppManager.editorConfig.CurveSelectingQuantized) {
            AppManager.mCurveSelectingRectangle = new Rectangle(quantized_clock,
                    value, 0, 0);
        } else {
            AppManager.mCurveSelectingRectangle = new Rectangle(clock, value,
                    0, 0);
        }
    }
    ...
    public void TrackSelector_MouseDown(Object sender, BMouseEventArgs e) {
        ...
        if (((height - OFFSET_TRACK_TAB) <= e.Y) && (e.Y < height)) {
                        ...
                        if (vec.size(vsq.Track) > (i + 1)) {
                            if ((x <= e.X) && (e.X < (x + selecter_width))) {
                                ...
                                if (AppManager.getSelected() != new_selected) {
                                    ...
                                    try {
                                        selectedTrackChangedEvent.raise(this,
                                            (i + 1));
                                    } catch (Exception ex) {
                                        serr.println(
                                            "TrackSelector#TrackSelector_MouseDown; ex=" +
                                            ex);
                                    }
                                    ...
                                    return;
                                } else if ((((x + selecter_width) -
                                        PX_WIDTH_RENDER) <= e.X) &&
                                        (e.X < (e.X + selecter_width))) {
                                    if (AppManager.getRenderRequired(
                                                AppManager.getSelected()) &&
                                            !AppManager.isPlaying()) {
                                        try {
                                            renderRequiredEvent.raise(this,
                                                AppManager.getSelected());
                                        } catch (Exception ex) {
                                            serr.println(
                                                "TrackSelector#TrackSelector_MouseDown; ex=" +
        ...
        } else if (((height - (2 * OFFSET_TRACK_TAB)) <= e.Y) &&
                (e.Y < (height - OFFSET_TRACK_TAB))) {
                ...
                if (ve != null) {
                    if ((mModifierOnMouseDown & mModifierKey) == mModifierKey) {
                        if (AppManager.itemSelection.isEventContains(
                                    AppManager.getSelected(), ve.InternalID)) {
                    ...
                    } else if ((PortUtil.getCurrentModifierKey() &
            ...
            if (AppManager.keyWidth <= e.X) {
                if ((e.Button == BMouseButtons.Left) && !mSpaceKeyDowned) {
                    ...
                    int px_shift = DOT_WID +
                        AppManager.editorConfig.PxToleranceBezier;
                    ...
                    if (AppManager.getSelectedTool() == EditTool.LINE) {
                        ...
                        if (mSelectedCurve.isScalar() ||
                                mSelectedCurve.isAttachNote()) {
                            if (mSelectedCurve.equals(CurveType.Env)) {
                                if (processMouseDownEnvelope(e)) {
                                    invalidate();
                            ...
                            Vector<BezierChain> dict = AppManager.getVsqFile().AttachedCurves.get(AppManager.getSelected() -
                                    1).get(mSelectedCurve);
                            ...
                            for (int i = 0; i < dict.size(); i++) {
                                ...
                                for (Iterator<BezierPoint> itr = bc.points.iterator();
                                    ...
                                    Rectangle rc = new Rectangle(pt.x -
                                            px_shift, pt.y - px_shift,
                                            px_width, px_width);

                                    if (isInRect(e.X, e.Y, rc)) {
                                        AppManager.itemSelection.addBezier(new SelectedBezierPoint(
                                                bc.id, bp.getID(),
                                                BezierPickedSide.BASE, bp));
                                    ...
                                    if (bp.getControlLeftType() != BezierControlType.None) {
                                        ...
                                        rc = new Rectangle(pt.x - px_shift,
                                                pt.y - px_shift, px_width,
                                                px_width);

                                        if (isInRect(e.X, e.Y, rc)) {
                                            AppManager.itemSelection.addBezier(new SelectedBezierPoint(
                                                    bc.id, bp.getID(),
                                                    BezierPickedSide.LEFT, bp));
                                            mEditingBezierOriginal = (BezierChain) bc.clone();
                                            found = true;
                        ...
                        if (!found) {
                            ...
                            if (ve != null) {
                                ...
                                if ((mModifierOnMouseDown & mModifierKey) == mModifierKey) {
                                    ...
                                    if (last_selected != null) {
                                        ...
                                        for (Iterator<VsqEvent> itr = AppManager
                                                                                                   .getVsqFile().Track.get(
                                                    AppManager.getSelected())
                                                                                                   .getNoteEventIterator();
                                                itr.hasNext();) {
                                            VsqEvent item = itr.next();
                                ...
                                if (mSelectedCurve.equals(CurveType.VEL)) {
                                    if (AppManager.mDrawIsUtau[selected - 1]) {
                                        mVelEditShiftY = e.Y -
                                            yCoordFromValue((ve.UstEvent == null)
                                                ? 100 : ve.UstEvent.getIntensity());
                                    } else {
                                        mVelEditShiftY = e.Y -
                                            yCoordFromValue(ve.ID.Dynamics);
                                    }
                                } else if (mSelectedCurve.equals(
                                            CurveType.Accent)) {
                                    mVelEditShiftY = e.Y -
                                        yCoordFromValue(ve.ID.DEMaccent);
                                } else if (mSelectedCurve.equals(
                                            CurveType.Decay)) {
                                    mVelEditShiftY = e.Y -
                                        yCoordFromValue(ve.ID.DEMdecGainRate);
                                }
                            ...
                            if (id > 0) {
                                if (AppManager.itemSelection.isPointContains(id)) {
                                    ...
                                    AppManager.itemSelection.addPoint(mSelectedCurve,
                                        id);
                                }
                                ...
                                if (list != null) {
                                    ...
                                    for (int i = 0; i < count; i++) {
                                        ...
                                        if (AppManager.itemSelection.isPointContains(
                                                    item.id)) {
                                            mMovingPoints.add(new BPPair(
                                                    list.getKeyClock(i),
                                                    item.value));
                                        }
                                    }
                                ...
                                if (((mModifierOnMouseDown &
                                        InputEvent.SHIFT_MASK) != InputEvent.SHIFT_MASK) &&
                                        ((mModifierOnMouseDown & mModifierKey) != mModifierKey)) {
                                    AppManager.itemSelection.clearPoint();
                                }
                            }
                            ...
                            if (AppManager.editorConfig.CurveSelectingQuantized) {
                                ...
                                AppManager.mCurveSelectingRectangle = new Rectangle(clock,
                                        value, 0, 0);
                            }
                        }
                        ...
                        if (ve3 != null) {
                            ...
                            CadenciiCommand run = new CadenciiCommand(VsqCommand.generateCommandEventDelete(
                                        selected, ve3.InternalID));
                            executeCommand(run, true);
                        } else {
                            if (AppManager.isCurveMode()) {
                                Vector<BezierChain> list = vsq.AttachedCurves.get(AppManager.getSelected() -
                                        1).get(mSelectedCurve);
                                ...
                                if (list != null) {
                                    ...
                                    findBezierPointAt(e.X, e.Y, list, chain,
                                        point, side, DOT_WID,
                                        AppManager.editorConfig.PxToleranceBezier);
                                ...
                                if (id > 0) {
                                    VsqBPList item = AppManager.getVsqFile().Track.get(AppManager.getSelected())
                                                                                  .getCurve(mSelectedCurve.getName());
                            ...
                            if (((mModifierOnMouseDown & InputEvent.SHIFT_MASK) != InputEvent.SHIFT_MASK) &&
                                    ((mModifierOnMouseDown & mModifierKey) != mModifierKey)) {
                                AppManager.itemSelection.clearPoint();
                            }
                        ...
                        if (!mSelectedCurve.equals(CurveType.VEL) &&
                            ...
                            for (int i = 0; i < dict.size(); i++) {
                                ...
                                for (Iterator<BezierPoint> itr = bc.points.iterator();
                                    ...
                                    Point pt = getScreenCoord(bp.getBase());
                                    Rectangle rc = new Rectangle(pt.x -
                                            DOT_WID, pt.y - DOT_WID,
                                            (2 * DOT_WID) + 1, (2 * DOT_WID) +
                                            1);
    ...
    private boolean processMouseDownBezier(BMouseEventArgs e) {
        ...
        Vector<BezierChain> dict = AppManager.getVsqFile().AttachedCurves.get(track -
                1).get(mSelectedCurve);
        ...
        findBezierPointAt(e.X, e.Y, dict, found_chain, found_point, found_side,
        ...
        if (found_chain.value != null) {
            ...
            for (int j = 0; j < dict.size(); j++) {
                ...
                for (int i = 1; i < bc.size(); i++) {
                    if (!is_middle &&
                            (bc.points.get(i - 1).getBase().getX() <= clock) &&
                            (clock <= bc.points.get(i).getBase().getX())) {
                    ...
                    if (!too_near) {
                        for (Iterator<BezierPoint> itr = bc.points.iterator();
                            ...
                            BezierPoint bp = itr.next();
                            Point pt = getScreenCoord(bp.getBase());
                            Rectangle rc = new Rectangle(pt.x - px_shift,
                                    pt.y - px_shift, px_width, px_width);
            ...
            if (!too_near) {
                if (((modifier & mModifierKey) != mModifierKey) &&
                        (target_chain == null)) {
                    ...
                    for (int i = 0; i < dict.size(); i++) {
                        ...
                        int last = (int) bc.points.get(bc.points.size() - 1)
                                                  .getBase().getX();
                ...
                if (target_chain == null) {
                    ...
                    bp.setID(point_id);
                    adding.add(bp);
                    chain_id = AppManager.getVsqFile().AttachedCurves.get(track -
                            1).getNextId(mSelectedCurve);

                    CadenciiCommand run = VsqFileEx.generateCommandAddBezierChain(track,
                            mSelectedCurve, chain_id,
                            AppManager.editorConfig.getControlCurveResolutionValue(),
                            adding);
                    ...
                    CadenciiCommand run = VsqFileEx.generateCommandReplaceBezierChain(track,
                            mSelectedCurve, target_chain.id, target_chain,
                            AppManager.editorConfig.getControlCurveResolutionValue());
                    executeCommand(run, false);
                    mMouseDownMode = MouseDownMode.BEZIER_EDIT;
                }
                ...
                AppManager.itemSelection.clearBezier();
                AppManager.itemSelection.addBezier(new SelectedBezierPoint(
                        chain_id, point_id, BezierPickedSide.BASE, bp));
            } else {
                mMouseDownMode = MouseDownMode.NONE;
            }
        }
    ...
    private boolean processMouseDownPreutteranceAndOverlap(BMouseEventArgs e) {
        ...
        if (findPreUtteranceOrOverlapAt(e.X, e.Y, internal_id,
                    found_flag_was_overlap)) {
            if (found_flag_was_overlap.value) {
                mOverlapEditingID = internal_id.value;
                mPreOverlapEditing = AppManager.getVsqFile().Track.get(AppManager.getSelected())
                                                                  .findEventFromID(mOverlapEditingID);
                ...
                mPreOverlapEditing = AppManager.getVsqFile().Track.get(AppManager.getSelected())
                                                                  .findEventFromID(mPreUtteranceEditingID);
    ...
    private boolean processMouseDownEnvelope(BMouseEventArgs e) {
        ...
        if ((found.UstEvent != null) && (found.UstEvent.getEnvelope() != null)) {
            mEnvelopeOriginal = (UstEnvelope) found.UstEvent.getEnvelope()
                                                            .clone();
        ...
        getEnvelopeRegion(vsq.TempoTable, item_prev, item, item_next,
            env_start, env_end);
        ...
        if (mEnvelopePointKind == 1) {
            ...
            mEnvelopeDotEnd = mEnvelopeRangeEnd -
                ((mEnvelopeOriginal.p4 + mEnvelopeOriginal.p3 +
                mEnvelopeOriginal.p5 + mEnvelopeOriginal.p2) / 1000.0);
        } else if (mEnvelopePointKind == 2) {
            mEnvelopeDotBegin = mEnvelopeRangeBegin +
                (mEnvelopeOriginal.p1 / 1000.0);
            mEnvelopeDotEnd = mEnvelopeRangeEnd -
                ((mEnvelopeOriginal.p4 + mEnvelopeOriginal.p3 +
                mEnvelopeOriginal.p5) / 1000.0);
        } else if (mEnvelopePointKind == 3) {
            mEnvelopeDotBegin = mEnvelopeRangeBegin +
                ((mEnvelopeOriginal.p1 + mEnvelopeOriginal.p2) / 1000.0);
            mEnvelopeDotEnd = mEnvelopeRangeEnd -
                ((mEnvelopeOriginal.p4 + mEnvelopeOriginal.p3) / 1000.0);
        } else if (mEnvelopePointKind == 4) {
            mEnvelopeDotBegin = mEnvelopeRangeBegin +
                ((mEnvelopeOriginal.p1 + mEnvelopeOriginal.p2 +
                mEnvelopeOriginal.p5) / 1000.0);
            mEnvelopeDotEnd = mEnvelopeRangeEnd -
                (mEnvelopeOriginal.p4 / 1000.0);
        } else if (mEnvelopePointKind == 5) {
            mEnvelopeDotBegin = mEnvelopeRangeBegin +
                ((mEnvelopeOriginal.p1 + mEnvelopeOriginal.p2 +
                mEnvelopeOriginal.p5 + mEnvelopeOriginal.p3) / 1000.0);
            mEnvelopeDotEnd = mEnvelopeRangeEnd;
        }
    ...
    private VsqEvent findItemAt(int locx, int locy) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (ve.ID.type == VsqIDType.Singer) {
                ...
                if ((0 <= locy) &&
                        (locy <= (getHeight() - (2 * OFFSET_TRACK_TAB))) &&
                        (AppManager.keyWidth <= locx) && (locx <= getWidth())) {
                    if ((y <= locy) && (locy <= (getHeight() - FOOTER)) &&
                            (x <= locx) && (locx <= (x + VEL_BAR_WIDTH))) {
                        return ve;
                    }
                }
            }
    ...
    public void TrackSelector_MouseUp(Object sender, BMouseEventArgs e) {
        ...
        if ((mMouseDownMode == MouseDownMode.BEZIER_ADD_NEW) ||
                ...
                (mMouseDownMode == MouseDownMode.BEZIER_EDIT)) {
            if ((e.Button == BMouseButtons.Left) &&
                    sender instanceof TrackSelector) {
                int chain_id = AppManager.itemSelection.getLastBezier().chainID;
                BezierChain edited = (BezierChain) vsq.AttachedCurves.get(selected -
                        1).getBezierChain(mSelectedCurve, chain_id).clone();
                ...
                if (mMouseDownMode == MouseDownMode.BEZIER_ADD_NEW) {
                    ...
                    CadenciiCommand pre = VsqFileEx.generateCommandReplaceBezierChain(selected,
                            mSelectedCurve, chain_id, mEditingBezierOriginal,
                            AppManager.editorConfig.getControlCurveResolutionValue());
                    executeCommand(pre, false);

                    CadenciiCommand run = VsqFileEx.generateCommandReplaceBezierChain(selected,
                            mSelectedCurve, chain_id, edited,
                            AppManager.editorConfig.getControlCurveResolutionValue());
                    executeCommand(run, true);
                } else if ((mMouseDownMode == MouseDownMode.BEZIER_MODE) &&
                        mMouseMoved) {
                    vsq.AttachedCurves.get(selected - 1)
                                      .setBezierChain(mSelectedCurve, chain_id,
            ...
            if (e.Button == BMouseButtons.Left) {
                if (AppManager.getSelectedTool() == EditTool.ARROW) {
                    if (mSelectedCurve.equals(CurveType.Env)) {
                        ...
                        if (AppManager.mCurveSelectingRectangle.width == 0) {
                            ...
                            if (!AppManager.isCurveSelectedIntervalEnabled()) {
                                int start = Math.min(AppManager.mCurveSelectingRectangle.x,
                                        AppManager.mCurveSelectingRectangle.x +
                                        AppManager.mCurveSelectingRectangle.width);
                                int end = Math.max(AppManager.mCurveSelectingRectangle.x,
                                        AppManager.mCurveSelectingRectangle.x +
                                        AppManager.mCurveSelectingRectangle.width);
                                ...
                                AppManager.mCurveSelectedInterval = new SelectedRegion(Math.min(
                                            start, old_start));
                                AppManager.mCurveSelectedInterval.setEnd(Math.max(
                                        end, old_end));
                            }
                            ...
                            if (!mSelectedCurve.equals(CurveType.Accent) &&
                                ...
                                int count = list.size();
                                Rectangle rc = new Rectangle(Math.min(
                                            AppManager.mCurveSelectingRectangle.x,
                                            AppManager.mCurveSelectingRectangle.x +
                                            AppManager.mCurveSelectingRectangle.width),
                                        Math.min(
                    ...
                    if (AppManager.isCurveMode()) {
                        Vector<BezierChain> list = vsq.AttachedCurves.get(selected -
                                1).get(mSelectedCurve);

                        if (list != null) {
                            int x = Math.min(AppManager.mCurveSelectingRectangle.x,
                                    AppManager.mCurveSelectingRectangle.x +
                                    AppManager.mCurveSelectingRectangle.width);
                            int y = Math.min(AppManager.mCurveSelectingRectangle.y,
                                    AppManager.mCurveSelectingRectangle.y +
                                    AppManager.mCurveSelectingRectangle.height);
                            Rectangle rc = new Rectangle(x, y,
                                    Math.abs(
                                        AppManager.mCurveSelectingRectangle.width),
                                    Math.abs(
                                        AppManager.mCurveSelectingRectangle.height));
                            ...
                            for (int i = 0; i < count; i++) {
                                ...
                                for (int j = 0; j < point_count; j++) {
                                    ...
                                    Point ctrl_l = point.getControlLeft()
                                                        .toPoint();
                                    Point ctrl_r = point.getControlRight()
                                                        .toPoint();
                                    ...
                                    if (isInRect(superpoint.x, superpoint.y, rc)) {
                                        ...
                                        if (((point.getControlLeftType() != BezierControlType.None) &&
                                                isInRect(ctrl_l.x, ctrl_l.y, rc)) ||
                                                ((point.getControlRightType() != BezierControlType.None) &&
                                                isInRect(ctrl_r.x, ctrl_r.y, rc))) {
                            ...
                            if (changed) {
                                ...
                                CadenciiCommand run = VsqFileEx.generateCommandReplaceAttachedCurveRange(selected,
                                        comm);
                                executeCommand(run, true);
                            }
                        }
                        ...
                        if (mSelectedCurve.equals(CurveType.VEL) ||
                            ...
                            if (deleting.size() > 0) {
                                CadenciiCommand er_run = new CadenciiCommand(VsqCommand.generateCommandEventDeleteRange(
                                            selected, deleting));
                                executeCommand(er_run, true);
                            }
                        } else if (mSelectedCurve.equals(CurveType.VibratoRate) ||
                                mSelectedCurve.equals(CurveType.VibratoDepth)) {
                            int er_start = Math.min(AppManager.mCurveSelectingRectangle.x,
                                    AppManager.mCurveSelectingRectangle.x +
                                    AppManager.mCurveSelectingRectangle.width);
                            int er_end = Math.max(AppManager.mCurveSelectingRectangle.x,
                                    AppManager.mCurveSelectingRectangle.x +
                                    AppManager.mCurveSelectingRectangle.width);
                            ...
                            for (Iterator<VsqEvent> itr = vsq_track.getNoteEventIterator();
                                ...
                                if (clear_start < clear_end) {
                                    float f_clear_start = (clear_start -
                                        cl_vib_start) / (float) cl_vib_length;
                                    float f_clear_end = (clear_end -
                                        cl_vib_start) / (float) cl_vib_length;
                                    VsqID item = (VsqID) ve.ID.clone();
                                    VibratoBPList target = null;

                                    if (mSelectedCurve.equals(
                                                CurveType.VibratoDepth)) {
                                    ...
                                    if (mSelectedCurve.equals(
                                                CurveType.VibratoDepth)) {
                                        item.VibratoHandle.setDepthBP(new VibratoBPList(
                                                PortUtil.convertFloatArray(
                                                    bpx.toArray(
                                                        new Float[] {  })),
                                                PortUtil.convertIntArray(
                                                    bpy.toArray(
                                                        new Integer[] {  }))));
                                    } else {
                                        item.VibratoHandle.setRateBP(new VibratoBPList(
                                                PortUtil.convertFloatArray(
                                                    bpx.toArray(
                                                        new Float[] {  })),
                                                PortUtil.convertIntArray(
                            ...
                            if (delete.size() > 0) {
                                CadenciiCommand run_eraser = new CadenciiCommand(VsqCommand.generateCommandTrackCurveEdit2(
                                            selected, mSelectedCurve.getName(),
                                            delete,
                ...
                } else if (!AppManager.isCurveMode() &&
                        ((AppManager.getSelectedTool() == EditTool.PENCIL) ||
                        (AppManager.getSelectedTool() == EditTool.LINE))) {
                    mMouseTracer.append(e.X + stdx, e.Y);
                        ...
                        if (mSelectedCurve.equals(CurveType.VEL) ||
                            ...
                            for (Iterator<VsqEvent> itr = vsq_track.getNoteEventIterator();
                                ...
                                if ((start <= ve.Clock) && (ve.Clock < end)) {
                                    ...
                                    for (Iterator<Point> itr2 = mMouseTracer.iterator();
                                            itr2.hasNext();) {
                                        i++;
                                        ...
                                        int key0 = lkey;
                                        int key1 = key;
                                        int key0_clock = AppManager.clockFromXCoord(key0 -
                                                stdx);
                                        int key1_clock = AppManager.clockFromXCoord(key1 -
                                                stdx);

                                        if ((key0_clock < ve.Clock) &&
                                                (ve.Clock < key1_clock)) {
                                            int key0_value = valueFromYCoord(lvalue);
                                            int key1_value = valueFromYCoord(value);
                                            float a = (key1_value - key0_value) / (float) (key1_clock -
                                                key0_clock);
                                            float b = key0_value -
                                                (a * key0_clock);
                                            int new_value = (int) ((a * ve.Clock) +
                                                b);
                                            velocity.put(ve.InternalID,
                                                new_value);
                                        } else if (key0_clock == ve.Clock) {
                                            velocity.put(ve.InternalID,
                                                valueFromYCoord(lvalue));
                                        } else if (key1_clock == ve.Clock) {
                                            velocity.put(ve.InternalID,
                                                valueFromYCoord(value));
                                        }
                            ...
                            if (velocity.size() > 0) {
                                ...
                                for (Iterator<Integer> itr = velocity.keySet()
                                                                     .iterator();
                                        itr.hasNext();) {
                                    int internal_id = itr.next();
                                    int value = (Integer) velocity.get(internal_id);
                                    cpy.add(new ValuePair<Integer, Integer>(
                                            internal_id, value));
                                }
                                ...
                                if (mSelectedCurve.equals(CurveType.VEL)) {
                                    if (is_utau_mode) {
                                        ...
                                        for (Iterator<Integer> itr = velocity.keySet()
                                                ...
                                                itr.hasNext();) {
                                            int internal_id = itr.next();
                                            VsqEvent item = (VsqEvent) vsq_track.findEventFromID(internal_id)
                                                                                .clone();
                                            ...
                                            item.UstEvent.setIntensity(velocity.get(
                                                    internal_id));
                                            events[i] = item;
                                            i++;
                                        }

                                        run = new CadenciiCommand(VsqCommand.generateCommandEventReplaceRange(
                                                    selected, events));
                                    } else {
                                        run = new CadenciiCommand(VsqCommand.generateCommandEventChangeVelocity(
                                                    selected, cpy));
                                    }
                                } else if (mSelectedCurve.equals(
                                            CurveType.Accent)) {
                                    run = new CadenciiCommand(VsqCommand.generateCommandEventChangeAccent(
                                                selected, cpy));
                                } else if (mSelectedCurve.equals(
                                            CurveType.Decay)) {
                                    run = new CadenciiCommand(VsqCommand.generateCommandEventChangeDecay(
                                                selected, cpy));
                                }
                            ...
                            for (Iterator<VsqEvent> itr = vsq_track.getNoteEventIterator();
                                ...
                                int cl_vib_start = ve.Clock +
                                    ve.ID.VibratoDelay;
                                float cl_vib_length = ve.ID.getLength() -
                                    ve.ID.VibratoDelay;

                                // 仮想スクリーン上の、ビブラートの描画開始位置
                                int vib_start = AppManager.xCoordFromClocks(cl_vib_start) +
                                    stdx;

                                // 仮想スクリーン上の、ビブラートの描画終了位置
                                int vib_end = AppManager.xCoordFromClocks(ve.Clock +
                                        ve.ID.getLength()) + stdx;
                                ...
                                float add_min = (AppManager.clockFromXCoord(chk_start -
                                        stdx) - cl_vib_start) / cl_vib_length;
                                float add_max = (AppManager.clockFromXCoord(chk_end -
                                        stdx) - cl_vib_start) / cl_vib_length;
                                ...
                                for (Iterator<Point> itr2 = mMouseTracer.iterator();
                                    ...
                                    int clock = AppManager.clockFromXCoord(p.x -
                                            stdx);
                                    ...
                                    ValuePair<Float, Integer> tmp = new ValuePair<Float, Integer>(x,
                                            val);
                                ...
                                if (target.getCount() > 0) {
                                    for (int i = 0; i < target.getCount();
                                            i++) {
                                        if ((target.getElement(i).X < add_min) ||
                                                (add_max < target.getElement(i).X)) {
                                            edit.add(new ValuePair<Float, Integer>(
                                                    target.getElement(i).X,
                                ...
                                if (mSelectedCurve.equals(
                                            CurveType.VibratoDepth)) {
                                    id.VibratoHandle.setDepthBP(new VibratoBPList(
                                            bpx, bpy));
                                } else {
                                    id.VibratoHandle.setRateBP(new VibratoBPList(
                                            bpx, bpy));
                                }
                            ...
                            int start = mMouseTracer.firstKey();
                            int end = mMouseTracer.lastKey();
                            int clock_start = AppManager.clockFromXCoord(start -
                                    stdx);
                            int clock_end = AppManager.clockFromXCoord(end -
                                    stdx);
                            int last = start;

                            VsqBPList list = vsq.Track.get(track)
                                                      .getCurve(mSelectedCurve.getName());
                            ...
                            for (Iterator<Point> itr = mMouseTracer.iterator();
                                ...
                                if (value != lvalue) {
                                    index++;
                                    add.put(clock,
                                        new VsqBPPair(value, maxid + index));
                                    lvalue = value;
                                    lclock = clock;
                                }
                            }
                            ...
                            if (add.containsKey(clock_end)) {
                                ...
                                index++;
                                add.put(clock_end,
                                    new VsqBPPair(valueAtEnd, maxid + index));
                            }

                            CadenciiCommand pen_run = new CadenciiCommand(VsqCommand.generateCommandTrackCurveEdit2(
                                        track, mSelectedCurve.getName(),
                                        delete, add));
                    ...
                    if (contains_first_singer) {
                        ...
                        for (int j = 0; j < ids.length; j++) {
                            for (Iterator<SelectedEventEntry> itr = AppManager.itemSelection.getEventIterator();
                                ...
                                if ((item.original.InternalID == ids[j]) &&
                                        (item.original.Clock != clocks[j])) {
                                    changed = true;
                        ...
                        if (changed) {
                            CadenciiCommand run = new CadenciiCommand(VsqCommand.generateCommandEventChangeClockAndIDContaintsRange(
            ...
            if (mMouseMoved) {
                ...
                VsqEvent edited = (VsqEvent) target.findEventFromID(mEnvelopeEdigintID)
                                                   .clone();
                ...
                // コマンドを発行
                CadenciiCommand run = new CadenciiCommand(VsqCommand.generateCommandEventReplace(
                            selected, edited));
                executeCommand(run, true);
            }
        } else if (mMouseDownMode == MouseDownMode.PRE_UTTERANCE_MOVE) {
            ...
            if (mMouseMoved) {
                VsqTrack target = vsq_track;
                VsqEvent edited = (VsqEvent) target.findEventFromID(mPreUtteranceEditingID)
                                                   .clone();
            ...
            if (mMouseMoved) {
                VsqTrack target = vsq_track;
                VsqEvent edited = (VsqEvent) target.findEventFromID(mOverlapEditingID)
                                                   .clone();
            ...
            if (mSelectedCurve.equals(CurveType.VibratoRate) ||
                ...
                for (Iterator<VsqEvent> itr = vsq_track.getNoteEventIterator();
                    ...
                    if ((cl_vib_start <= clock) && (clock < cl_vib_end)) {
                        x = (clock - cl_vib_start) / (float) (cl_vib_end -
                            cl_vib_start);
                    ...
                    if (mSelectedCurve.equals(CurveType.VibratoRate)) {
                        if (x == 0f) {
                            ...
                            if (edited.VibratoHandle.getRateBP().getCount() <= 0) {
                                edited.VibratoHandle.setRateBP(new VibratoBPList(
                                        new float[] { x }, new int[] { value }));
                            } else {
                        ...
                        if (x == 0f) {
                            ...
                            if (edited.VibratoHandle.getDepthBP().getCount() <= 0) {
                                edited.VibratoHandle.setDepthBP(new VibratoBPList(
                                        new float[] { x }, new int[] { value }));
                            } else {
                                Vector<Float> xs = new Vector<Float>();
                                Vector<Integer> vals = new Vector<Integer>();
                ...
                if (list != null) {
                    ...
                    CadenciiCommand run = new CadenciiCommand(VsqCommand.generateCommandTrackCurveEdit2(
                                selected, mSelectedCurve.getName(), delete, add));
                    executeCommand(run, true);
                }
            }
            ...
            if ((0 <= e.Y) && (e.Y <= (height - (2 * OFFSET_TRACK_TAB)))) {
                if ((key_width <= e.X) && (e.X <= width)) {
                    if (!mSelectedCurve.equals(CurveType.VEL) &&
                        ...
                        //int track = AppManager.getSelected();
                        int clock = AppManager.clockFromXCoord(e.X);
                        Vector<BezierChain> dict = vsq.AttachedCurves.get(selected -
                                1).get(mSelectedCurve);
                        BezierChain target_chain = null;
                        ...
                        for (int i = 0; i < dict_size; i++) {
                            ...
                            for (Iterator<BezierPoint> itr = bc.points.iterator();
                                ...
                                BezierPoint bp = itr.next();
                                Point pt = getScreenCoord(bp.getBase());
                                Rectangle rc = new Rectangle(pt.x - DOT_WID,
                                        pt.y - DOT_WID, (2 * DOT_WID) + 1,
                                        (2 * DOT_WID) + 1);
                        ...
                        if (found) {
                            ...
                            try {
                                ...
                                BDialogResult ret = AppManager.showModalDialog(fbpe,
                                        mMainWindow);
                                mEditingChainID = -1;
                                mEditingPointID = -1;

                                BezierChain after = vsq.AttachedCurves.get(selected -
                                        1)
                                                                      .getBezierChain(mSelectedCurve,
                                        chain_id);

                                // 編集前の状態に戻す
                                CadenciiCommand revert = VsqFileEx.generateCommandReplaceBezierChain(selected,
                                        mSelectedCurve, chain_id, before,
                                        AppManager.editorConfig.getControlCurveResolutionValue());
                                executeCommand(revert, false);

                                if (ret == BDialogResult.OK) {
                                    // ダイアログの結果がOKで、かつベジエ曲線が単調増加なら編集を適用
                                    if (BezierChain.isBezierImplicit(
                                                target_chain)) {
                                        CadenciiCommand run = VsqFileEx.generateCommandReplaceBezierChain(selected,
                                                mSelectedCurve, chain_id,
                                                after,
                            ...
                            if (bp_found) {
                                ...
                                FormCurvePointEdit dialog = new FormCurvePointEdit(mMainWindow,
                                        bp_id, mSelectedCurve);
                                int tx = AppManager.xCoordFromClocks(tclock);
                                Point pt = pointToScreen(new Point(tx, 0));
                                invalidate();
                                dialog.setLocation(new Point(pt.x -
                                        (dialog.getWidth() / 2),
                                        pt.y - dialog.getHeight()));
                ...
                if (AppManager.getSelectedTool() != EditTool.ERASER) {
                    ...
                    if (ve == null) {
                        ...
                        Rectangle rc_left_singer_box = new Rectangle(x_at_left,
                    ...
                    if (ve != null) {
                        ...
                        for (int i = 0; i < sub_cmenu_singer.length; i++) {
                            TrackSelectorSingerDropdownMenuItem tsmi = (TrackSelectorSingerDropdownMenuItem) sub_cmenu_singer[i];
                        ...
                        for (Iterator<VsqEvent> itr = vsq_track.getSingerEventIterator();
                                itr.hasNext();) {
    ...
    public void prepareSingerMenu(RendererKind renderer) {
        ...
        if ((renderer == RendererKind.UTAU) || (renderer == RendererKind.VCNT)) {
            ...
            items = new Vector<SingerConfig>(Arrays.asList(
                        VocaloSysUtil.getSingerConfigs(
        ...
        for (Iterator<SingerConfig> itr = items.iterator(); itr.hasNext();) {
            ...
            if ((renderer == RendererKind.UTAU) ||
                ...
                if (sc != null) {
                    tip = "Original: " +
                        VocaloSysUtil.getOriginalSinger(sc.Language,
                            sc.Program, SynthesizerType.VOCALOID1) +
                        "\nHarmonics: " + sc.Harmonics + "\nNoise: " +
                        sc.Breathiness + "\nBrightness: " + sc.Brightness +
                        "\nClearness: " + sc.Clearness + "\nGender Factor: " +
                        sc.GenderFactor + "\nReso1(Freq,BandWidth,Amp): " +
                        sc.Resonance1Frequency + ", " + sc.Resonance1BandWidth +
                        ", " + sc.Resonance1Amplitude +
                        "\nReso2(Freq,BandWidth,Amp): " +
                        sc.Resonance2Frequency + ", " + sc.Resonance2BandWidth +
                        ", " + sc.Resonance2Amplitude +
                        "\nReso3(Freq,BandWidth,Amp): " +
                        sc.Resonance3Frequency + ", " + sc.Resonance3BandWidth +
                        ", " + sc.Resonance3Amplitude +
                        "\nReso4(Freq,BandWidth,Amp): " +
                        sc.Resonance4Frequency + ", " + sc.Resonance4BandWidth +
                        ", " + sc.Resonance4Amplitude;
                }
            } else if (renderer == RendererKind.VOCALOID2) {
                if (sc != null) {
                    tip = "Original: " +
                        VocaloSysUtil.getOriginalSinger(sc.Language,
                            sc.Program, SynthesizerType.VOCALOID2) +
            ...
            if (sc != null) {
                TrackSelectorSingerDropdownMenuItem tsmi = new TrackSelectorSingerDropdownMenuItem();
        ...
        cmenuSinger.visibleChangedEvent.add(new BEventHandler(this,
                "cmenuSinger_VisibleChanged"));
    ...
    public void cmenusinger_Click(Object sender, BEventArgs e) {
        ...
        if (item != null) {
            ...
            if (cmenuSinger.SingerChangeExists) {
                ...
                CadenciiCommand run = new CadenciiCommand(VsqCommand.generateCommandEventAdd(
                            selected, ve));
                executeCommand(run, true);
            }
        }
    ...
    private void registerEventHandlers() {
        this.cmenuCurveVelocity.clickEvent.add(new BEventHandler(this,
                "cmenuCurveCommon_Click"));
        this.cmenuCurveAccent.clickEvent.add(new BEventHandler(this,
                "cmenuCurveCommon_Click"));
        this.cmenuCurveDecay.clickEvent.add(new BEventHandler(this,
                "cmenuCurveCommon_Click"));
        this.cmenuCurveDynamics.clickEvent.add(new BEventHandler(this,
                "cmenuCurveCommon_Click"));
        this.cmenuCurveVibratoRate.clickEvent.add(new BEventHandler(this,
                "cmenuCurveCommon_Click"));
        this.cmenuCurveVibratoDepth.clickEvent.add(new BEventHandler(this,
                "cmenuCurveCommon_Click"));
        this.cmenuCurveReso1Freq.clickEvent.add(new BEventHandler(this,
                "cmenuCurveCommon_Click"));
        this.cmenuCurveReso1BW.clickEvent.add(new BEventHandler(this,
                "cmenuCurveCommon_Click"));
        this.cmenuCurveReso1Amp.clickEvent.add(new BEventHandler(this,
                "cmenuCurveCommon_Click"));
        this.cmenuCurveReso2Freq.clickEvent.add(new BEventHandler(this,
                "cmenuCurveCommon_Click"));
        this.cmenuCurveReso2BW.clickEvent.add(new BEventHandler(this,
                "cmenuCurveCommon_Click"));
        this.cmenuCurveReso2Amp.clickEvent.add(new BEventHandler(this,
                "cmenuCurveCommon_Click"));
        this.cmenuCurveReso3Freq.clickEvent.add(new BEventHandler(this,
                "cmenuCurveCommon_Click"));
        this.cmenuCurveReso3BW.clickEvent.add(new BEventHandler(this,
                "cmenuCurveCommon_Click"));
        this.cmenuCurveReso3Amp.clickEvent.add(new BEventHandler(this,
                "cmenuCurveCommon_Click"));
        this.cmenuCurveReso4Freq.clickEvent.add(new BEventHandler(this,
                "cmenuCurveCommon_Click"));
        this.cmenuCurveReso4BW.clickEvent.add(new BEventHandler(this,
                "cmenuCurveCommon_Click"));
        this.cmenuCurveReso4Amp.clickEvent.add(new BEventHandler(this,
                "cmenuCurveCommon_Click"));
        this.cmenuCurveHarmonics.clickEvent.add(new BEventHandler(this,
                "cmenuCurveCommon_Click"));
        this.cmenuCurveBreathiness.clickEvent.add(new BEventHandler(this,
                "cmenuCurveCommon_Click"));
        this.cmenuCurveBrightness.clickEvent.add(new BEventHandler(this,
                "cmenuCurveCommon_Click"));
        this.cmenuCurveClearness.clickEvent.add(new BEventHandler(this,
                "cmenuCurveCommon_Click"));
        this.cmenuCurveOpening.clickEvent.add(new BEventHandler(this,
                "cmenuCurveCommon_Click"));
        this.cmenuCurveGenderFactor.clickEvent.add(new BEventHandler(this,
                "cmenuCurveCommon_Click"));
        this.cmenuCurvePortamentoTiming.clickEvent.add(new BEventHandler(this,
                "cmenuCurveCommon_Click"));
        this.cmenuCurvePitchBend.clickEvent.add(new BEventHandler(this,
                "cmenuCurveCommon_Click"));
        this.cmenuCurvePitchBendSensitivity.clickEvent.add(new BEventHandler(
                this, "cmenuCurveCommon_Click"));
        this.cmenuCurveEffect2Depth.clickEvent.add(new BEventHandler(this,
                "cmenuCurveCommon_Click"));
        this.cmenuCurveEnvelope.clickEvent.add(new BEventHandler(this,
                "cmenuCurveCommon_Click"));

        this.mouseMoveEvent.add(new BMouseEventHandler(this,
                "TrackSelector_MouseMove"));
        this.mouseDoubleClickEvent.add(new BMouseEventHandler(this,
                "TrackSelector_MouseDoubleClick"));
        this.keyUpEvent.add(new BKeyEventHandler(this, "TrackSelector_KeyUp"));
        this.mouseClickEvent.add(new BMouseEventHandler(this,
                "TrackSelector_MouseClick"));
        this.mouseDownEvent.add(new BMouseEventHandler(this,
                "TrackSelector_MouseDown"));
        this.mouseUpEvent.add(new BMouseEventHandler(this,
    ...
    private enum MouseDownMode {NONE,
        CURVE_EDIT,
        TRACK_LIST,
        SINGER_LIST,
