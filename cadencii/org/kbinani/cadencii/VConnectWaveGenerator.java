...
import org.kbinani.vsq.*;
    ...
    public class VConnectWaveGenerator extends WaveUnit implements WaveGenerator
    {
        ...
        /// シンセサイザの実行ファイル名
        /// </summary>
        public static final String STRAIGHT_SYNTH = fsys.combine( fsys.combine("usr", "bin"), "vconnect_stand");
...
try {
    ...
    Logger.write( VConnectWaveGenerator.class + ".prepareMetaText; ex=" + ex + "\n" );
}
        }
