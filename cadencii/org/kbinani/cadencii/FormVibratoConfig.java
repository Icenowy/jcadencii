...
public class FormVibratoConfig extends BDialog {
    ...
    public FormVibratoConfig(VibratoHandle vibrato_handle, int note_length,
        DefaultVibratoLengthEnum default_vibrato_length, SynthesizerType type,
    ...
    private void updateComboBoxStatus() {
        ...
        if (radioUserDefined.isSelected()) {
            ...
            SynthesizerType type = radioVocaloid1.isSelected()
                ? SynthesizerType.VOCALOID1 : SynthesizerType.VOCALOID2;
    ...
    private void registerEventHandlers() {
        ...
        radioUserDefined.checkedChangedEvent.add(new BEventHandler(this,
                "handleRadioCheckedChanged"));
        comboVibratoType.selectedIndexChangedEvent.add(new BEventHandler(this,
                "comboVibratoType_SelectedIndexChanged"));
        txtVibratoLength.textChangedEvent.add(new BEventHandler(this,
                "txtVibratoLength_TextChanged"));
    }

    public void handleRadioCheckedChanged(Object sender, BEventArgs e) {
        comboVibratoType.selectedIndexChangedEvent.remove(new BEventHandler(
                this, "comboVibratoType_SelectedIndexChanged"));
        updateComboBoxStatus();
        comboVibratoType.selectedIndexChangedEvent.add(new BEventHandler(this,
                "comboVibratoType_SelectedIndexChanged"));
    }
    ...
    public void comboVibratoType_SelectedIndexChanged(Object sender,
        BEventArgs e) {
        ...
        if (index >= 0) {
            ...
            if (s.equals("$04040000")) {
                ...
                if (radioUserDefined.isSelected()) {
                    ...
                    for (int i = 0; i < size; i++) {
                        VibratoHandle handle = vec.get(AppManager.editorConfig.AutoVibratoCustom,
                                i);
