...
public class FormShortcutKeys extends BDialog {
    ...
    private static final String[] mCategories = new String[] {
            "menuFile", "menuEdit", "menuVisual", "menuJob", "menuLyric",
            "menuTrack", "menuScript", "menuSetting", "menuHelp", ".other"
        };
    ...
    public FormShortcutKeys(TreeMap<String, ValuePair<String, BKeys[]>> dict,
        ...
        mMainForm = main_form;
        list.setColumnHeaders(new String[] {
                gettext("Command"), gettext("Shortcut Key")
            });
    ...
    private static void copyDict(
        TreeMap<String, ValuePair<String, BKeys[]>> src,
        TreeMap<String, ValuePair<String, BKeys[]>> dest) {
        dest.clear();
        ...
        for (Iterator<String> itr = src.keySet().iterator(); itr.hasNext();) {
            ...
            dest.put(name,
                new ValuePair<String, BKeys[]>(key, cp.toArray(new BKeys[] {  })));
        }
    }
    ...
    private void updateList() {
        list.selectedIndexChangedEvent.remove(new BEventHandler(this,
                "list_SelectedIndexChanged"));
        list.clear();
        list.selectedIndexChangedEvent.add(new BEventHandler(this,
                "list_SelectedIndexChanged"));
        mFieldName.clear();
        ...
        for (Iterator<String> itr = mDict.keySet().iterator(); itr.hasNext();) {
            ...
            if (add_this_one) {
                list.addRow(new String[] {
                        display, Utility.getShortcutDisplayString(keys)
                    });
    ...
    private void updateColor() {
        ...
        for (int i = 0; i < size; i++) {
            ...
            for (Iterator<String> itr = mDict.keySet().iterator();
                    itr.hasNext();) {
    ...
    private void registerEventHandlers() {
        ...
        btnLoadDefault.clickEvent.add(new BEventHandler(this,
        ...
        this.formClosingEvent.add(new BFormClosingEventHandler(this,
                "FormShortcutKeys_FormClosing"));
        btnOK.clickEvent.add(new BEventHandler(this, "btnOK_Click"));
        btnCancel.clickEvent.add(new BEventHandler(this, "btnCancel_Click"));
        comboCategory.selectedIndexChangedEvent.add(new BEventHandler(this,
                "comboCategory_SelectedIndexChanged"));
        list.selectedIndexChangedEvent.add(new BEventHandler(this,
                "list_SelectedIndexChanged"));
        this.sizeChangedEvent.add(new BEventHandler(this,
                "FormShortcutKeys_SizeChanged"));
        reRegisterHandlers();
    }

    private void unRegisterHandlers() {
        comboEditKey.selectedIndexChangedEvent.remove(new BEventHandler(this,
                "comboEditKey_SelectedIndexChanged"));
        checkCommand.checkedChangedEvent.remove(new BEventHandler(this,
                "handleModifier_CheckedChanged"));
        checkShift.checkedChangedEvent.remove(new BEventHandler(this,
                "handleModifier_CheckedChanged"));
        checkControl.checkedChangedEvent.remove(new BEventHandler(this,
                "handleModifier_CheckedChanged"));
        checkOption.checkedChangedEvent.remove(new BEventHandler(this,
                "handleModifier_CheckedChanged"));
    }

    private void reRegisterHandlers() {
        comboEditKey.selectedIndexChangedEvent.add(new BEventHandler(this,
                "comboEditKey_SelectedIndexChanged"));
        checkCommand.checkedChangedEvent.add(new BEventHandler(this,
                "handleModifier_CheckedChanged"));
        checkShift.checkedChangedEvent.add(new BEventHandler(this,
                "handleModifier_CheckedChanged"));
        checkControl.checkedChangedEvent.add(new BEventHandler(this,
                "handleModifier_CheckedChanged"));
        checkOption.checkedChangedEvent.add(new BEventHandler(this,
                "handleModifier_CheckedChanged"));
    }
    ...
    public void FormShortcutKeys_FormClosing(Object sender,
