...
public class VibratoPointIteratorBySec implements Iterator<PointD> {
    ...
    public VibratoPointIteratorBySec(VsqFileEx vsq, VibratoBPList rate,
        int start_rate, VibratoBPList depth, int start_depth, int clock_start,
        int clock_width, float sec_resolution) {
        this.vsq = vsq;
        this.rate = rate;
