...
// イベントハンドラを一時的に取り除く
textDepth.textChangedEvent.remove( new BEventHandler( this, "textDepth_TextChanged" ) );
textRate.textChangedEvent.remove( new BEventHandler( this, "textRate_TextChanged" ) );
textName.textChangedEvent.remove( new BEventHandler( this, "textName_TextChanged" ) );
...
// イベントハンドラを再登録
textDepth.textChangedEvent.add( new BEventHandler( this, "textDepth_TextChanged" ) );
textRate.textChangedEvent.add( new BEventHandler( this, "textRate_TextChanged" ) );
textName.textChangedEvent.add( new BEventHandler( this, "textName_TextChanged" ) );
...
buttonUp.clickEvent.add( new BEventHandler( this, "handleUpDownButtonClick" ) );
buttonDown.clickEvent.add( new BEventHandler( this, "handleUpDownButtonClick" ) );

pictureDepth.paintEvent.add( new BPaintEventHandler( this, "pictureDepth_Paint" ) );
pictureRate.paintEvent.add( new BPaintEventHandler( this, "pictureRate_Paint" ) );
pictureResulting.paintEvent.add( new BPaintEventHandler( this, "pictureResulting_Paint" ) );
