    ...
    for ( int j = 0; j < list.size(); j++ ) {
        ...
        if ( start < chain_start && chain_start <= end && end < chain_end ) {
            ...
            try {
                ...
                Logger.write( BezierCurves.class + ".mergeBezierChain; ex=" + ex + "\n" );
                continue;
            }
            bc_edit.id = bc.id;
    ...
    for ( Iterator<BezierChain> itr = this.get( curve ).iterator(); itr.hasNext(); ) {
        ...
        if ( clock_start < chain_start && chain_start < clock_end && clock_end < chain_end ) {
            ...
            try {
                ...
                Logger.write( BezierCurves.class + ".deleteBeziers; ex=" + ex + "\n" );
            }
            ...
            try {
                ...
                Logger.write( BezierCurves.class + ".deleteBeiers; ex=" + ex + "\n" );
            }
