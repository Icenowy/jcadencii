...
public class FormMidiImExport extends BDialog {
    ...
    public FormMidiImExport() {
        ...
        listTrack.setColumnHeaders(new String[] {
                gettext("Track"), gettext("Name"), gettext("Notes")
            });
    ...
    public double getOffsetSeconds() {
        ...
        try {
            ...
            Logger.write(FormMidiImExport.class + ".getOffsetSeconds; ex=" +
                ex + "\n");
    ...
    public int getOffsetClocks() {
        ...
        try {
            ...
            Logger.write(FormMidiImExport.class + ".getOffsetClocks; ex=" + ex +
                "\n");
            serr.println("FormMidiImExport#getOffsetClocks; ex=" + ex);
        }
    ...
    private void registerEventHandlers() {
        ...
        btnUncheckAll.clickEvent.add(new BEventHandler(this,
                "btnUnckeckAll_Click"));
        chkNote.checkedChangedEvent.add(new BEventHandler(this,
                "chkNote_CheckedChanged"));
        chkMetaText.clickEvent.add(new BEventHandler(this, "chkMetaText_Click"));
        chkExportVocaloidNrpn.checkedChangedEvent.add(new BEventHandler(this,
                "chkExportVocaloidNrpn_CheckedChanged"));
        chkExportVocaloidNrpn.checkedChangedEvent.add(new BEventHandler(this,
                "chkExportVocaloidNrpn_CheckedChanged"));
        this.formClosingEvent.add(new BFormClosingEventHandler(this,
                "FormMidiImExport_FormClosing"));
        btnOK.clickEvent.add(new BEventHandler(this, "btnOK_Click"));
        btnCancel.clickEvent.add(new BEventHandler(this, "btnCancel_Click"));
        radioGateTime.checkedChangedEvent.add(new BEventHandler(this,
                "radioGateTime_CheckedChanged"));
        radioPlayTime.checkedChangedEvent.add(new BEventHandler(this,
                "radioPlayTime_CheckedChanged"));
    }
    ...
    public void FormMidiImExport_FormClosing(Object sender,
    ...
    private JPanel getGroupCommonOption() {
        if (groupCommonOption == null) {
            ...
            groupCommonOption.setBorder(BorderFactory.createTitledBorder(null,
                    "Option", TitledBorder.DEFAULT_JUSTIFICATION,
    ...
    private BGroupBox getGroupMode() {
        if (groupMode == null) {
            ...
            groupMode.setBorder(BorderFactory.createTitledBorder(null,
                    "Import Basis", TitledBorder.DEFAULT_JUSTIFICATION,
                    TitledBorder.DEFAULT_POSITION,
                    new Font("Dialog", Font.BOLD, 12), new Color(51, 51, 51)));
    ...
    public enum FormMidiMode {IMPORT,
        EXPORT,
        IMPORT_VSQ;
    }
}
