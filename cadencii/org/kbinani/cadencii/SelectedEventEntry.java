...
public class SelectedEventEntry implements IPropertyDescriptor {
    ...
    public void captureValuesFromEditing() {
        ...
        if ((editing.ID.LyricHandle != null) &&
                (editing.ID.LyricHandle.L0 != null)) {
            m_symbol_protected = editing.ID.LyricHandle.L0.PhoneticSymbolProtected
                ? BooleanEnum.On : BooleanEnum.Off;
        }
        ...
        if ((editing.ID.PMbPortamentoUse == 1) ||
                (editing.ID.PMbPortamentoUse == 3)) {
    ...
    private int calculateClock(int measure, int beat, int gate) {
        ...
        if (vsq == null) {
            ...
            return (((((measure + premeasure) - 1) * 4) + (beat - 1)) * 480) +
            gate;
        } else {
            int premeasure = vsq.getPreMeasure();
            int bartopclock = vsq.getClockFromBarCount((measure + premeasure) -
                    1);
            Timesig timesig = vsq.getTimesigAt(bartopclock);

            return bartopclock +
            (((beat - 1) * 480 * 4) / timesig.denominator) + gate;
        }
    }
    ...
    private PositionSpec getPosition() {
        ...
        int clock_bartop = vsq.getClockFromBarCount((ret.measure + premeasure) -
                1);
    ...
    public static int evalReceivedString(int old_value, String received_string) {
        ...
        if (received_string.startsWith("+") || received_string.startsWith("-") ||
                received_string.startsWith("*") ||
                received_string.startsWith("/")) {
            try {
    ...
    public void setPhrase(String value) {
        ...
        if (!old.equals(value)) {
            ...
            String[] spl = PortUtil.splitString(phonetic_symbol,
                    new char[] { ' ', ',' }, true);
            String consonant_adjustment = "";

            for (int i = 0; i < spl.length; i++) {
                consonant_adjustment += (((i == 0) ? "" : " ") +
                (VsqPhoneticSymbol.isConsonant(spl[i]) ? 64 : 0));
            }
            ...
            if (vsq != null) {
                ...
                SingerConfig sc = AppManager.getSingerInfoUtau(singer.ID.IconHandle.Language,
                        singer.ID.IconHandle.Program);

                if ((sc != null) &&
                        AppManager.mUtauVoiceDB.containsKey(sc.VOICEIDSTR)) {
    ...
    public void setCosonantAdjustment(String value) {
        ...
        String[] symbol = PortUtil.splitString(editing.ID.LyricHandle.L0.getPhoneticSymbol(),
                new char[] { ' ' }, true);
        String[] adjustment = PortUtil.splitString(value,
                new char[] { ' ', ',' }, true);
    ...
    public void setProtect(BooleanEnum value) {
        ...
        editing.ID.LyricHandle.L0.PhoneticSymbolProtected = (value == BooleanEnum.On)
            ? true : false;
    }
    ...
    public void setLength(String value) {
        ...
        // ビブラートの長さを調節
        Utility.editLengthOfVsqEvent(editing, draft,
    ...
    public void setUpPortamento(BooleanEnum value) {
        ...
        editing.ID.PMbPortamentoUse = ((m_portamento_up == BooleanEnum.On) ? 1 : 0) +
            ((m_portamento_down == BooleanEnum.On) ? 2 : 0);
    }
    ...
    public void setVibrato(VibratoVariation value) {
        if (value.description.equals(VibratoVariation.empty.description)) {
            ...
            if ((m_vibrato != null) && (value != null) &&
                    !m_vibrato.equals(value)) {
        ...
        if (value <= 0) {
            ...
            if (editing.ID.VibratoHandle == null) {
                ...
                if (vsq != null) {
                    ...
                    editing.ID.VibratoHandle = AppManager.editorConfig.createAutoVibrato(type,
                            480); // 480はダミー
                }
            ...
            editing.ID.VibratoDelay = editing.ID.getLength() -
                editing.ID.VibratoHandle.getLength();
    ...
    public void setRelease(int value) {
        ...
        e.Tag = editing.Tag;
        VsqFileEx.setEventTag(e, VsqFileEx.TAG_VSQEVENT_AQUESTONE_RELEASE,
            r + "");
        editing.Tag = e.Tag;
    }
    ...
    public int getRelease() {
        ...
        String v = VsqFileEx.getEventTag(e,
                VsqFileEx.TAG_VSQEVENT_AQUESTONE_RELEASE);
        int value = 64;
