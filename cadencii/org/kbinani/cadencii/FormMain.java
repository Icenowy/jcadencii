...
public class FormMain extends BForm implements FormMainUi {
    ...
    private final AuthorListEntry[] _CREDIT = new AuthorListEntry[] {
            ...
            new AuthorListEntry("結晶", "@gondam"), new AuthorListEntry(""),
            new AuthorListEntry(), new AuthorListEntry(),
            new AuthorListEntry("Special Thanks to", 3), new AuthorListEntry(),
            ...
            new AuthorListEntry("修羅場P", "@shurabaP"), new AuthorListEntry(),
            new AuthorListEntry("developper of UTAU:", 2),
            new AuthorListEntry("飴屋/菖蒲", "@ameyaP_"), new AuthorListEntry(),
            new AuthorListEntry("developper of RebarDotNet:", 2),
            new AuthorListEntry("Anthony Baraff"), new AuthorListEntry(),
            new AuthorListEntry("promoter:", 2),
            new AuthorListEntry("zhuo", "@zhuop"), new AuthorListEntry(),
            new AuthorListEntry("library tester:", 2),
            new AuthorListEntry("evm"), new AuthorListEntry("そろそろP"),
            new AuthorListEntry("めがね１１０"), new AuthorListEntry("上総"),
            new AuthorListEntry("NOIKE", "@knoike"), new AuthorListEntry("逃亡者"),
            new AuthorListEntry(), new AuthorListEntry("translator:", 2),
            ...
            new AuthorListEntry(), new AuthorListEntry(),
            new AuthorListEntry("Thanks to", 3), new AuthorListEntry(),
            new AuthorListEntry("ないしょの人"), new AuthorListEntry("naquadah"),
            new AuthorListEntry("1zo"), new AuthorListEntry("Amby"),
            new AuthorListEntry("ケロッグ"), new AuthorListEntry("beginner"),
            new AuthorListEntry("b2ox", "@b2ox"), new AuthorListEntry("麻太郎"),
            ...
            new AuthorListEntry("ちょむ"), new AuthorListEntry("whimsoft"),
            new AuthorListEntry("kitiketao", "@okoktaokokta"),
            new AuthorListEntry("カプチ２"), new AuthorListEntry("あにぃ"),
            new AuthorListEntry("tomo"),
            new AuthorListEntry("ナウ□マP", "@now_romaP"),
            new AuthorListEntry("内藤　魅亜", "@mianaito"),
            new AuthorListEntry("空茶", "@maizeziam"), new AuthorListEntry("いぬくま"),
            ...
            new AuthorListEntry("ぎんじ"), new AuthorListEntry("BeForU", "@BeForU"),
            new AuthorListEntry("all members of Cadencii bbs", 2),
            new AuthorListEntry(), new AuthorListEntry("     ... and you !", 3),
        };
    ...
    public FormMain(FormMainController controller, String file) {
        ...
        AppManager.superFont10Bold = new Font(AppManager.editorConfig.BaseFontName,
                java.awt.Font.BOLD, AppManager.FONT_SIZE10);
        AppManager.superFont8 = new Font(AppManager.editorConfig.BaseFontName,
                java.awt.Font.PLAIN, AppManager.FONT_SIZE8);
        AppManager.superFont10 = new Font(AppManager.editorConfig.BaseFontName,
                java.awt.Font.PLAIN, AppManager.FONT_SIZE10);
        AppManager.superFont9 = new Font(AppManager.editorConfig.BaseFontName,
                java.awt.Font.PLAIN, AppManager.FONT_SIZE9);
        AppManager.superFont50Bold = new Font(AppManager.editorConfig.BaseFontName,
                java.awt.Font.BOLD, AppManager.FONT_SIZE50);

        s_modifier_key = InputEvent.CTRL_MASK;
        ...
        panelWaveformZoom = (WaveformZoomUiImpl) (new WaveformZoomController(this,
                waveView)).getUi();
        ...
        trackSelector.mouseClickEvent.add(new BMouseEventHandler(this,
                "trackSelector_MouseClick"));
        trackSelector.mouseUpEvent.add(new BMouseEventHandler(this,
                "trackSelector_MouseUp"));
        trackSelector.mouseDownEvent.add(new BMouseEventHandler(this,
                "trackSelector_MouseDown"));
        trackSelector.mouseMoveEvent.add(new BMouseEventHandler(this,
                "trackSelector_MouseMove"));
        trackSelector.keyDownEvent.add(new BKeyEventHandler(this,
                "handleSpaceKeyDown"));
        trackSelector.keyUpEvent.add(new BKeyEventHandler(this,
                "handleSpaceKeyUp"));
        trackSelector.previewKeyDownEvent.add(new BPreviewKeyDownEventHandler(
                this, "trackSelector_PreviewKeyDown"));
        trackSelector.selectedTrackChangedEvent.add(new SelectedTrackChangedEventHandler(
                this, "trackSelector_SelectedTrackChanged"));
        trackSelector.selectedCurveChangedEvent.add(new SelectedCurveChangedEventHandler(
                this, "trackSelector_SelectedCurveChanged"));
        trackSelector.renderRequiredEvent.add(new RenderRequiredEventHandler(
                this, "trackSelector_RenderRequired"));
        trackSelector.preferredMinHeightChangedEvent.add(new BEventHandler(
                this, "trackSelector_PreferredMinHeightChanged"));
        trackSelector.mouseDoubleClickEvent.add(new BMouseEventHandler(this,
                "trackSelector_MouseDoubleClick"));
        ...
        pictPianoRoll.mouseWheelEvent.add(new BMouseEventHandler(this,
                "pictPianoRoll_MouseWheel"));
        trackSelector.mouseWheelEvent.add(new BMouseEventHandler(this,
                "trackSelector_MouseWheel"));
        picturePositionIndicator.mouseWheelEvent.add(new BMouseEventHandler(
                this, "picturePositionIndicator_MouseWheel"));

        menuVisualOverview.checkedChangedEvent.add(new BEventHandler(this,
                "menuVisualOverview_CheckedChanged"));
        ...
        AppManager.mInputTextBox.setFont(new Font(
                AppManager.editorConfig.BaseFontName, java.awt.Font.PLAIN, 9));
        AppManager.mInputTextBox.setEnabled(false);
        AppManager.mInputTextBox.keyPressEvent.add(new BKeyPressEventHandler(
                this, "mInputTextBox_KeyPress"));
        ...
        AppManager.previewStartedEvent.add(new BEventHandler(this,
                "AppManager_PreviewStarted"));
        AppManager.previewAbortedEvent.add(new BEventHandler(this,
                "AppManager_PreviewAborted"));
        AppManager.gridVisibleChangedEvent.add(new BEventHandler(this,
                "AppManager_GridVisibleChanged"));
        AppManager.itemSelection.selectedEventChangedEvent.add(new SelectedEventChangedEventHandler(
                this, "ItemSelectionModel_SelectedEventChanged"));
        AppManager.selectedToolChangedEvent.add(new BEventHandler(this,
                "AppManager_SelectedToolChanged"));
        AppManager.updateBgmStatusRequiredEvent.add(new BEventHandler(this,
                "AppManager_UpdateBgmStatusRequired"));
        AppManager.mainWindowFocusRequiredEvent.add(new BEventHandler(this,
                "AppManager_MainWindowFocusRequired"));
        AppManager.editedStateChangedEvent.add(new EditedStateChangedEventHandler(
                this, "AppManager_EditedStateChanged"));
        AppManager.waveViewReloadRequiredEvent.add(new WaveViewRealoadRequiredEventHandler(
                this, "AppManager_WaveViewRealoadRequired"));
        EditorConfig.quantizeModeChangedEvent.add(new BEventHandler(this,
                "handleEditorConfig_QuantizeModeChanged"));

        mPropertyPanelContainer.stateChangeRequiredEvent.add(new StateChangeRequiredEventHandler(
                this, "mPropertyPanelContainer_StateChangeRequired"));

        updateRecentFileMenu();

        // C3が画面中央に来るように調整
        int draft_start_to_draw_y = (68 * (int) (100 * controller.getScaleY())) -
            (pictPianoRoll.getHeight() / 2);
        int draft_vscroll_value = (int) ((draft_start_to_draw_y * (double) vScroll.getMaximum()) / ((128 * (int) (100 * controller.getScaleY())) -
            vScroll.getHeight()));
        ...
        int draft_hscroll_value = (int) (cp -
            (24.0 * controller.getScaleXInv()));
        ...
        AppManager.mMixerWindow.federChangedEvent.add(new FederChangedEventHandler(
                this, "mixerWindow_FederChanged"));
        AppManager.mMixerWindow.panpotChangedEvent.add(new PanpotChangedEventHandler(
                this, "mixerWindow_PanpotChanged"));
        AppManager.mMixerWindow.muteChangedEvent.add(new MuteChangedEventHandler(
                this, "mixerWindow_MuteChanged"));
        AppManager.mMixerWindow.soloChangedEvent.add(new SoloChangedEventHandler(
                this, "mixerWindow_SoloChanged"));
        ...
        AppManager.mMixerWindow.formClosingEvent.add(new BFormClosingEventHandler(
                this, "mixerWindow_FormClosing"));
        ...
        AppManager.iconPalette.formClosingEvent.add(new BFormClosingEventHandler(
                this, "iconPalette_FormClosing"));
        AppManager.iconPalette.locationChangedEvent.add(new BEventHandler(
                this, "iconPalette_LocationChanged"));

        trackSelector.commandExecutedEvent.add(new BEventHandler(this,
                "trackSelector_CommandExecuted"));
        ...
        this.windowStateChangedEvent.add(new BEventHandler(this,
                "FormMain_WindowStateChanged"));
        this.locationChangedEvent.add(new BEventHandler(this,
        ...
        Rectangle rc = new Rectangle(a.x, a.y,
        ...
        AppManager.propertyWindow.windowStateChangedEvent.add(new BEventHandler(
                this, "propertyWindow_WindowStateChanged"));
        AppManager.propertyWindow.locationChangedEvent.add(new BEventHandler(
                this, "propertyWindow_LocationOrSizeChanged"));
        AppManager.propertyWindow.sizeChangedEvent.add(new BEventHandler(this,
                "propertyWindow_LocationOrSizeChanged"));
        AppManager.propertyWindow.formClosingEvent.add(new BFormClosingEventHandler(
                this, "propertyWindow_FormClosing"));
        AppManager.propertyPanel.commandExecuteRequiredEvent.add(new CommandExecuteRequiredEventHandler(
                this, "propertyPanel_CommandExecuteRequired"));
        updateBgmMenuState();
    ...
    private void checkUnknownResamplerAndSinger(ByRef<String> resampler_path,
        ...
        if (str.startsWith(singer_path.value, search) &&
                (str.length(singer_path.value) > str.length(search))) {
            singer_path.value = str.sub(singer_path.value, str.length(search));
            singer_path.value = fsys.combine(fsys.combine(utau_dir, "voice"),
                    singer_path.value);
        }
        ...
        if (fsys.isFileExists(fsys.combine(singer_path.value, "oto.ini"))) {
            ...
            for (int i = 0; i < vec.size(AppManager.editorConfig.UtauSingers);
                    i++) {
        ...
        if (!str.compare(resampler_dir, "") &&
                fsys.isFileExists(resampler_path.value)) {
            boolean found = false;

            for (int i = 0; i < AppManager.editorConfig.getResamplerCount();
                    i++) {
        ...
        try {
            if (check_unknown_singer || check_unknwon_resampler) {
                dialog = new FormCheckUnknownSingerAndResampler(singer_path.value,
                        check_unknown_singer, resampler_path.value,
                        check_unknwon_resampler);
            ...
            Logger.write(FormMain.class +
                ".checkUnknownResamplerAndSinger; ex=" + ex + "\n");
        } finally {
            if (dialog != null) {
                try {
                    dialog.close();
    ...
    private void updateVibratoPresetMenu() {
        ...
        for (int i = 0; i < size; i++) {
            ...
            item.clickEvent.add(new BEventHandler(this,
                    "handleVibratoPresetSubelementClick"));
    ...
    private void updateNoteLengthStepSequencer() {
        ...
        Utility.editLengthOfVsqEvent(item, length,
    ...
    private void fixAddingEvent() {
        ...
        if (AppManager.editorConfig.EnableAutoVibrato) {
            ...
            if (note_length >= threshold) {
                ...
                vibrato = AppManager.editorConfig.createAutoVibrato(type,
                        vibrato_clocks);
        ...
        if ((item != null) && (item.ID != null) &&
                (item.ID.IconHandle != null)) {
            singerConfig = AppManager.getSingerInfoUtau(item.ID.IconHandle.Language,
                    item.ID.IconHandle.Program);
        }

        if ((singerConfig != null) &&
                AppManager.mUtauVoiceDB.containsKey(singerConfig.VOICEIDSTR)) {
        ...
        if (AppManager.mAutoNormalize) {
            ...
            while (changed) {
                ...
                for (int i = 0; i < work.getEventCount(); i++) {
                    ...
                    int end_clock = work.getEvent(i).ID.getLength() +
                        start_clock;

                    if ((start_clock < AppManager.mAddingEvent.Clock) &&
                            (AppManager.mAddingEvent.Clock < end_clock)) {
                        work.getEvent(i).ID.setLength(AppManager.mAddingEvent.Clock -
                            start_clock);
                        changed = true;
                        ...
                        break;
                    } else if ((AppManager.mAddingEvent.Clock < start_clock) &&
                            (start_clock < (AppManager.mAddingEvent.Clock +
                            AppManager.mAddingEvent.ID.getLength()))) {
                        AppManager.mAddingEvent.ID.setLength(start_clock -
                            AppManager.mAddingEvent.Clock);
                        changed = true;
                    }
                }
            }
            ...
            AppManager.editHistory.register(AppManager.getVsqFile()
                                                      .executeCommand(run));
            setEdited(true);
        } else {
            ...
            CadenciiCommand run = new CadenciiCommand(VsqCommand.generateCommandEventAddRange(
                        AppManager.getSelected(), items));
            AppManager.editHistory.register(AppManager.getVsqFile()
                                                      .executeCommand(run));
            setEdited(true);
        }
    ...
    private void lengthenSelectedEvent(int delta_length) {
        ...
        for (Iterator<SelectedEventEntry> itr = AppManager.itemSelection.getEventIterator();
            ...
            Utility.editLengthOfVsqEvent(add, draft,
                AppManager.vibratoLengthEditingRule);
            items.add(add);
        }
        ...
        // コマンドを発行
        CadenciiCommand run = new CadenciiCommand(VsqCommand.generateCommandEventReplaceRange(
    ...
    private void moveUpDownLeftRight(int delta_note, int delta_clock) {
        ...
        for (Iterator<SelectedEventEntry> itr = AppManager.itemSelection.getEventIterator();
            ...
            if ((delta_note != 0) && (0 <= (note + delta_note)) &&
                    ((note + delta_note) <= 127)) {
    ...
    /// <returns></returns>
    private VsqEvent getItemAtClickedPosition(Point mouse_position,
        ...
        synchronized (AppManager.mDrawObjects) {
            Vector<DrawObject> dobj_list = AppManager.mDrawObjects.get(selected -
                    1);
    ...
    private int computeVScrollValueForMiddleDrag(int mouse_y) {
        ...
        double new_vscroll_value = (double) mMiddleButtonVScroll -
            ((dy * max) / ((128.0 * (int) (100.0 * controller.getScaleY())) -
            (double) pictPianoRoll.getHeight()));
    ...
    private int computeHScrollValueForMiddleDrag(int mouse_x) {
        ...
        double new_hscroll_value = (double) mMiddleButtonHScroll -
            ((double) dx * controller.getScaleXInv());
    ...
    public Vector<ValuePairOfStringArrayOfKeys> getDefaultShortcutKeys() {
        ...
        Vector<ValuePairOfStringArrayOfKeys> ret = new Vector<ValuePairOfStringArrayOfKeys>(Arrays.asList(
                    new ValuePairOfStringArrayOfKeys[] {
                        new ValuePairOfStringArrayOfKeys(
                            menuFileNew.getName(), new BKeys[] { ctrl, BKeys.N }),
                        new ValuePairOfStringArrayOfKeys(
                            menuFileOpen.getName(),
                            new BKeys[] { ctrl, BKeys.O }),
                        new ValuePairOfStringArrayOfKeys(
                            menuFileOpenVsq.getName(), new BKeys[] {  }),
                        new ValuePairOfStringArrayOfKeys(
                            menuFileSave.getName(),
                            new BKeys[] { ctrl, BKeys.S }),
                        new ValuePairOfStringArrayOfKeys(
                            menuFileQuit.getName(),
                            new BKeys[] { ctrl, BKeys.Q }),
                        new ValuePairOfStringArrayOfKeys(
                            menuFileSaveNamed.getName(), new BKeys[] {  }),
                        new ValuePairOfStringArrayOfKeys(
                            menuFileImportVsq.getName(), new BKeys[] {  }),
                        new ValuePairOfStringArrayOfKeys(
                            menuFileOpenUst.getName(), new BKeys[] {  }),
                        new ValuePairOfStringArrayOfKeys(
                            menuFileImportMidi.getName(), new BKeys[] {  }),
                        new ValuePairOfStringArrayOfKeys(
                            menuFileExportWave.getName(), new BKeys[] {  }),
                        new ValuePairOfStringArrayOfKeys(
                            menuFileExportMidi.getName(), new BKeys[] {  }),
                        new ValuePairOfStringArrayOfKeys(
                            menuEditUndo.getName(),
                            new BKeys[] { ctrl, BKeys.Z }),
                        new ValuePairOfStringArrayOfKeys(
                            menuEditRedo.getName(),
                            new BKeys[] { ctrl, BKeys.Shift, BKeys.Z }),
                        new ValuePairOfStringArrayOfKeys(
                            menuEditCut.getName(), new BKeys[] { ctrl, BKeys.X }),
                        new ValuePairOfStringArrayOfKeys(
                            menuEditCopy.getName(),
                            new BKeys[] { ctrl, BKeys.C }),
                        new ValuePairOfStringArrayOfKeys(
                            menuEditPaste.getName(),
                            new BKeys[] { ctrl, BKeys.V }),
                        new ValuePairOfStringArrayOfKeys(
                            menuEditSelectAll.getName(),
                            new BKeys[] { ctrl, BKeys.A }),
                        new ValuePairOfStringArrayOfKeys(
                            menuEditSelectAllEvents.getName(),
                            new BKeys[] { ctrl, BKeys.Shift, BKeys.A }),
                        new ValuePairOfStringArrayOfKeys(
                            menuEditDelete.getName(), new BKeys[] { BKeys.Back }),
                        new ValuePairOfStringArrayOfKeys(
                            menuVisualMixer.getName(), new BKeys[] { BKeys.F3 }),
                        new ValuePairOfStringArrayOfKeys(
                            menuVisualWaveform.getName(), new BKeys[] {  }),
                        new ValuePairOfStringArrayOfKeys(
                            menuVisualProperty.getName(),
                            new BKeys[] { BKeys.F6 }),
                        new ValuePairOfStringArrayOfKeys(
                            menuVisualGridline.getName(), new BKeys[] {  }),
                        new ValuePairOfStringArrayOfKeys(
                            menuVisualStartMarker.getName(), new BKeys[] {  }),
                        new ValuePairOfStringArrayOfKeys(
                            menuVisualEndMarker.getName(), new BKeys[] {  }),
                        new ValuePairOfStringArrayOfKeys(
                            menuVisualLyrics.getName(), new BKeys[] {  }),
                        new ValuePairOfStringArrayOfKeys(
                            menuVisualNoteProperty.getName(), new BKeys[] {  }),
                        new ValuePairOfStringArrayOfKeys(
                            menuVisualPitchLine.getName(), new BKeys[] {  }),
                        new ValuePairOfStringArrayOfKeys(
                            menuVisualIconPalette.getName(),
                            new BKeys[] { BKeys.F4 }),
                        new ValuePairOfStringArrayOfKeys(
                            menuJobNormalize.getName(), new BKeys[] {  }),
                        new ValuePairOfStringArrayOfKeys(
                            menuJobInsertBar.getName(), new BKeys[] {  }),
                        new ValuePairOfStringArrayOfKeys(
                            menuJobDeleteBar.getName(), new BKeys[] {  }),
                        new ValuePairOfStringArrayOfKeys(
                            menuJobRandomize.getName(), new BKeys[] {  }),
                        new ValuePairOfStringArrayOfKeys(
                            menuJobConnect.getName(), new BKeys[] {  }),
                        new ValuePairOfStringArrayOfKeys(
                            menuJobLyric.getName(), new BKeys[] {  }),
                        new ValuePairOfStringArrayOfKeys(
                            menuTrackOn.getName(), new BKeys[] {  }),
                        new ValuePairOfStringArrayOfKeys(
                            menuTrackAdd.getName(), new BKeys[] {  }),
                        new ValuePairOfStringArrayOfKeys(
                            menuTrackCopy.getName(), new BKeys[] {  }),
                        new ValuePairOfStringArrayOfKeys(
                            menuTrackChangeName.getName(), new BKeys[] {  }),
                        new ValuePairOfStringArrayOfKeys(
                            menuTrackDelete.getName(), new BKeys[] {  }),
                        new ValuePairOfStringArrayOfKeys(
                            menuTrackRenderCurrent.getName(), new BKeys[] {  }),
                        new ValuePairOfStringArrayOfKeys(
                            menuTrackRenderAll.getName(), new BKeys[] {  }),
                        new ValuePairOfStringArrayOfKeys(
                            menuTrackOverlay.getName(), new BKeys[] {  }),
                        new ValuePairOfStringArrayOfKeys(
                            menuTrackRendererVOCALOID1.getName(),
                            new BKeys[] {  }),
                        new ValuePairOfStringArrayOfKeys(
                            menuTrackRendererVOCALOID2.getName(),
                            new BKeys[] {  }),
                        new ValuePairOfStringArrayOfKeys(
                            menuTrackRendererUtau.getName(), new BKeys[] {  }),
                        new ValuePairOfStringArrayOfKeys(
                            menuLyricExpressionProperty.getName(),
                            new BKeys[] {  }),
                        new ValuePairOfStringArrayOfKeys(
                            menuLyricVibratoProperty.getName(), new BKeys[] {  }),
                        new ValuePairOfStringArrayOfKeys(
                            menuLyricDictionary.getName(), new BKeys[] {  }),
                        new ValuePairOfStringArrayOfKeys(
                            menuScriptUpdate.getName(), new BKeys[] {  }),
                        new ValuePairOfStringArrayOfKeys(
                            menuSettingPreference.getName(), new BKeys[] {  }),
                        new ValuePairOfStringArrayOfKeys(
                            menuSettingGameControlerSetting.getName(),
                            new BKeys[] {  }),
                        new ValuePairOfStringArrayOfKeys(
                            menuSettingGameControlerLoad.getName(),
                            new BKeys[] {  }),
                        new ValuePairOfStringArrayOfKeys(
                            menuSettingPaletteTool.getName(), new BKeys[] {  }),
                        new ValuePairOfStringArrayOfKeys(
                            menuSettingShortcut.getName(), new BKeys[] {  }),
                        
                //new ValuePairOfStringArrayOfKeys( menuSettingSingerProperty.getName(), new BKeys[]{} ),
                new ValuePairOfStringArrayOfKeys(menuWindowMinimize.getName(),
                            new BKeys[] { ctrl, BKeys.M }),
                        new ValuePairOfStringArrayOfKeys(
                            menuHelpAbout.getName(), new BKeys[] {  }),
                        new ValuePairOfStringArrayOfKeys(
                            menuHiddenEditLyric.getName(),
                            new BKeys[] { BKeys.F2 }),
                        new ValuePairOfStringArrayOfKeys(
                            menuHiddenEditFlipToolPointerPencil.getName(),
                            new BKeys[] { ctrl, BKeys.W }),
                        new ValuePairOfStringArrayOfKeys(
                            menuHiddenEditFlipToolPointerEraser.getName(),
                            new BKeys[] { ctrl, BKeys.E }),
                        new ValuePairOfStringArrayOfKeys(
                            menuHiddenVisualForwardParameter.getName(),
                            new BKeys[] { ctrl, BKeys.Alt, BKeys.PageDown }),
                        new ValuePairOfStringArrayOfKeys(
                            menuHiddenVisualBackwardParameter.getName(),
                            new BKeys[] { ctrl, BKeys.Alt, BKeys.PageUp }),
                        new ValuePairOfStringArrayOfKeys(
                            menuHiddenTrackNext.getName(),
                            new BKeys[] { ctrl, BKeys.PageDown }),
                        new ValuePairOfStringArrayOfKeys(
                            menuHiddenTrackBack.getName(),
                            new BKeys[] { ctrl, BKeys.PageUp }),
                        new ValuePairOfStringArrayOfKeys(
                            menuHiddenSelectBackward.getName(),
                            new BKeys[] { BKeys.Alt, BKeys.Left }),
                        new ValuePairOfStringArrayOfKeys(
                            menuHiddenSelectForward.getName(),
                            new BKeys[] { BKeys.Alt, BKeys.Right }),
                        new ValuePairOfStringArrayOfKeys(
                            menuHiddenMoveUp.getName(),
                            new BKeys[] { BKeys.Shift, BKeys.Up }),
                        new ValuePairOfStringArrayOfKeys(
                            menuHiddenMoveDown.getName(),
                            new BKeys[] { BKeys.Shift, BKeys.Down }),
                        new ValuePairOfStringArrayOfKeys(
                            menuHiddenMoveLeft.getName(),
                            new BKeys[] { BKeys.Shift, BKeys.Left }),
                        new ValuePairOfStringArrayOfKeys(
                            menuHiddenMoveRight.getName(),
                            new BKeys[] { BKeys.Shift, BKeys.Right }),
                        new ValuePairOfStringArrayOfKeys(
                            menuHiddenLengthen.getName(),
                            new BKeys[] { ctrl, BKeys.Right }),
                        new ValuePairOfStringArrayOfKeys(
                            menuHiddenShorten.getName(),
                            new BKeys[] { ctrl, BKeys.Left }),
                        new ValuePairOfStringArrayOfKeys(
                            menuHiddenGoToEndMarker.getName(),
                            new BKeys[] { ctrl, BKeys.End }),
                        new ValuePairOfStringArrayOfKeys(
                            menuHiddenGoToStartMarker.getName(),
                            new BKeys[] { ctrl, BKeys.Home }),
                        new ValuePairOfStringArrayOfKeys(
                            menuHiddenPlayFromStartMarker.getName(),
                            new BKeys[] { ctrl, BKeys.Enter }),
                        new ValuePairOfStringArrayOfKeys(
                            menuHiddenFlipCurveOnPianorollMode.getName(),
                            new BKeys[] { BKeys.Tab }),
                    }));
    ...
    public void updateBgmMenuState() {
        ...
        if (count > 0) {
            for (int i = 0; i < count; i++) {
                ...
                menu_remove.clickEvent.add(new BEventHandler(this,
                        "handleBgmRemove_Click"));
                menu.add(menu_remove);

                BgmMenuItem menu_start_after_premeasure = new BgmMenuItem(i);
                menu_start_after_premeasure.setText(gettext(
                        "Start After Premeasure"));
                menu_start_after_premeasure.setName(
                    "menu_start_after_premeasure" + i);
                menu_start_after_premeasure.setCheckOnClick(true);
                menu_start_after_premeasure.setSelected(item.startAfterPremeasure);
                menu_start_after_premeasure.checkedChangedEvent.add(new BEventHandler(
                        this, "handleBgmStartAfterPremeasure_CheckedChanged"));
                ...
                menu_offset_second.setToolTipText(item.readOffsetSeconds + " " +
                    gettext("seconds"));
                menu_offset_second.clickEvent.add(new BEventHandler(this,
                        "handleBgmOffsetSeconds_Click"));
    ...
    public void updatePropertyPanelState(PanelState state) {
        if (state == PanelState.Docked) {
            ...
            serr.println(
                "fixme: FormMain#updatePropertyPanelState; Panel1MinSize not set");
            ...
            while (before != after) {
                ...
                AppManager.propertyWindow.formClosingEvent.remove(new BFormClosingEventHandler(
                        this, "propertyWindow_FormClosing"));
            ...
            AppManager.propertyWindow.setBounds(new Rectangle(parent.x +
                    property.x, parent.y + property.y, rc.width, rc.height));
            ...
            serr.println(
                "fixme: FormMain#updatePropertyPanelState; splitContainerProperty.Panel1MinSize not set");
            splitContainerProperty.setPanel1Hidden(true);
            splitContainerProperty.setDividerLocation(0);
            splitContainerProperty.setDividerSize(0);
            splitContainerProperty.setSplitterFixed(true);
    ...
    public void updateLayout() {
        ...
        panelWaveformZoom.setSize(new Dimension(keywidth,
                panelWaveformZoom.getHeight()));

        Dimension overview_pref_size = panelOverview.getPreferredSize();

        if (AppManager.editorConfig.OverviewEnabled) {
            panel3.setPreferredSize(new Dimension(
                    (int) overview_pref_size.getWidth(), _OVERVIEW_HEIGHT));

            //panel3.setHeight( _OVERVIEW_HEIGHT );
        } else {
            panel3.setPreferredSize(new Dimension(
                    (int) overview_pref_size.getWidth(), 0));
    ...
    public void updateRendererMenu() {
        ...
        if (!VSTiDllManager.isRendererAvailable(RendererKind.VOCALOID1,
                    wine_prefix, wine_top)) {
            cMenuTrackTabRendererVOCALOID1.setIcon(new ImageIcon(
                    Resources.get_slash()));
            menuTrackRendererVOCALOID1.setIcon(new ImageIcon(
                    Resources.get_slash()));
        } else {
        ...
        if (!VSTiDllManager.isRendererAvailable(RendererKind.VOCALOID2,
                    wine_prefix, wine_top)) {
            cMenuTrackTabRendererVOCALOID2.setIcon(new ImageIcon(
                    Resources.get_slash()));
            menuTrackRendererVOCALOID2.setIcon(new ImageIcon(
                    Resources.get_slash()));
        } else {
        ...
        if (!VSTiDllManager.isRendererAvailable(RendererKind.UTAU, wine_prefix,
                    wine_top)) {
            cMenuTrackTabRendererUtau.setIcon(new ImageIcon(
                    Resources.get_slash()));
        ...
        if (!VSTiDllManager.isRendererAvailable(RendererKind.VCNT, wine_prefix,
                    wine_top)) {
            cMenuTrackTabRendererStraight.setIcon(new ImageIcon(
                    Resources.get_slash()));
        ...
        if (!VSTiDllManager.isRendererAvailable(RendererKind.AQUES_TONE,
                    wine_prefix, wine_top)) {
            cMenuTrackTabRendererAquesTone.setIcon(new ImageIcon(
                    Resources.get_slash()));
            menuTrackRendererAquesTone.setIcon(new ImageIcon(
                    Resources.get_slash()));
        } else {
    ...
    public void drawUtauVibrato(Graphics2D g, UstVibrato vibrato, int note,
        int clock_start, int clock_width) {
        //SmoothingMode old = g.SmoothingMode;
        //g.SmoothingMode = SmoothingMode.AntiAlias;
        // 魚雷を描いてみる
        int y0 = AppManager.yCoordFromNote(note - 0.5f);
        int x0 = AppManager.xCoordFromClocks(clock_start);
        int px_width = AppManager.xCoordFromClocks(clock_start + clock_width) -
            x0;
        ...
        // vibrato in
        int cl_vibin_end = clock_start +
            (int) ((clock_width * vibrato.In) / 100.0);
        ...
        g.drawPolyline(new int[] { x0, ul.x, dl.x },
            new int[] { y0, ul.y, dl.y }, 3);

        // vibrato out
        int cl_vibout_start = (clock_start + clock_width) -
            (int) ((clock_width * vibrato.Out) / 100.0);
        ...
        if (boxwidth > 0) {
            g.drawPolyline(new int[] { ul.x, dl.x, dr.x, ur.x },
                new int[] { ul.y, dl.y, dr.y, ur.y }, 4);
        }

        // buf1に、vibrato in/outによる増幅率を代入
        float[] buf1 = new float[clock_width + 1];

        for (int clock = clock_start; clock <= (clock_start + clock_width);
                clock++) {
        ...
        if (((clock_start + clock_width) - cl_vibout_start) > 0) {
            for (int clock = clock_start + clock_width;
                    clock >= cl_vibout_start; clock--) {
                int i = clock - clock_start;
                float v = ((clock_start + clock_width) - clock) / (float) ((clock_start +
                    clock_width) - cl_vibout_start);
                buf1[i] = buf1[i] * v;
            }
        }
        ...
        try {
            ...
            double msec = AppManager.getVsqFile()
                                    .getSecFromClock(clock_start - 1) * 1000.0;
            float px_track_height = (int) (controller.getScaleY() * 100.0f);
            phase -= (((AppManager.getVsqFile().getSecFromClock(clock_start) * 1000.0) -
            msec) * omega);
    ...
    public void updateCopyAndPasteButtonStatus() {
        ...
        cMenuTrackSelectorDeleteBezier.setEnabled((AppManager.isCurveMode() &&
            (AppManager.itemSelection.getLastBezier() != null)));
        ...
        boolean copied_is_null = (ce.events.size() == 0) &&
            (ce.tempo.size() == 0) && (ce.timesig.size() == 0) &&
            (copied_curve.size() == 0) && (copied_bezier.size() == 0);
        ...
        if (copied_curve.size() == 1) {
            ...
            for (Iterator<CurveType> itr = copied_curve.keySet().iterator();
                    itr.hasNext();) {
    ...
    public boolean dirtyCheck() {
        if (mEdited) {
            ...
            BDialogResult dr = AppManager.showMessageBox(gettext(
                        "Save this sequence?"), gettext("Affirmation"),
            ...
            if (dr == BDialogResult.YES) {
                if (str.compare(AppManager.getFileName(), "")) {
                    int dr2 = AppManager.showModalDialog(saveXmlVsqDialog,
                            false, this);
    ...
    public Dimension getWindowMinimumSize() {
        Dimension current_minsize = new Dimension(getMinimumSize().width,
                getMinimumSize().height);
        Dimension client = getContentPane().getSize();
        Dimension current = getSize();

        return new Dimension(current_minsize.width,
            splitContainer1.getPanel2MinSize() + _SCROLL_WIDTH +
            _PICT_POSITION_INDICATOR_HEIGHT +
            pictPianoRoll.getMinimumSize().height + menuStripMain.getHeight() +
            (current.height - client.height) + 20);
    }
    ...
    public void executeLyricChangeCommand() {
        ...
        for (Iterator<Integer> itr = vsq_track.indexIterator(
                    IndexIteratorKind.NOTE); itr.hasNext();) {
            indx = itr.next();
        ...
        if (txtlen > 0) {
            ...
            phrase[0] = str.sub(txt, 0, 1) +
                ((txtlen > 1) ? str.sub(txt, 1).replace("-", "") : "");
        } else {
            phrase[0] = "";
        }
        ...
        if ((phonetic_symbol_edit_mode &&
                !str.compare(AppManager.mInputTextBox.getText(),
                    original_symbol[0])) ||
                (!phonetic_symbol_edit_mode &&
                !str.compare(phrase[0], original_phrase[0]))) {
            if (phonetic_symbol_edit_mode) {
                // 発音記号を編集するモード
                ...
                String[] spl = PortUtil.splitString(phonetic_symbol[0],
                        new char[] { ' ' }, true);
    ...
    public void reloadMidiIn() {
        if (mMidiIn != null) {
            mMidiIn.midiReceivedEvent.remove(new MidiReceivedEventHandler(
                    this, "mMidiIn_MidiReceived"));
            mMidiIn.close();
            mMidiIn = null;
        }
        ...
        try {
            ...
            mMidiIn.midiReceivedEvent.add(new MidiReceivedEventHandler(this,
                    "mMidiIn_MidiReceived"));
    ...
    public void ensureVisibleY(int note) {
        ...
        if (note < noteBottom) {
            ...
            int new_start_to_draw_y = controller.getStartToDrawY() +
                (note_y - height);
    ...
    public void ensureVisible(int clock) {
        ...
        if ((clock < clock_left) || (clock_right < clock)) {
            ...
            float f_draft = cl_new_center -
                ((((pictPianoRoll.getWidth() / 2) + 34) - 70) * controller.getScaleXInv());
    ...
    public void processSpecialShortcutKey(BKeyEventArgs e,
        ...
        if (onPreviewKeyDown && (keycode != 0)) {
            for (SpecialShortcutHolder holder : mSpecialShortcutHolders) {
                if (stroke.equals(holder.shortcut)) {
                    try {
                        holder.menu.clickEvent.raise(holder.menu,
                            new BEventArgs());
                    } catch (Exception ex) {
                        Logger.write(FormMain.class +
                            ".processSpecialShortcutKey; ex=" + ex + "\n");
                        serr.println("FormMain#processSpecialShortcutKey; ex=" +
                            ex);
                    }
        ...
        if (e.KeyValue == KeyEvent.VK_ENTER) {
        ...
        } else if ((e.KeyValue == KeyEvent.VK_ADD) ||
                (e.KeyValue == KeyEvent.VK_PLUS) ||
                (e.KeyValue == KeyEvent.VK_RIGHT)) {
            if (onPreviewKeyDown) {
                forward();
            }
        } else if ((e.KeyValue == KeyEvent.VK_MINUS) ||
                (e.KeyValue == KeyEvent.VK_LEFT)) {
            if (onPreviewKeyDown) {
                rewind();
            }
            ...
            if (!AppManager.isPlaying()) {
                ...
                if ((specialGoToFirst != null) &&
                        (specialGoToFirst.length > 0)) {
    ...
    public void updateScrollRangeHorizontal() {
        ...
        int thumb_width = 40;
        int box_width = (int) (large_change / (float) maximum * (hwidth -
            (2 * thumb_width)));
        ...
        if (box_width < AppManager.editorConfig.MinimumScrollHandleWidth) {
            ...
            if ((hwidth - (2 * thumb_width)) > box_width) {
                maximum = (l * (hwidth - (2 * thumb_width))) / (hwidth -
                    (2 * thumb_width) - box_width);
                large_change = (l * box_width) / (hwidth - (2 * thumb_width) -
                    box_width);
            }
        }
    ...
    public void updateScrollRangeVertical() {
        ...
        int thumb_height = 40;
        int box_height = (int) (large_change / (float) maximum * (vheight -
            (2 * thumb_height)));
        ...
        if (box_height < AppManager.editorConfig.MinimumScrollHandleWidth) {
            ...
            maximum = (int) (((((128.0 * (int) (100 * scaley)) - pheight) / scaley) * (vheight -
                (2 * thumb_height))) / (vheight - (2 * thumb_height) -
                box_height));
            large_change = (int) (((((128.0 * (int) (100 * scaley)) - pheight) / scaley) * box_height) / (vheight -
                (2 * thumb_height) - box_height));
        }
    ...
    public void flipControlCurveVisible(boolean visible) {
        ...
        if (visible) {
            ...
            splitContainer1.setDividerLocation(splitContainer1.getHeight() -
                AppManager.mLastTrackSelectorHeight -
                splitContainer1.getDividerSize());
            splitContainer1.setPanel2MinSize(trackSelector.getPreferredMinSize());
        } else {
            AppManager.mLastTrackSelectorHeight = splitContainer1.getHeight() -
                splitContainer1.getDividerLocation() -
                splitContainer1.getDividerSize();
            ...
            splitContainer1.setDividerLocation(splitContainer1.getHeight() -
                panel2height - splitContainer1.getDividerSize());
    ...
    public void applyShortcut() {
        ...
        for (Iterator<String> itr = dict.keySet().iterator(); itr.hasNext();) {
            ...
            if (str.compare(key, "menuEditCopy") ||
                    str.compare(key, "menuEditCut") ||
                    str.compare(key, "menuEditPaste") ||
                    str.compare(key, "SpecialShortcutGoToFirst")) {
                continue;
            }
        ...
        work.add(new ValuePair<String, BMenuItem[]>("menuEditUndo",
                new BMenuItem[] { cMenuPianoUndo, cMenuTrackSelectorUndo }));
        work.add(new ValuePair<String, BMenuItem[]>("menuEditRedo",
                new BMenuItem[] { cMenuPianoRedo, cMenuTrackSelectorRedo }));
        work.add(new ValuePair<String, BMenuItem[]>("menuEditCut",
                new BMenuItem[] {
                    cMenuPianoCut, cMenuTrackSelectorCut, menuEditCut
                }));
        work.add(new ValuePair<String, BMenuItem[]>("menuEditCopy",
                new BMenuItem[] {
                    cMenuPianoCopy, cMenuTrackSelectorCopy, menuEditCopy
                }));
        work.add(new ValuePair<String, BMenuItem[]>("menuEditPaste",
                new BMenuItem[] {
                    cMenuPianoPaste, cMenuTrackSelectorPaste, menuEditPaste
                }));
        work.add(new ValuePair<String, BMenuItem[]>("menuEditSelectAll",
                new BMenuItem[] { cMenuPianoSelectAll, cMenuTrackSelectorSelectAll }));
        work.add(new ValuePair<String, BMenuItem[]>("menuEditSelectAllEvents",
                new BMenuItem[] { cMenuPianoSelectAllEvents }));
        work.add(new ValuePair<String, BMenuItem[]>("menuEditDelete",
                new BMenuItem[] { menuEditDelete }));
        work.add(new ValuePair<String, BMenuItem[]>("menuVisualGridline",
                new BMenuItem[] { cMenuPianoGrid }));
        work.add(new ValuePair<String, BMenuItem[]>("menuJobLyric",
                new BMenuItem[] { cMenuPianoImportLyric }));
        work.add(new ValuePair<String, BMenuItem[]>(
                "menuLyricExpressionProperty",
                new BMenuItem[] { cMenuPianoExpressionProperty }));
        work.add(new ValuePair<String, BMenuItem[]>(
                "menuLyricVibratoProperty",
                new BMenuItem[] { cMenuPianoVibratoProperty }));
        work.add(new ValuePair<String, BMenuItem[]>("menuTrackOn",
                new BMenuItem[] { cMenuTrackTabTrackOn }));
        work.add(new ValuePair<String, BMenuItem[]>("menuTrackAdd",
                new BMenuItem[] { cMenuTrackTabAdd }));
        work.add(new ValuePair<String, BMenuItem[]>("menuTrackCopy",
                new BMenuItem[] { cMenuTrackTabCopy }));
        work.add(new ValuePair<String, BMenuItem[]>("menuTrackDelete",
                new BMenuItem[] { cMenuTrackTabDelete }));
        work.add(new ValuePair<String, BMenuItem[]>("menuTrackRenderCurrent",
                new BMenuItem[] { cMenuTrackTabRenderCurrent }));
        work.add(new ValuePair<String, BMenuItem[]>("menuTrackRenderAll",
                new BMenuItem[] { cMenuTrackTabRenderAll }));
        work.add(new ValuePair<String, BMenuItem[]>("menuTrackOverlay",
                new BMenuItem[] { cMenuTrackTabOverlay }));
        work.add(new ValuePair<String, BMenuItem[]>(
                "menuTrackRendererVOCALOID1",
                new BMenuItem[] { cMenuTrackTabRendererVOCALOID1 }));
        work.add(new ValuePair<String, BMenuItem[]>(
                "menuTrackRendererVOCALOID2",
                new BMenuItem[] { cMenuTrackTabRendererVOCALOID2 }));
        work.add(new ValuePair<String, BMenuItem[]>(
        ...
        if (AppManager.mMixerWindow != null) {
            if (dict.containsKey("menuVisualMixer")) {
                KeyStroke shortcut = BKeysUtility.getKeyStrokeFromBKeys(dict.get(
                            "menuVisualMixer"));
        ...
        for (int i = 0; i < sub_menu_script.length; i++) {
            ...
            if (sub_tsi.length == 1) {
                ...
                if (dict.containsKey(PortUtil.getComponentName(dd_run))) {
                    applyMenuItemShortcut(dict, tsi,
                        PortUtil.getComponentName(tsi));
                }
            }
        }
    }
    ...
    public void applyMenuItemShortcut(TreeMap<String, BKeys[]> dict,
        Object item, String item_name) {
        if (item == null) {
            return;
        }
        ...
        try {
            sout.println("FormMain#applyMenuItemShortcut; item_name=" +
                item_name);

            KeyStroke ks = BKeysUtility.getKeyStrokeFromBKeys(k);

            if (str.startsWith(item_name, "menuHidden")) {
                mSpecialShortcutHolders.add(new SpecialShortcutHolder(
                        BKeysUtility.getKeyStrokeFromBKeys(k), menu));
            } else {
    ...
    public void forward() {
        ...
        int unit = QuantizeModeUtil.getQuantizeClock(AppManager.editorConfig.getPositionQuantize(),
                AppManager.editorConfig.isPositionQuantizeTriplet());
        int cl_new = doQuantize(cl_clock + unit, unit);

        if (cl_new <= (hScroll.getMaximum() +
                ((pictPianoRoll.getWidth() - AppManager.keyWidth) * controller.getScaleXInv()))) {
            // 表示の更新など
    ...
    public void clearTempWave() {
        String tmppath = fsys.combine(AppManager.getCadenciiTempDir(),
                AppManager.getID());
            ...
            if (fsys.isFileExists(file)) {
                for (int error = 0; error < 100; error++) {
                    try {
                        ...
                        Logger.write(FormMain.class + ".clearTempWave; ex=" +
                            ex + "\n");
    ...
    public void applyLanguage() {
        ...
        try {
            openXmlVsqDialog.addFileFilter(gettext(
                    "XML-VSQ Format(*.xvsq)|*.xvsq"));
        ...
        try {
            saveXmlVsqDialog.addFileFilter(gettext(
                    "XML-VSQ Format(*.xvsq)|*.xvsq"));
        ...
        try {
            openUstDialog.addFileFilter(gettext(
                    "UTAU Script Format(*.ust)|*.ust"));
        ...
        menuLyricCopyVibratoToPreset.setText(gettext(
                "Copy vibrato config to preset"));
        ...
        menuHelpLogSwitch.setText(Logger.isEnabled() ? gettext("Disable")
                                                     : gettext("Enable"));
        ...
        menuHiddenEditFlipToolPointerEraser.setText(gettext(
                "Chagne tool pointer / eraser"));
        menuHiddenEditFlipToolPointerPencil.setText(gettext(
                "Change tool pointer / pencil"));
        ...
        menuHiddenVisualBackwardParameter.setText(gettext(
                "Previous control curve"));
        menuHiddenVisualForwardParameter.setText(gettext("Next control curve"));
        menuHiddenFlipCurveOnPianorollMode.setText(gettext(
                "Change pitch drawing mode"));
    ...
    public void importLyric() {
        ...
        try {
            ...
            mDialogImportLyric.setLocation(getFormPreferedLocation(
                    mDialogImportLyric));

            BDialogResult dr = AppManager.showModalDialog(mDialogImportLyric,
                    this);
            ...
            if (dr == BDialogResult.OK) {
                ...
                for (Iterator<Integer> itr = vsq_track.indexIterator(
                    ...
                    new_events[indx].ID.LyricHandle.L0.setPhoneticSymbol(new_symbols.get(
                            indx));
    ...
    public void editNoteVibratoProperty() {
        ...
        try {
            dlg = new FormVibratoConfig(ev.ID.VibratoHandle, ev.ID.getLength(),
                    AppManager.editorConfig.DefaultVibratoLength, type,
            ...
            if (dlg.getDialogResult() == BDialogResult.OK) {
                ...
                if (dlg.getVibratoHandle() != null) {
                    edited.ID.VibratoHandle = (VibratoHandle) dlg.getVibratoHandle()
                                                                 .clone();
                    ...
                    edited.ID.VibratoDelay = ev.ID.getLength() -
                        dlg.getVibratoHandle().getLength();
                } else {
                    edited.ID.VibratoHandle = null;
                }

                CadenciiCommand run = new CadenciiCommand(VsqCommand.generateCommandEventChangeIDContaints(
                            selected, ev.InternalID, edited.ID));
                AppManager.editHistory.register(vsq.executeCommand(run));
                setEdited(true);
                refreshScreen();
            }
            ...
            if (dlg != null) {
                try {
                    ...
                    Logger.write(FormMain.class +
                        ".editNoteVibratoProperty; ex=" + ex2 + "\n");
                }
            }
        }
    }
    ...
    public void editNoteExpressionProperty() {
        ...
        try {
            ...
            Logger.write(FormMain.class + ".editNoteExpressionProperty; ex=" +
                ex + "\n");
        } finally {
            if (dlg != null) {
                try {
                    ...
                    Logger.write(FormMain.class +
                        ".editNoteExpressionProperty; ex=" + ex2 + "\n");
                }
            }
        }
    }
    ...
    public int computeScrollValueFromWheelDelta(int delta) {
        double new_val = (double) hScroll.getValue() -
            ((delta * AppManager.editorConfig.WheelOrder) / (5.0 * controller.getScaleX()));
    ...
    public void selectAll() {
        ...
        for (Iterator<VsqEvent> itr = AppManager.getVsqFile().Track.get(
                    AppManager.getSelected()).getEventIterator();
                itr.hasNext();) {
        ...
        for (CurveType vct : Utility.CURVE_USAGE) {
            ...
            VsqBPList target = AppManager.getVsqFile().Track.get(AppManager.getSelected())
                                                            .getCurve(vct.getName());
    ...
    public void selectAllEvent() {
        ...
        for (Iterator<VsqEvent> itr = vsq_track.getEventIterator();
            ...
            if ((ev.ID.type == VsqIDType.Anote) &&
                    (ev.Clock >= premeasureclock)) {
    ...
    public void deleteEvent() {
        ...
        if (AppManager.itemSelection.getEventCount() > 0) {
            ...
            VsqCommand run = VsqCommand.generateCommandEventDeleteRange(selected,
                    ids);
            ...
            if (AppManager.isWholeSelectedIntervalEnabled()) {
                ...
                for (CurveType vct : Utility.CURVE_USAGE) {
                    ...
                    t.add(new BPPair(start_clock,
                            work_curve.getValue(start_clock)));
                ...
                CadenciiCommand delete_curve = new CadenciiCommand(VsqCommand.generateCommandTrackCurveEditRange(
                            selected, strs, curves));
                ...
                CadenciiCommand run2 = new CadenciiCommand(VsqCommand.generateCommandReplace(
                            work));
            ...
            for (Iterator<ValuePair<Integer, SelectedTempoEntry>> itr = AppManager.itemSelection.getTempoIterator();
                    itr.hasNext();) {
            ...
            CadenciiCommand run = new CadenciiCommand(VsqCommand.generateCommandUpdateTempoRange(
            ...
            for (Iterator<ValuePair<Integer, SelectedTimesigEntry>> itr = AppManager.itemSelection.getTimesigIterator();
                    itr.hasNext();) {
            ...
            CadenciiCommand run = new CadenciiCommand(VsqCommand.generateCommandUpdateTimesigRange(
        ...
        if (AppManager.itemSelection.getPointIDCount() > 0) {
            ...
            if (!trackSelector.getSelectedCurve().isAttachNote()) {
                ...
                CadenciiCommand run = new CadenciiCommand(VsqCommand.generateCommandTrackCurveReplace(
                            selected,
                            trackSelector.getSelectedCurve().getName(), list));
                AppManager.editHistory.register(vsq.executeCommand(run));
                setEdited(true);
            } else {
    ...
    public void pasteEvent() {
        ...
        if (copied_events.size() != 0) {
            ...
            if (clock >= AppManager.getVsqFile().getPreMeasureClocks()) {
                ...
                add_event = VsqCommand.generateCommandEventAddRange(AppManager.getSelected(),
                        paste.toArray(new VsqEvent[] {  }));
            }
        }
        ...
        if (copied_timesig.size() > 0) {
            ...
            for (Iterator<TimeSigTableEntry> itr = copied_timesig.iterator();
                    itr.hasNext();) {
        ...
        if (copied_curve.size() > 0) {
            ...
            for (Iterator<CurveType> itr = copied_curve.keySet().iterator();
                ...
                if (curve.isAttachNote()) {
                    ...
                    VsqBPList target = (VsqBPList) AppManager.getVsqFile().Track.get(AppManager.getSelected())
                                                                                .getCurve(curve.getName())
                                                                                .clone();
                    int count = list.size();
                    ...
                    if (copied_curve.size() == 1) {
                        work.put(trackSelector.getSelectedCurve().getName(),
                            target);
                    } else {
            ...
            if (work.size() > 0) {
                ...
                for (Iterator<String> itr = work.keySet().iterator();
                        itr.hasNext();) {
                    String s = itr.next();
                    count++;
                    curves[count] = s;
                ...
                edit_bpcurve = VsqCommand.generateCommandTrackCurveReplaceRange(AppManager.getSelected(),
                        curves, bplists);
            }
        ...
        if (copied_bezier.size() > 0) {
            int dclock = clock - copy_started_clock;
            BezierCurves attached_curve = (BezierCurves) AppManager.getVsqFile().AttachedCurves.get(AppManager.getSelected() -
                    1).clone();
            TreeMap<CurveType, Vector<BezierChain>> command_arg = new TreeMap<CurveType, Vector<BezierChain>>();

            for (Iterator<CurveType> itr = copied_bezier.keySet().iterator();
                    itr.hasNext();) {
                CurveType curve = itr.next();
                ...
                for (Iterator<BezierChain> itr2 = copied_bezier.get(curve)
                                                               .iterator();
                        itr2.hasNext();) {
                    BezierChain bc = itr2.next();
                    BezierChain bc_copy = (BezierChain) bc.clone();

                    for (Iterator<BezierPoint> itr3 = bc_copy.points.iterator();
                            itr3.hasNext();) {
                        BezierPoint bp = itr3.next();
                        bp.setBase(new PointD(bp.getBase().getX() + dclock,
                                bp.getBase().getY()));
                    }
                ...
                for (Iterator<BezierChain> itr2 = attached_curve.get(curve)
                                                                .iterator();
                        itr2.hasNext();) {
                    BezierChain bc = itr2.next();
                    arg.add(bc);
            ...
            edit_bezier = VsqFileEx.generateCommandReplaceAttachedCurveRange(AppManager.getSelected(),
                    command_arg);
        }
    ...
    public void copyEvent() {
        ...
        if (AppManager.isWholeSelectedIntervalEnabled()) {
            ...
            for (int i = 0; i < Utility.CURVE_USAGE.length; i++) {
                ...
                VsqBPList list = AppManager.getVsqFile().Track.get(AppManager.getSelected())
                                                              .getCurve(vct.getName());
                ...
                copyCurveCor(AppManager.getSelected(), vct, start_clock,
                    end_clock, tmp_bezier);

                VsqBPList tmp_bplist = new VsqBPList(list.getName(),
                        list.getDefault(), list.getMinimum(), list.getMaximum());
                int c = list.size();
            ...
            copyCurveCor(AppManager.getSelected(),
                trackSelector.getSelectedCurve(), start, end, tmp_bezier);
            ...
            if (tmp_bezier.size() > 0) {
                ...
                if (list != null) {
                    VsqBPList tmp_bplist = new VsqBPList(list.getName(),
                            list.getDefault(), list.getMinimum(),
                            list.getMaximum());
                    int c = list.size();
                ...
                if (list != null) {
                    VsqBPList tmp_bplist = new VsqBPList(curve.getName(),
                            curve.getDefault(), curve.getMinimum(),
                            curve.getMaximum());

                    for (Iterator<Long> itr = AppManager.itemSelection.getPointIDIterator();
                            itr.hasNext();) {
                        long id = itr.next();
    ...
    public void cutEvent() {
        ...
        if (AppManager.itemSelection.getEventCount() > 0) {
            ...
            delete_event = VsqCommand.generateCommandEventDeleteRange(AppManager.getSelected(),
                    ids);
        }
        ...
        if (AppManager.isWholeSelectedIntervalEnabled() ||
            ...
            for (int i = 0; i < Utility.CURVE_USAGE.length; i++) {
                ...
                VsqCommand tmp = VsqCommand.generateCommandTrackCurveEdit2(track,
                        curve.getName(), delete,
            ...
            work.AttachedCurves.get(AppManager.getSelected() - 1)
                               .deleteBeziers(target_curve, start_clock,
                end_clock);
    ...
    public void copyCurveCor(int track, CurveType curve_type, int start,
        int end, Vector<BezierChain> copied_chain) {
        for (Iterator<BezierChain> itr = AppManager.getVsqFile().AttachedCurves.get(track -
                    1).get(curve_type).iterator(); itr.hasNext();) {
    ...
    public void copyTrackCore() {
        ...
        CadenciiCommand run = VsqFileEx.generateCommandAddTrack(track,
                vsq.Mixer.Slave.get(selected - 1), vsq.Track.size(),
    ...
    public void changeTrackNameCore() {
        ...
        try {
            ...
            if (dr == BDialogResult.OK) {
                ...
                CadenciiCommand run = new CadenciiCommand(VsqCommand.generateCommandTrackChangeName(
                            selected, ret));
                AppManager.editHistory.register(vsq.executeCommand(run));
                setEdited(true);
                refreshScreen();
    ...
    public void deleteTrackCore() {
        ...
        if (AppManager.showMessageBox(PortUtil.formatMessage(gettext(
                            "Do you wish to remove track? {0} : '{1}'"),
                        selected, vsq.Track.get(selected).getName()),
                    _APP_NAME,
    ...
    public void addTrackCore() {
        ...
        CadenciiCommand run = VsqFileEx.generateCommandAddTrack(vsq_track,
                new VsqMixerEntry(0, 0, 0, 0), i, new BezierCurves());
        AppManager.editHistory.register(vsq.executeCommand(run));
        updateDrawObjectList();
        setEdited(true);
    ...
    public void updateDrawObjectList() {
        ...
        synchronized (AppManager.mDrawObjects) {
            ...
            if (AppManager.mDrawObjects != null) {
                for (Iterator<Vector<DrawObject>> itr = AppManager.mDrawObjects.iterator();
                        itr.hasNext();) {
            ...
            try {
                SMALL_FONT = new Font(AppManager.editorConfig.ScreenFontName,
                        java.awt.Font.PLAIN, AppManager.FONT_SIZE8);
                ...
                for (int track = 1; track < track_count; track++) {
                    ...
                    VsqEvent item = null;
                    VsqEvent item_next = itr_note.hasNext() ? itr_note.next()
                                                            : null;

                    while ((item_prev != null) || (item != null) ||
                            (item_next != null)) {
                        item_prev = item;
                        item = item_next;
                        ...
                        String title = Utility.trimString(lyric_jp + " [" +
                                lyric_en + "]", SMALL_FONT, lyric_width);
                        ...
                        if (item.ID.VibratoHandle != null) {
                            ...
                            px_vibrato_delay = _PX_ACCENT_HEADER +
                                (int) ((lyric_width - _PX_ACCENT_HEADER) * rate);
                        }
                        ...
                        if ((0 <= program) &&
                                (program < AppManager.editorConfig.UtauSingers.size())) {
                            SingerConfig sc = AppManager.editorConfig.UtauSingers.get(program);

                            // 通常のUTAU音源
                            if (AppManager.mUtauVoiceDB.containsKey(
                                        sc.VOICEIDSTR)) {
                                ...
                                if ((oa.fileName == null) ||
                                        ((oa.fileName != null) &&
                                        str.compare(oa.fileName, ""))) {
                                    is_valid_for_utau = false;
                                } else {
                                    is_valid_for_utau = fsys.isFileExists(fsys.combine(
                                                sc.VOICEIDSTR, oa.fileName));
                                }
                            }
                        }

                        int intensity = (item.UstEvent == null) ? 100
                                                                : item.UstEvent.getIntensity();

                        //追加
                        tmp.add(new DrawObject(DrawObjectType.Note, vsq,
                                new Rectangle(x, y, lyric_width, track_height),
                                title, accent, item.ID.DEMdecGainRate,
                                item.ID.Dynamics, item.InternalID,
                                px_vibrato_delay, false,
                                item.ID.LyricHandle.L0.PhoneticSymbolProtected,
                                rate_bp, depth_bp, rate_start, depth_start,
                                item.ID.Note, item.UstEvent.getEnvelope(),
                                length, timesig, is_valid_for_utau,
                                is_valid_for_utau, // vConnect-STANDはstfファイルを必要としないので，
                                vib_delay, intensity));
                    }

                    // Dynaff, Crescendイベント
                    for (Iterator<VsqEvent> itr = vsq_track.getDynamicsEventIterator();
                            itr.hasNext();) {
                        ...
                        int y = (-note * (int) (100 * controller.getScaleY())) +
                            yoffset;
                        tmp.add(new DrawObject(type, vsq,
                                new Rectangle(x, y, width, track_height), str,
                                0, 0, 0, item_itr.InternalID, 0, false, false,
                                null, null, 0, 0, item_itr.ID.Note, null,
                                length, clock, true, true, length, 0));
                    }
                    ...
                    for (int i = 0; i < (count - 1); i++) {
                        ...
                        for (int j = i + 1; j < count; j++) {
                            ...
                            if (((itemj.mType == DrawObjectType.Note) &&
                                    (parent_type != DrawObjectType.Note)) ||
                                    ((itemj.mType != DrawObjectType.Note) &&
                                    (parent_type == DrawObjectType.Note))) {
                                continue;
                            }
                ...
                Logger.write(FormMain.class + ".updateDrawObjectList; ex=" +
                    ex + "\n");
    ...
    public void updateRecentFileMenu() {
        ...
        if (AppManager.editorConfig.RecentFiles != null) {
            for (int i = 0; i < AppManager.editorConfig.RecentFiles.size();
                    i++) {
                ...
                if (item != "") {
                    ...
                    itm.clickEvent.add(new BEventHandler(this,
                            "handleRecentFileMenuItem_Click"));
                    itm.mouseEnterEvent.add(new BEventHandler(this,
                            "handleRecentFileMenuItem_MouseEnter"));
    ...
    /// 入力用のテキストボックスを初期化します
    /// </summary>
    public void showInputTextBox(String phrase, String phonetic_symbol,
        Point position, boolean phonetic_symbol_edit_mode) {
        hideInputTextBox();

        AppManager.mInputTextBox.keyUpEvent.add(new BKeyEventHandler(this,
                "mInputTextBox_KeyUp"));
        AppManager.mInputTextBox.keyDownEvent.add(new BKeyEventHandler(this,
                "mInputTextBox_KeyDown"));
        ...
        AppManager.mInputTextBox.setFont(new Font(
                AppManager.editorConfig.BaseFontName, java.awt.Font.PLAIN,
    ...
    public void hideInputTextBox() {
        AppManager.mInputTextBox.keyUpEvent.remove(new BKeyEventHandler(this,
                "mInputTextBox_KeyUp"));
        AppManager.mInputTextBox.keyDownEvent.remove(new BKeyEventHandler(
                this, "mInputTextBox_KeyDown"));
        // TODO: JAVA: AppManager.mInputTextBox.ImeModeChanged -= mInputTextBox_ImeModeChanged;
    ...
    public boolean openVsqCor(String file) {
        ...
        if (AppManager.editorConfig.UseProjectCache) {
            ...
            if (!str.compare(cacheDir, "") && fsys.isDirectoryExists(cacheDir) &&
                ...
                if (!fsys.isDirectoryExists(estimatedCacheDir)) {
                    try {
                        ...
                        AppManager.showMessageBox(PortUtil.formatMessage(
                                gettext("cannot create cache directory: '{0}'"),
                                estimatedCacheDir), gettext("Info."),
                            PortUtil.OK_OPTION,
                ...
                for (int i = 1; i < vsq.Track.size(); i++) {
                    ...
                    if (fsys.isFileExists(wavFrom)) {
                        try {
                            ...
                            Logger.write(FormMain.class + ".openVsqCor; ex=" +
                                ex + "\n");
                            serr.println("FormMain#openVsqCor; ex=" + ex);
                        }
                    }
            ...
            if (!fsys.isDirectoryExists(cacheDir)) {
                try {
                    ...
                    Logger.write(FormMain.class + ".openVsqCor; ex=" + ex +
                        "\n");
                    serr.println("FormMain#openVsqCor; ex=" + ex);
                    AppManager.showMessageBox(PortUtil.formatMessage(gettext(
                                "cannot create cache directory: '{0}'"),
                            estimatedCacheDir), gettext("Info."),
                        PortUtil.OK_OPTION,
                        org.kbinani.windows.forms.Utility.MSGBOX_INFORMATION_MESSAGE);
    ...
    public void updateMenuFonts() {
        ...
        AppManager.superFont8Height = Util.measureString(Util.PANGRAM,
                AppManager.superFont8).height;
        AppManager.superFont9Height = Util.measureString(Util.PANGRAM,
                AppManager.superFont9).height;
        AppManager.superFont10Height = Util.measureString(Util.PANGRAM,
                AppManager.superFont10).height;
        AppManager.superFont50Height = Util.measureString(Util.PANGRAM,
                AppManager.superFont50Bold).height;
    }
        ...
        try {
            ...
            for (Iterator<VsqBarLineType> itr = vsq.getBarLineIterator(
                ...
                if (blt.isSeparator()) {
                    ...
                    g.drawString(current + "", x + 4, 8 - small_font_offset +
                        1);
                ...
                if ((dashed_line_step > 1) && AppManager.isGridVisible()) {
                    ...
                    for (int i = 1; i < numDashedLine; i++) {
                        int x2 = AppManager.xCoordFromClocks(blt.clock() +
                                (i * dashed_line_step));
            ...
            if (vsq != null) {
                ...
                for (int i = 0; i < c; i++) {
                    ...
                    if (mPositionIndicatorMouseDownMode == PositionIndicatorMouseDownMode.TIMESIG) {
                        if (AppManager.itemSelection.isTimesigContains(barcount)) {
                            int edit_clock_x = AppManager.xCoordFromClocks(vsq.getClockFromBarCount(
                                        AppManager.itemSelection.getTimesig(
                                            barcount).editing.BarCount));
                            g.setColor(mColorR187G187B255);
                            g.drawLine(edit_clock_x - 1, 32, edit_clock_x - 1,
                                picturePositionIndicator.getHeight() - 1);
                            g.setColor(mColorR007G007B151);
                            g.drawLine(edit_clock_x, 32, edit_clock_x,
                                picturePositionIndicator.getHeight() - 1);
                        }
                    }
                }
                ...
                for (int i = 0; i < c; i++) {
                    ...
                    String s = PortUtil.formatDecimal("#.00",
                            60e6 / (float) itemi.Tempo);
                    ...
                    if (mPositionIndicatorMouseDownMode == PositionIndicatorMouseDownMode.TEMPO) {
                        if (AppManager.itemSelection.isTempoContains(clock)) {
                            int edit_clock_x = AppManager.xCoordFromClocks(AppManager.itemSelection.getTempo(
                                        clock).editing.Clock);
                            g.setColor(mColorR187G187B255);
                            g.drawLine(edit_clock_x - 1, 18, edit_clock_x - 1,
                                32);
                            g.setColor(mColorR007G007B151);
                            g.drawLine(edit_clock_x, 18, edit_clock_x, 32);
                        }
                    }
                }
            }
            ...
            // ソングポジション
            float xoffset = (key_width + AppManager.keyOffset) -
                controller.getStartToDrawX();
            int marker_x = (int) ((AppManager.getCurrentClock() * controller.getScaleX()) +
                xoffset);
            ...
            if (vsq.config.StartMarkerEnabled) {
                ...
                if (x < key_width) {
                    ...
                    g.drawImage(Resources.get_start_marker(), x, 3, this);
                }
            }
            ...
            if (vsq.config.EndMarkerEnabled) {
                ...
                if (x < key_width) {
                    ...
                    g.drawImage(Resources.get_end_marker(), x, 3, this);
                }
            }
            ...
            if (right) {
                g.setColor(Color.white);
                g.fillPolygon(new int[] { width - 6, width, width - 6 },
                    new int[] { 3, 10, 16 }, 3);
            }
            ...
            if (left) {
                ...
                g.fillPolygon(new int[] {
                        key_width + 7, key_width + 1, key_width + 7
                    }, new int[] { 3, 10, 16 }, 3);
            }
            ...
            Logger.write(FormMain.class +
                ".picturePositionIndicatorDrawTo; ex=" + ex + "\n");
    ...
    public void registerEventHandlers() {
        ...
        menuFileNew.mouseEnterEvent.add(new BEventHandler(this,
                "handleMenuMouseEnter"));
        menuFileNew.clickEvent.add(new BEventHandler(this, "handleFileNew_Click"));
        menuFileOpen.mouseEnterEvent.add(new BEventHandler(this,
                "handleMenuMouseEnter"));
        menuFileOpen.clickEvent.add(new BEventHandler(this,
                "handleFileOpen_Click"));
        menuFileSave.mouseEnterEvent.add(new BEventHandler(this,
                "handleMenuMouseEnter"));
        menuFileSave.clickEvent.add(new BEventHandler(this,
                "handleFileSave_Click"));
        menuFileSaveNamed.mouseEnterEvent.add(new BEventHandler(this,
                "handleMenuMouseEnter"));
        menuFileSaveNamed.clickEvent.add(new BEventHandler(this,
                "menuFileSaveNamed_Click"));
        menuFileOpenVsq.mouseEnterEvent.add(new BEventHandler(this,
                "handleMenuMouseEnter"));
        menuFileOpenVsq.clickEvent.add(new BEventHandler(this,
                "menuFileOpenVsq_Click"));
        menuFileOpenUst.mouseEnterEvent.add(new BEventHandler(this,
                "handleMenuMouseEnter"));
        menuFileOpenUst.clickEvent.add(new BEventHandler(this,
                "menuFileOpenUst_Click"));
        menuFileImport.mouseEnterEvent.add(new BEventHandler(this,
                "handleMenuMouseEnter"));
        menuFileImportMidi.mouseEnterEvent.add(new BEventHandler(this,
                "handleMenuMouseEnter"));
        menuFileImportMidi.clickEvent.add(new BEventHandler(this,
                "menuFileImportMidi_Click"));
        menuFileImportUst.mouseEnterEvent.add(new BEventHandler(this,
                "handleMenuMouseEnter"));
        menuFileImportUst.clickEvent.add(new BEventHandler(this,
                "menuFileImportUst_Click"));
        menuFileImportVsq.mouseEnterEvent.add(new BEventHandler(this,
                "handleMenuMouseEnter"));
        menuFileImportVsq.clickEvent.add(new BEventHandler(this,
                "menuFileImportVsq_Click"));
        menuFileExport.mouseEnterEvent.add(new BEventHandler(this,
                "handleMenuMouseEnter"));
        menuFileExport.dropDownOpeningEvent.add(new BEventHandler(this,
                "menuFileExport_DropDownOpening"));
        menuFileExportWave.mouseEnterEvent.add(new BEventHandler(this,
                "handleMenuMouseEnter"));
        menuFileExportWave.clickEvent.add(new BEventHandler(this,
                "menuFileExportWave_Click"));
        menuFileExportParaWave.mouseEnterEvent.add(new BEventHandler(this,
                "handleMenuMouseEnter"));
        menuFileExportParaWave.clickEvent.add(new BEventHandler(this,
                "menuFileExportParaWave_Click"));
        menuFileExportMidi.mouseEnterEvent.add(new BEventHandler(this,
                "handleMenuMouseEnter"));
        menuFileExportMidi.clickEvent.add(new BEventHandler(this,
                "menuFileExportMidi_Click"));
        menuFileExportMusicXml.mouseEnterEvent.add(new BEventHandler(this,
                "handleMenuMouseEnter"));
        menuFileExportMusicXml.clickEvent.add(new BEventHandler(this,
                "menuFileExportMusicXml_Click"));
        menuFileExportUst.mouseEnterEvent.add(new BEventHandler(this,
                "handleMenuMouseEnter"));
        menuFileExportUst.clickEvent.add(new BEventHandler(this,
                "menuFileExportUst_Click"));
        menuFileExportVsq.mouseEnterEvent.add(new BEventHandler(this,
                "handleMenuMouseEnter"));
        menuFileExportVsq.clickEvent.add(new BEventHandler(this,
                "menuFileExportVsq_Click"));
        menuFileExportVxt.mouseEnterEvent.add(new BEventHandler(this,
                "handleMenuMouseEnter"));
        menuFileExportVxt.clickEvent.add(new BEventHandler(this,
                "menuFileExportVxt_Click"));
        menuFileRecent.mouseEnterEvent.add(new BEventHandler(this,
                "handleMenuMouseEnter"));
        menuFileRecentClear.mouseEnterEvent.add(new BEventHandler(this,
                "handleMenuMouseEnter"));
        menuFileRecentClear.clickEvent.add(new BEventHandler(this,
                "menuFileRecentClear_Click"));
        menuFileQuit.mouseEnterEvent.add(new BEventHandler(this,
                "handleMenuMouseEnter"));
        menuFileQuit.clickEvent.add(new BEventHandler(this, "menuFileQuit_Click"));
        menuEdit.dropDownOpeningEvent.add(new BEventHandler(this,
                "menuEdit_DropDownOpening"));
        menuEditUndo.mouseEnterEvent.add(new BEventHandler(this,
                "handleMenuMouseEnter"));
        menuEditUndo.clickEvent.add(new BEventHandler(this,
                "handleEditUndo_Click"));
        menuEditRedo.mouseEnterEvent.add(new BEventHandler(this,
                "handleMenuMouseEnter"));
        menuEditRedo.clickEvent.add(new BEventHandler(this,
                "handleEditRedo_Click"));
        menuEditCut.mouseEnterEvent.add(new BEventHandler(this,
                "handleMenuMouseEnter"));
        menuEditCut.clickEvent.add(new BEventHandler(this, "handleEditCut_Click"));
        menuEditCopy.mouseEnterEvent.add(new BEventHandler(this,
                "handleMenuMouseEnter"));
        menuEditCopy.clickEvent.add(new BEventHandler(this,
                "handleEditCopy_Click"));
        menuEditPaste.mouseEnterEvent.add(new BEventHandler(this,
                "handleMenuMouseEnter"));
        menuEditPaste.clickEvent.add(new BEventHandler(this,
                "handleEditPaste_Click"));
        menuEditDelete.mouseEnterEvent.add(new BEventHandler(this,
                "handleMenuMouseEnter"));
        menuEditDelete.clickEvent.add(new BEventHandler(this,
                "menuEditDelete_Click"));
        menuEditAutoNormalizeMode.mouseEnterEvent.add(new BEventHandler(this,
                "handleMenuMouseEnter"));
        menuEditAutoNormalizeMode.clickEvent.add(new BEventHandler(this,
                "menuEditAutoNormalizeMode_Click"));
        menuEditSelectAll.mouseEnterEvent.add(new BEventHandler(this,
                "handleMenuMouseEnter"));
        menuEditSelectAll.clickEvent.add(new BEventHandler(this,
                "menuEditSelectAll_Click"));
        menuEditSelectAllEvents.mouseEnterEvent.add(new BEventHandler(this,
                "handleMenuMouseEnter"));
        menuEditSelectAllEvents.clickEvent.add(new BEventHandler(this,
                "menuEditSelectAllEvents_Click"));
        menuVisualOverview.mouseEnterEvent.add(new BEventHandler(this,
                "handleMenuMouseEnter"));
        menuVisualControlTrack.checkedChangedEvent.add(new BEventHandler(this,
                "menuVisualControlTrack_CheckedChanged"));
        menuVisualControlTrack.mouseEnterEvent.add(new BEventHandler(this,
                "handleMenuMouseEnter"));
        menuVisualMixer.mouseEnterEvent.add(new BEventHandler(this,
                "handleMenuMouseEnter"));
        menuVisualMixer.clickEvent.add(new BEventHandler(this,
                "menuVisualMixer_Click"));
        menuVisualWaveform.checkedChangedEvent.add(new BEventHandler(this,
                "menuVisualWaveform_CheckedChanged"));
        menuVisualWaveform.mouseEnterEvent.add(new BEventHandler(this,
                "handleMenuMouseEnter"));
        menuVisualProperty.mouseEnterEvent.add(new BEventHandler(this,
                "handleMenuMouseEnter"));
        menuVisualProperty.checkedChangedEvent.add(new BEventHandler(this,
                "menuVisualProperty_CheckedChanged"));
        menuVisualGridline.checkedChangedEvent.add(new BEventHandler(this,
                "menuVisualGridline_CheckedChanged"));
        menuVisualGridline.mouseEnterEvent.add(new BEventHandler(this,
                "handleMenuMouseEnter"));
        menuVisualIconPalette.clickEvent.add(new BEventHandler(this,
                "menuVisualIconPalette_Click"));
        menuVisualIconPalette.mouseEnterEvent.add(new BEventHandler(this,
                "handleMenuMouseEnter"));
        menuVisualStartMarker.clickEvent.add(new BEventHandler(this,
                "handleStartMarker_Click"));
        menuVisualStartMarker.mouseEnterEvent.add(new BEventHandler(this,
                "handleMenuMouseEnter"));
        menuVisualEndMarker.mouseEnterEvent.add(new BEventHandler(this,
                "handleMenuMouseEnter"));
        menuVisualEndMarker.clickEvent.add(new BEventHandler(this,
                "handleEndMarker_Click"));
        menuVisualLyrics.checkedChangedEvent.add(new BEventHandler(this,
                "menuVisualLyrics_CheckedChanged"));
        menuVisualLyrics.mouseEnterEvent.add(new BEventHandler(this,
                "handleMenuMouseEnter"));
        menuVisualNoteProperty.checkedChangedEvent.add(new BEventHandler(this,
                "menuVisualNoteProperty_CheckedChanged"));
        menuVisualNoteProperty.mouseEnterEvent.add(new BEventHandler(this,
                "handleMenuMouseEnter"));
        menuVisualPitchLine.checkedChangedEvent.add(new BEventHandler(this,
                "menuVisualPitchLine_CheckedChanged"));
        menuVisualPitchLine.mouseEnterEvent.add(new BEventHandler(this,
                "handleMenuMouseEnter"));
        menuVisualPluginUi.mouseEnterEvent.add(new BEventHandler(this,
                "handleMenuMouseEnter"));
        menuVisualPluginUi.dropDownOpeningEvent.add(new BEventHandler(this,
                "menuVisualPluginUi_DropDownOpening"));
        menuVisualPluginUiVocaloid1.clickEvent.add(new BEventHandler(this,
                "menuVisualPluginUiVocaloidCommon_Click"));
        menuVisualPluginUiVocaloid2.clickEvent.add(new BEventHandler(this,
                "menuVisualPluginUiVocaloidCommon_Click"));
        menuVisualPluginUiAquesTone.clickEvent.add(new BEventHandler(this,
                "menuVisualPluginUiAquesTone_Click"));
        menuJob.dropDownOpeningEvent.add(new BEventHandler(this,
                "menuJob_DropDownOpening"));
        menuJobNormalize.mouseEnterEvent.add(new BEventHandler(this,
                "handleMenuMouseEnter"));
        menuJobNormalize.clickEvent.add(new BEventHandler(this,
                "menuJobNormalize_Click"));
        menuJobInsertBar.mouseEnterEvent.add(new BEventHandler(this,
                "handleMenuMouseEnter"));
        menuJobInsertBar.clickEvent.add(new BEventHandler(this,
                "menuJobInsertBar_Click"));
        menuJobDeleteBar.mouseEnterEvent.add(new BEventHandler(this,
                "handleMenuMouseEnter"));
        menuJobDeleteBar.clickEvent.add(new BEventHandler(this,
                "menuJobDeleteBar_Click"));
        menuJobRandomize.mouseEnterEvent.add(new BEventHandler(this,
                "handleMenuMouseEnter"));
        menuJobRandomize.clickEvent.add(new BEventHandler(this,
                "menuJobRandomize_Click"));
        menuJobConnect.mouseEnterEvent.add(new BEventHandler(this,
                "handleMenuMouseEnter"));
        menuJobConnect.clickEvent.add(new BEventHandler(this,
                "menuJobConnect_Click"));
        menuJobLyric.mouseEnterEvent.add(new BEventHandler(this,
                "handleMenuMouseEnter"));
        menuJobLyric.clickEvent.add(new BEventHandler(this, "menuJobLyric_Click"));
        menuTrack.dropDownOpeningEvent.add(new BEventHandler(this,
                "menuTrack_DropDownOpening"));
        menuTrackOn.mouseEnterEvent.add(new BEventHandler(this,
                "handleMenuMouseEnter"));
        menuTrackBgm.mouseEnterEvent.add(new BEventHandler(this,
                "handleMenuMouseEnter"));
        menuTrackOn.clickEvent.add(new BEventHandler(this, "handleTrackOn_Click"));
        menuTrackAdd.mouseEnterEvent.add(new BEventHandler(this,
                "handleMenuMouseEnter"));
        menuTrackAdd.clickEvent.add(new BEventHandler(this, "menuTrackAdd_Click"));
        menuTrackCopy.mouseEnterEvent.add(new BEventHandler(this,
                "handleMenuMouseEnter"));
        menuTrackCopy.clickEvent.add(new BEventHandler(this,
                "menuTrackCopy_Click"));
        menuTrackChangeName.mouseEnterEvent.add(new BEventHandler(this,
                "handleMenuMouseEnter"));
        menuTrackChangeName.clickEvent.add(new BEventHandler(this,
                "menuTrackChangeName_Click"));
        menuTrackDelete.mouseEnterEvent.add(new BEventHandler(this,
                "handleMenuMouseEnter"));
        menuTrackDelete.clickEvent.add(new BEventHandler(this,
                "menuTrackDelete_Click"));
        menuTrackRenderCurrent.mouseEnterEvent.add(new BEventHandler(this,
                "handleMenuMouseEnter"));
        menuTrackRenderCurrent.clickEvent.add(new BEventHandler(this,
                "menuTrackRenderCurrent_Click"));
        menuTrackRenderAll.mouseEnterEvent.add(new BEventHandler(this,
                "handleMenuMouseEnter"));
        menuTrackRenderAll.clickEvent.add(new BEventHandler(this,
                "handleTrackRenderAll_Click"));
        menuTrackOverlay.mouseEnterEvent.add(new BEventHandler(this,
                "handleMenuMouseEnter"));
        menuTrackOverlay.clickEvent.add(new BEventHandler(this,
                "menuTrackOverlay_Click"));
        menuTrackRenderer.mouseEnterEvent.add(new BEventHandler(this,
                "handleMenuMouseEnter"));
        menuTrackRenderer.dropDownOpeningEvent.add(new BEventHandler(this,
                "menuTrackRenderer_DropDownOpening"));
        menuTrackRendererVOCALOID1.mouseEnterEvent.add(new BEventHandler(this,
                "handleMenuMouseEnter"));
        menuTrackRendererVOCALOID1.clickEvent.add(new BEventHandler(this,
                "handleChangeRenderer"));
        menuTrackRendererVOCALOID2.mouseEnterEvent.add(new BEventHandler(this,
                "handleMenuMouseEnter"));
        menuTrackRendererVOCALOID2.clickEvent.add(new BEventHandler(this,
                "handleChangeRenderer"));
        menuTrackRendererUtau.mouseEnterEvent.add(new BEventHandler(this,
                "handleMenuMouseEnter"));
        ...
        menuTrackRendererAquesTone.mouseEnterEvent.add(new BEventHandler(this,
                "handleMenuMouseEnter"));
        menuTrackRendererAquesTone.clickEvent.add(new BEventHandler(this,
                "handleChangeRenderer"));
        menuLyric.dropDownOpeningEvent.add(new BEventHandler(this,
                "menuLyric_DropDownOpening"));
        menuLyricCopyVibratoToPreset.mouseEnterEvent.add(new BEventHandler(
                this, "handleMenuMouseEnter"));
        menuLyricExpressionProperty.mouseEnterEvent.add(new BEventHandler(
                this, "handleMenuMouseEnter"));
        menuLyricExpressionProperty.clickEvent.add(new BEventHandler(this,
                "menuLyricExpressionProperty_Click"));
        menuLyricVibratoProperty.mouseEnterEvent.add(new BEventHandler(this,
                "handleMenuMouseEnter"));
        menuLyricVibratoProperty.clickEvent.add(new BEventHandler(this,
                "menuLyricVibratoProperty_Click"));
        menuLyricPhonemeTransformation.mouseEnterEvent.add(new BEventHandler(
                this, "handleMenuMouseEnter"));
        menuLyricDictionary.mouseEnterEvent.add(new BEventHandler(this,
                "handleMenuMouseEnter"));
        menuLyricDictionary.clickEvent.add(new BEventHandler(this,
                "menuLyricDictionary_Click"));
        menuLyricPhonemeTransformation.clickEvent.add(new BEventHandler(this,
                "menuLyricPhonemeTransformation_Click"));
        menuLyricApplyUtauParameters.clickEvent.add(new BEventHandler(this,
                "menuLyricApplyUtauParameters_Click"));
        menuScriptUpdate.mouseEnterEvent.add(new BEventHandler(this,
                "handleMenuMouseEnter"));
        menuScriptUpdate.clickEvent.add(new BEventHandler(this,
                "menuScriptUpdate_Click"));
        menuSettingPreference.mouseEnterEvent.add(new BEventHandler(this,
                "handleMenuMouseEnter"));
        menuSettingPreference.clickEvent.add(new BEventHandler(this,
                "menuSettingPreference_Click"));
        menuSettingGameControler.mouseEnterEvent.add(new BEventHandler(this,
                "handleMenuMouseEnter"));
        menuSettingGameControlerSetting.clickEvent.add(new BEventHandler(this,
                "menuSettingGameControlerSetting_Click"));
        menuSettingGameControlerLoad.clickEvent.add(new BEventHandler(this,
                "menuSettingGameControlerLoad_Click"));
        menuSettingGameControlerRemove.clickEvent.add(new BEventHandler(this,
                "menuSettingGameControlerRemove_Click"));
        menuSettingSequence.clickEvent.add(new BEventHandler(this,
                "menuSettingSequence_Click"));
        menuSettingSequence.mouseEnterEvent.add(new BEventHandler(this,
                "handleMenuMouseEnter"));
        menuSettingShortcut.mouseEnterEvent.add(new BEventHandler(this,
                "handleMenuMouseEnter"));
        menuSettingShortcut.clickEvent.add(new BEventHandler(this,
                "menuSettingShortcut_Click"));
        menuSettingVibratoPreset.mouseEnterEvent.add(new BEventHandler(this,
                "handleMenuMouseEnter"));
        menuSettingVibratoPreset.clickEvent.add(new BEventHandler(this,
                "menuSettingVibratoPreset_Click"));
        menuSettingDefaultSingerStyle.mouseEnterEvent.add(new BEventHandler(
                this, "handleMenuMouseEnter"));
        menuSettingDefaultSingerStyle.clickEvent.add(new BEventHandler(this,
                "menuSettingDefaultSingerStyle_Click"));
        menuSettingPaletteTool.mouseEnterEvent.add(new BEventHandler(this,
                "handleMenuMouseEnter"));
        menuSettingPositionQuantize.mouseEnterEvent.add(new BEventHandler(
                this, "handleMenuMouseEnter"));
        menuSettingPositionQuantize04.clickEvent.add(new BEventHandler(this,
                "handlePositionQuantize"));
        menuSettingPositionQuantize08.clickEvent.add(new BEventHandler(this,
                "handlePositionQuantize"));
        menuSettingPositionQuantize16.clickEvent.add(new BEventHandler(this,
                "handlePositionQuantize"));
        menuSettingPositionQuantize32.clickEvent.add(new BEventHandler(this,
                "handlePositionQuantize"));
        menuSettingPositionQuantize64.clickEvent.add(new BEventHandler(this,
                "handlePositionQuantize"));
        menuSettingPositionQuantize128.clickEvent.add(new BEventHandler(this,
                "handlePositionQuantize"));
        menuSettingPositionQuantizeOff.clickEvent.add(new BEventHandler(this,
                "handlePositionQuantize"));
        menuSettingPositionQuantizeTriplet.clickEvent.add(new BEventHandler(
                this, "handlePositionQuantizeTriplet_Click"));
        menuWindowMinimize.clickEvent.add(new BEventHandler(this,
                "menuWindowMinimize_Click"));
        menuHelpAbout.clickEvent.add(new BEventHandler(this,
                "menuHelpAbout_Click"));
        menuHelpManual.clickEvent.add(new BEventHandler(this,
                "menuHelpManual_Click"));
        menuHelpLogSwitch.checkedChangedEvent.add(new BEventHandler(this,
                "menuHelpLogSwitch_CheckedChanged"));
        menuHelpLogOpen.clickEvent.add(new BEventHandler(this,
                "menuHelpLogOpen_Click"));
        menuHelpDebug.clickEvent.add(new BEventHandler(this,
                "menuHelpDebug_Click"));
        menuHiddenEditLyric.clickEvent.add(new BEventHandler(this,
                "menuHiddenEditLyric_Click"));
        menuHiddenEditFlipToolPointerPencil.clickEvent.add(new BEventHandler(
                this, "menuHiddenEditFlipToolPointerPencil_Click"));
        menuHiddenEditFlipToolPointerEraser.clickEvent.add(new BEventHandler(
                this, "menuHiddenEditFlipToolPointerEraser_Click"));
        menuHiddenVisualForwardParameter.clickEvent.add(new BEventHandler(
                this, "menuHiddenVisualForwardParameter_Click"));
        menuHiddenVisualBackwardParameter.clickEvent.add(new BEventHandler(
                this, "menuHiddenVisualBackwardParameter_Click"));
        menuHiddenTrackNext.clickEvent.add(new BEventHandler(this,
                "menuHiddenTrackNext_Click"));
        menuHiddenTrackBack.clickEvent.add(new BEventHandler(this,
                "menuHiddenTrackBack_Click"));
        menuHiddenCopy.clickEvent.add(new BEventHandler(this,
                "handleEditCopy_Click"));
        menuHiddenPaste.clickEvent.add(new BEventHandler(this,
                "handleEditPaste_Click"));
        menuHiddenCut.clickEvent.add(new BEventHandler(this,
                "handleEditCut_Click"));
        menuHiddenSelectBackward.clickEvent.add(new BEventHandler(this,
                "menuHiddenSelectBackward_Click"));
        menuHiddenSelectForward.clickEvent.add(new BEventHandler(this,
                "menuHiddenSelectForward_Click"));
        menuHiddenMoveUp.clickEvent.add(new BEventHandler(this,
                "menuHiddenMoveUp_Click"));
        menuHiddenMoveDown.clickEvent.add(new BEventHandler(this,
                "menuHiddenMoveDown_Click"));
        menuHiddenMoveLeft.clickEvent.add(new BEventHandler(this,
                "menuHiddenMoveLeft_Click"));
        menuHiddenMoveRight.clickEvent.add(new BEventHandler(this,
                "menuHiddenMoveRight_Click"));
        menuHiddenLengthen.clickEvent.add(new BEventHandler(this,
                "menuHiddenLengthen_Click"));
        menuHiddenShorten.clickEvent.add(new BEventHandler(this,
                "menuHiddenShorten_Click"));
        menuHiddenGoToEndMarker.clickEvent.add(new BEventHandler(this,
                "menuHiddenGoToEndMarker_Click"));
        menuHiddenGoToStartMarker.clickEvent.add(new BEventHandler(this,
                "menuHiddenGoToStartMarker_Click"));
        menuHiddenPlayFromStartMarker.clickEvent.add(new BEventHandler(this,
                "menuHiddenPlayFromStartMarker_Click"));
        menuHiddenPrintPoToCSV.clickEvent.add(new BEventHandler(this,
                "menuHiddenPrintPoToCSV_Click"));
        menuHiddenFlipCurveOnPianorollMode.clickEvent.add(new BEventHandler(
                this, "menuHiddenFlipCurveOnPianorollMode_Click"));

        cMenuPiano.openingEvent.add(new BCancelEventHandler(this,
                "cMenuPiano_Opening"));
        cMenuPianoPointer.clickEvent.add(new BEventHandler(this,
                "cMenuPianoPointer_Click"));
        cMenuPianoPencil.clickEvent.add(new BEventHandler(this,
                "cMenuPianoPencil_Click"));
        cMenuPianoEraser.clickEvent.add(new BEventHandler(this,
                "cMenuPianoEraser_Click"));
        cMenuPianoCurve.clickEvent.add(new BEventHandler(this,
                "cMenuPianoCurve_Click"));
        cMenuPianoFixed01.clickEvent.add(new BEventHandler(this,
                "cMenuPianoFixed01_Click"));
        cMenuPianoFixed02.clickEvent.add(new BEventHandler(this,
                "cMenuPianoFixed02_Click"));
        cMenuPianoFixed04.clickEvent.add(new BEventHandler(this,
                "cMenuPianoFixed04_Click"));
        cMenuPianoFixed08.clickEvent.add(new BEventHandler(this,
                "cMenuPianoFixed08_Click"));
        cMenuPianoFixed16.clickEvent.add(new BEventHandler(this,
                "cMenuPianoFixed16_Click"));
        cMenuPianoFixed32.clickEvent.add(new BEventHandler(this,
                "cMenuPianoFixed32_Click"));
        cMenuPianoFixed64.clickEvent.add(new BEventHandler(this,
                "cMenuPianoFixed64_Click"));
        cMenuPianoFixed128.clickEvent.add(new BEventHandler(this,
                "cMenuPianoFixed128_Click"));
        cMenuPianoFixedOff.clickEvent.add(new BEventHandler(this,
                "cMenuPianoFixedOff_Click"));
        cMenuPianoFixedTriplet.clickEvent.add(new BEventHandler(this,
                "cMenuPianoFixedTriplet_Click"));
        cMenuPianoFixedDotted.clickEvent.add(new BEventHandler(this,
                "cMenuPianoFixedDotted_Click"));
        cMenuPianoQuantize04.clickEvent.add(new BEventHandler(this,
                "handlePositionQuantize"));
        cMenuPianoQuantize08.clickEvent.add(new BEventHandler(this,
                "handlePositionQuantize"));
        cMenuPianoQuantize16.clickEvent.add(new BEventHandler(this,
                "handlePositionQuantize"));
        cMenuPianoQuantize32.clickEvent.add(new BEventHandler(this,
                "handlePositionQuantize"));
        cMenuPianoQuantize64.clickEvent.add(new BEventHandler(this,
                "handlePositionQuantize"));
        cMenuPianoQuantize128.clickEvent.add(new BEventHandler(this,
                "handlePositionQuantize"));
        cMenuPianoQuantizeOff.clickEvent.add(new BEventHandler(this,
                "handlePositionQuantize"));
        cMenuPianoQuantizeTriplet.clickEvent.add(new BEventHandler(this,
                "handlePositionQuantizeTriplet_Click"));
        cMenuPianoGrid.clickEvent.add(new BEventHandler(this,
                "cMenuPianoGrid_Click"));
        cMenuPianoUndo.clickEvent.add(new BEventHandler(this,
                "cMenuPianoUndo_Click"));
        cMenuPianoRedo.clickEvent.add(new BEventHandler(this,
                "cMenuPianoRedo_Click"));
        cMenuPianoCut.clickEvent.add(new BEventHandler(this,
                "cMenuPianoCut_Click"));
        cMenuPianoCopy.clickEvent.add(new BEventHandler(this,
                "cMenuPianoCopy_Click"));
        cMenuPianoPaste.clickEvent.add(new BEventHandler(this,
                "cMenuPianoPaste_Click"));
        cMenuPianoDelete.clickEvent.add(new BEventHandler(this,
                "cMenuPianoDelete_Click"));
        cMenuPianoSelectAll.clickEvent.add(new BEventHandler(this,
                "cMenuPianoSelectAll_Click"));
        cMenuPianoSelectAllEvents.clickEvent.add(new BEventHandler(this,
                "cMenuPianoSelectAllEvents_Click"));
        cMenuPianoImportLyric.clickEvent.add(new BEventHandler(this,
                "cMenuPianoImportLyric_Click"));
        cMenuPianoExpressionProperty.clickEvent.add(new BEventHandler(this,
                "cMenuPianoProperty_Click"));
        cMenuPianoVibratoProperty.clickEvent.add(new BEventHandler(this,
                "cMenuPianoVibratoProperty_Click"));
        cMenuTrackTab.openingEvent.add(new BCancelEventHandler(this,
                "cMenuTrackTab_Opening"));
        cMenuTrackTabTrackOn.clickEvent.add(new BEventHandler(this,
                "handleTrackOn_Click"));
        cMenuTrackTabAdd.clickEvent.add(new BEventHandler(this,
                "cMenuTrackTabAdd_Click"));
        cMenuTrackTabCopy.clickEvent.add(new BEventHandler(this,
                "cMenuTrackTabCopy_Click"));
        cMenuTrackTabChangeName.clickEvent.add(new BEventHandler(this,
                "cMenuTrackTabChangeName_Click"));
        cMenuTrackTabDelete.clickEvent.add(new BEventHandler(this,
                "cMenuTrackTabDelete_Click"));
        cMenuTrackTabRenderCurrent.clickEvent.add(new BEventHandler(this,
                "cMenuTrackTabRenderCurrent_Click"));
        cMenuTrackTabRenderAll.clickEvent.add(new BEventHandler(this,
                "handleTrackRenderAll_Click"));
        cMenuTrackTabOverlay.clickEvent.add(new BEventHandler(this,
                "cMenuTrackTabOverlay_Click"));
        cMenuTrackTabRenderer.dropDownOpeningEvent.add(new BEventHandler(this,
                "cMenuTrackTabRenderer_DropDownOpening"));
        cMenuTrackTabRendererVOCALOID1.clickEvent.add(new BEventHandler(this,
                "handleChangeRenderer"));
        cMenuTrackTabRendererVOCALOID2.clickEvent.add(new BEventHandler(this,
                "handleChangeRenderer"));
        cMenuTrackTabRendererStraight.clickEvent.add(new BEventHandler(this,
                "handleChangeRenderer"));
        cMenuTrackTabRendererAquesTone.clickEvent.add(new BEventHandler(this,
                "handleChangeRenderer"));
        cMenuTrackSelector.openingEvent.add(new BCancelEventHandler(this,
                "cMenuTrackSelector_Opening"));
        cMenuTrackSelectorPointer.clickEvent.add(new BEventHandler(this,
                "cMenuTrackSelectorPointer_Click"));
        cMenuTrackSelectorPencil.clickEvent.add(new BEventHandler(this,
                "cMenuTrackSelectorPencil_Click"));
        cMenuTrackSelectorLine.clickEvent.add(new BEventHandler(this,
                "cMenuTrackSelectorLine_Click"));
        cMenuTrackSelectorEraser.clickEvent.add(new BEventHandler(this,
                "cMenuTrackSelectorEraser_Click"));
        cMenuTrackSelectorCurve.clickEvent.add(new BEventHandler(this,
                "cMenuTrackSelectorCurve_Click"));
        cMenuTrackSelectorUndo.clickEvent.add(new BEventHandler(this,
                "cMenuTrackSelectorUndo_Click"));
        cMenuTrackSelectorRedo.clickEvent.add(new BEventHandler(this,
                "cMenuTrackSelectorRedo_Click"));
        cMenuTrackSelectorCut.clickEvent.add(new BEventHandler(this,
                "cMenuTrackSelectorCut_Click"));
        cMenuTrackSelectorCopy.clickEvent.add(new BEventHandler(this,
                "cMenuTrackSelectorCopy_Click"));
        cMenuTrackSelectorPaste.clickEvent.add(new BEventHandler(this,
                "cMenuTrackSelectorPaste_Click"));
        cMenuTrackSelectorDelete.clickEvent.add(new BEventHandler(this,
                "cMenuTrackSelectorDelete_Click"));
        cMenuTrackSelectorDeleteBezier.clickEvent.add(new BEventHandler(this,
                "cMenuTrackSelectorDeleteBezier_Click"));
        cMenuTrackSelectorSelectAll.clickEvent.add(new BEventHandler(this,
                "cMenuTrackSelectorSelectAll_Click"));
        cMenuPositionIndicatorEndMarker.clickEvent.add(new BEventHandler(this,
                "cMenuPositionIndicatorEndMarker_Click"));
        cMenuPositionIndicatorStartMarker.clickEvent.add(new BEventHandler(
                this, "cMenuPositionIndicatorStartMarker_Click"));
        trackBar.valueChangedEvent.add(new BEventHandler(this,
                "trackBar_ValueChanged"));
        trackBar.enterEvent.add(new BEventHandler(this, "trackBar_Enter"));
        bgWorkScreen.doWorkEvent.add(new BDoWorkEventHandler(this,
                "bgWorkScreen_DoWork"));
        timer.tickEvent.add(new BEventHandler(this, "timer_Tick"));
        pictKeyLengthSplitter.mouseMoveEvent.add(new BMouseEventHandler(this,
                "pictKeyLengthSplitter_MouseMove"));
        pictKeyLengthSplitter.mouseDownEvent.add(new BMouseEventHandler(this,
                "pictKeyLengthSplitter_MouseDown"));
        pictKeyLengthSplitter.mouseUpEvent.add(new BMouseEventHandler(this,
                "pictKeyLengthSplitter_MouseUp"));
        panelOverview.keyUpEvent.add(new BKeyEventHandler(this,
                "handleSpaceKeyUp"));
        panelOverview.keyDownEvent.add(new BKeyEventHandler(this,
                "handleSpaceKeyDown"));
        vScroll.valueChangedEvent.add(new BEventHandler(this,
                "vScroll_ValueChanged"));
        //this.resizeEvent.add( new BEventHandler( this, "handleVScrollResize" ) );
        pictPianoRoll.resizeEvent.add(new BEventHandler(this,
                "handleVScrollResize"));
        vScroll.enterEvent.add(new BEventHandler(this, "vScroll_Enter"));
        hScroll.valueChangedEvent.add(new BEventHandler(this,
        ...
        picturePositionIndicator.previewKeyDownEvent.add(new BPreviewKeyDownEventHandler(
                this, "picturePositionIndicator_PreviewKeyDown"));
        picturePositionIndicator.mouseMoveEvent.add(new BMouseEventHandler(
                this, "picturePositionIndicator_MouseMove"));
        picturePositionIndicator.mouseClickEvent.add(new BMouseEventHandler(
                this, "picturePositionIndicator_MouseClick"));
        picturePositionIndicator.mouseDoubleClickEvent.add(new BMouseEventHandler(
                this, "picturePositionIndicator_MouseDoubleClick"));
        picturePositionIndicator.mouseDownEvent.add(new BMouseEventHandler(
                this, "picturePositionIndicator_MouseDown"));
        picturePositionIndicator.mouseUpEvent.add(new BMouseEventHandler(this,
                "picturePositionIndicator_MouseUp"));
        picturePositionIndicator.paintEvent.add(new BPaintEventHandler(this,
                "picturePositionIndicator_Paint"));
        pictPianoRoll.previewKeyDownEvent.add(new BPreviewKeyDownEventHandler(
                this, "pictPianoRoll_PreviewKeyDown"));
        pictPianoRoll.keyUpEvent.add(new BKeyEventHandler(this,
                "handleSpaceKeyUp"));
        pictPianoRoll.keyUpEvent.add(new BKeyEventHandler(this,
                "pictPianoRoll_KeyUp"));
        pictPianoRoll.mouseMoveEvent.add(new BMouseEventHandler(this,
                "pictPianoRoll_MouseMove"));
        pictPianoRoll.mouseDoubleClickEvent.add(new BMouseEventHandler(this,
                "pictPianoRoll_MouseDoubleClick"));
        pictPianoRoll.mouseClickEvent.add(new BMouseEventHandler(this,
                "pictPianoRoll_MouseClick"));
        pictPianoRoll.mouseDownEvent.add(new BMouseEventHandler(this,
                "pictPianoRoll_MouseDown"));
        pictPianoRoll.mouseUpEvent.add(new BMouseEventHandler(this,
                "pictPianoRoll_MouseUp"));
        pictPianoRoll.keyDownEvent.add(new BKeyEventHandler(this,
                "handleSpaceKeyDown"));
        waveView.mouseDoubleClickEvent.add(new BMouseEventHandler(this,
                "waveView_MouseDoubleClick"));
        waveView.mouseDownEvent.add(new BMouseEventHandler(this,
                "waveView_MouseDown"));
        waveView.mouseUpEvent.add(new BMouseEventHandler(this,
                "waveView_MouseUp"));
        waveView.mouseMoveEvent.add(new BMouseEventHandler(this,
                "waveView_MouseMove"));
        ...
        stripBtnFileNew.clickEvent.add(new BEventHandler(this,
                "handleFileNew_Click"));
        stripBtnFileNew.enterEvent.add(new BEventHandler(this,
                "handleStripButton_Enter"));
        stripBtnFileOpen.clickEvent.add(new BEventHandler(this,
                "handleFileOpen_Click"));
        stripBtnFileOpen.enterEvent.add(new BEventHandler(this,
                "handleStripButton_Enter"));
        stripBtnFileSave.clickEvent.add(new BEventHandler(this,
                "handleFileSave_Click"));
        stripBtnFileSave.enterEvent.add(new BEventHandler(this,
                "handleStripButton_Enter"));
        stripBtnCut.clickEvent.add(new BEventHandler(this, "handleEditCut_Click"));
        stripBtnCut.enterEvent.add(new BEventHandler(this,
                "handleStripButton_Enter"));
        stripBtnCopy.clickEvent.add(new BEventHandler(this,
                "handleEditCopy_Click"));
        stripBtnCopy.enterEvent.add(new BEventHandler(this,
                "handleStripButton_Enter"));
        stripBtnPaste.clickEvent.add(new BEventHandler(this,
                "handleEditPaste_Click"));
        stripBtnPaste.enterEvent.add(new BEventHandler(this,
                "handleStripButton_Enter"));
        stripBtnUndo.clickEvent.add(new BEventHandler(this,
                "handleEditUndo_Click"));
        stripBtnUndo.enterEvent.add(new BEventHandler(this,
                "handleStripButton_Enter"));
        stripBtnRedo.clickEvent.add(new BEventHandler(this,
                "handleEditRedo_Click"));
        stripBtnRedo.enterEvent.add(new BEventHandler(this,
                "handleStripButton_Enter"));

        stripBtnMoveTop.clickEvent.add(new BEventHandler(this,
                "stripBtnMoveTop_Click"));
        stripBtnMoveTop.enterEvent.add(new BEventHandler(this,
                "handleStripButton_Enter"));
        stripBtnRewind.clickEvent.add(new BEventHandler(this,
                "stripBtnRewind_Click"));
        stripBtnRewind.enterEvent.add(new BEventHandler(this,
                "handleStripButton_Enter"));
        stripBtnForward.clickEvent.add(new BEventHandler(this,
                "stripBtnForward_Click"));
        stripBtnForward.enterEvent.add(new BEventHandler(this,
                "handleStripButton_Enter"));
        stripBtnMoveEnd.clickEvent.add(new BEventHandler(this,
                "stripBtnMoveEnd_Click"));
        stripBtnMoveEnd.enterEvent.add(new BEventHandler(this,
                "handleStripButton_Enter"));
        stripBtnPlay.clickEvent.add(new BEventHandler(this, "stripBtnPlay_Click"));
        stripBtnPlay.enterEvent.add(new BEventHandler(this,
                "handleStripButton_Enter"));
        stripBtnScroll.checkedChangedEvent.add(new BEventHandler(this,
                "stripBtnScroll_CheckedChanged"));
        stripBtnScroll.enterEvent.add(new BEventHandler(this,
                "handleStripButton_Enter"));
        stripBtnLoop.checkedChangedEvent.add(new BEventHandler(this,
                "stripBtnLoop_CheckedChanged"));
        stripBtnLoop.enterEvent.add(new BEventHandler(this,
                "handleStripButton_Enter"));

        stripBtnPointer.clickEvent.add(new BEventHandler(this,
                "stripBtnArrow_Click"));
        stripBtnPointer.enterEvent.add(new BEventHandler(this,
                "handleStripButton_Enter"));
        stripBtnPencil.clickEvent.add(new BEventHandler(this,
                "stripBtnPencil_Click"));
        stripBtnPencil.enterEvent.add(new BEventHandler(this,
                "handleStripButton_Enter"));
        stripBtnLine.clickEvent.add(new BEventHandler(this, "stripBtnLine_Click"));
        stripBtnLine.enterEvent.add(new BEventHandler(this,
                "handleStripButton_Enter"));
        stripBtnEraser.clickEvent.add(new BEventHandler(this,
                "stripBtnEraser_Click"));
        stripBtnEraser.enterEvent.add(new BEventHandler(this,
                "handleStripButton_Enter"));
        stripBtnGrid.clickEvent.add(new BEventHandler(this, "stripBtnGrid_Click"));
        stripBtnGrid.enterEvent.add(new BEventHandler(this,
                "handleStripButton_Enter"));
        stripBtnCurve.clickEvent.add(new BEventHandler(this,
                "stripBtnCurve_Click"));
        stripBtnCurve.enterEvent.add(new BEventHandler(this,
                "handleStripButton_Enter"));
        stripBtnStepSequencer.enterEvent.add(new BEventHandler(this,
                "handleStripButton_Enter"));
        stripBtnStepSequencer.checkedChangedEvent.add(new BEventHandler(this,
                "stripBtnStepSequencer_CheckedChanged"));
        ...
        this.formClosedEvent.add(new BFormClosedEventHandler(this,
                "FormMain_FormClosed"));
        this.formClosingEvent.add(new BFormClosingEventHandler(this,
                "FormMain_FormClosing"));
        this.previewKeyDownEvent.add(new BPreviewKeyDownEventHandler(this,
                "FormMain_PreviewKeyDown"));
        panelOverview.enterEvent.add(new BEventHandler(this,
                "panelOverview_Enter"));
    }
    ...
    public void setResources() {
        try {
            ...
            stripBtnFileOpen.setIcon(new ImageIcon(
                    Resources.get_folder_horizontal_open()));
            ...
            stripBtnMoveTop.setIcon(new ImageIcon(
                    Resources.get_control_stop_180()));
            stripBtnRewind.setIcon(new ImageIcon(
                    Resources.get_control_double_180()));
            stripBtnForward.setIcon(new ImageIcon(
                    Resources.get_control_double()));
            stripBtnMoveEnd.setIcon(new ImageIcon(Resources.get_control_stop()));
            stripBtnPlay.setIcon(new ImageIcon(Resources.get_control()));
            stripBtnScroll.setIcon(new ImageIcon(
                    Resources.get_arrow_circle_double()));
            ...
            stripBtnCurve.setIcon(new ImageIcon(
                    Resources.get_layer_shape_curve()));
        ...
        if (tab || enter) {
            ...
            if (tab) {
                ...
                if (shift) {
                    ...
                    for (int i = track.getEventCount() - 1; i >= 0; i--) {
                        ...
                        if ((ve.ID.type == VsqIDType.Anote) && (i != index) &&
                                (ve.Clock <= clock)) {
                            tindex = i;
            ...
            if ((0 <= index) && (index < track.getEventCount())) {
                ...
                showInputTextBox(item.ID.LyricHandle.L0.Phrase,
                    ...
                    new Point(x, y), phonetic_symbol_edit_mode);
                ...
                // X軸方向について，見えるように移動
                if ((x < key_width) ||
                        (width < (x + AppManager.mInputTextBox.getWidth()))) {
                    int clock;
                    int clock_x;
                    ...
                    double draft_d = (((key_width + AppManager.keyOffset) -
                        clock_x) * controller.getScaleXInv()) + clock;
    ...
    public void mInputTextBox_KeyUp(Object sender, BKeyEventArgs e) {
        boolean flip = ((e.getKeyCode() == KeyEvent.VK_UP) ||
    ...
    public void AppManager_PreviewStarted(Object sender, BEventArgs e) {
        ...
        int selected = AppManager.getSelected();
        VsqFileEx vsq = AppManager.getVsqFile();
        RendererKind renderer = VsqFileEx.getTrackRendererKind(vsq.Track.get(
                    selected));
        int clock = AppManager.getCurrentClock();
        mLastClock = clock;
    ...
    public void ItemSelectionModel_SelectedEventChanged(Object sender,
        boolean selected_event_is_null) {
    ...
    public void AppManager_WaveViewRealoadRequired(Object sender,
        WaveViewRealoadRequiredEventArgs arg) {
        int track = arg.track;
    ...
    public void pictPianoRoll_MouseClick(Object sender, BMouseEventArgs e) {
        ...
        if (e.Button == BMouseButtons.Left) {
            ...
            VsqEvent item = getItemAtClickedPosition(new Point(e.X, e.Y),
                    out_id_rect);
            Rectangle id_rect = out_id_rect.value;

            if ((item != null) && (edit_mode != EditMode.MOVE_ENTRY_WAIT_MOVE) &&
                ...
                if (((modefiers & InputEvent.SHIFT_MASK) != InputEvent.SHIFT_MASK) &&
                        ((modefiers & s_modifier_key) != s_modifier_key)) {
                    AppManager.itemSelection.clearEvent();
                }
                ...
                if (AppManager.getSelectedTool() == EditTool.ERASER) {
                    CadenciiCommand run = new CadenciiCommand(VsqCommand.generateCommandEventDelete(
                ...
                if (AppManager.getSelectedTool() == EditTool.ERASER) {
                    ...
                    for (int i = 0;
                            i < AppManager.mDrawObjects.get(selected - 1).size();
                            i++) {
                        DrawObject dobj = AppManager.mDrawObjects.get(selected -
                                1).get(i);

                        if (((dobj.mRectangleInPixel.x +
                                controller.getStartToDrawX() +
                                dobj.mRectangleInPixel.width) - stdx) < 0) {
                            continue;
                        } else if (pictPianoRoll.getWidth() < ((dobj.mRectangleInPixel.x +
                                AppManager.keyWidth) - stdx)) {
                            break;
                        }

                        Rectangle rc = new Rectangle((dobj.mRectangleInPixel.x +
                                AppManager.keyWidth +
                                dobj.mVibratoDelayInPixel) - stdx,
                                (dobj.mRectangleInPixel.y +
                                (int) (100 * controller.getScaleY())) - stdy,
                                dobj.mRectangleInPixel.width -
                                dobj.mVibratoDelayInPixel,
            ...
            show_context_menu = AppManager.showContextMenuWhenRightClickedOnPianoroll
                ? (show_context_menu && !mMouseMoved) : false;
            ...
            if (show_context_menu) {
                ...
                if (item != null) {
                    if (!AppManager.itemSelection.isEventContains(
                                AppManager.getSelected(), item.InternalID)) {
                        AppManager.itemSelection.clearEvent();
                    }
                ...
                cMenuPianoPaste.setEnabled(((AppManager.clipboard.getCopiedItems().events.size() != 0) &&
                ...
                ByRef<Rectangle> out_id_rect = new ByRef<Rectangle>();
                VsqEvent item = getItemAtClickedPosition(mButtonInitial,
                        out_id_rect);
                Rectangle id_rect = out_id_rect.value;
    ...
    public void pictPianoRoll_MouseDoubleClick(Object sender, BMouseEventArgs e) {
        ...
        if ((item != null) && (item.ID.type == VsqIDType.Anote)) {
            ...
            showInputTextBox(item.ID.LyricHandle.L0.Phrase,
                item.ID.LyricHandle.L0.getPhoneticSymbol(),
                new Point(rect.x, rect.y), mLastSymbolEditMode);
            refreshScreen();
            ...
            if (AppManager.editorConfig.ShowExpLine &&
                    (AppManager.keyWidth <= e.X)) {
                int stdx = controller.getStartToDrawX();
                int stdy = controller.getStartToDrawY();

                for (Iterator<DrawObject> itr = AppManager.mDrawObjects.get(selected -
                            1).iterator(); itr.hasNext();) {
                    DrawObject dobj = itr.next();
                    // 表情コントロールプロパティを表示するかどうかを決める
                    rect = new Rectangle((dobj.mRectangleInPixel.x +
                            AppManager.keyWidth) - stdx,
                            dobj.mRectangleInPixel.y - stdy +
                            (int) (100 * controller.getScaleY()), 21,
                            (int) (100 * controller.getScaleY()));

                    if (Utility.isInRect(new Point(e.X, e.Y), rect)) {
                        VsqEvent selectedEvent = null;

                        for (Iterator<VsqEvent> itr2 = vsq.Track.get(selected)
                                                                .getEventIterator();
                                itr2.hasNext();) {
                        ...
                        if (selectedEvent != null) {
                            ...
                            try {
                                dlg = new FormNoteExpressionConfig(type,
                                        selectedEvent.ID.NoteHeadHandle);
                                ...
                                BDialogResult dr = AppManager.showModalDialog(dlg,
                                        this);
                                ...
                                if (dr == BDialogResult.OK) {
                                    ...
                                    CadenciiCommand run = new CadenciiCommand(VsqCommand.generateCommandEventChangeIDContaints(
                                                selected,
                                                selectedEvent.InternalID, id));
                                    AppManager.editHistory.register(vsq.executeCommand(
                                            run));
                                    setEdited(true);
                                    refreshScreen();
                                }
                                ...
                                Logger.write(FormMain.class +
                                    ".pictPianoRoll_MouseDoubleClick; ex=" +
                                    ex + "\n");
                                serr.println(FormMain.class +
                                    ".pictPianoRoll_MouseDoubleClick" + ex);
                            } finally {
                                if (dlg != null) {
                                    try {
                    ...
                    if (Utility.isInRect(new Point(e.X, e.Y), rect)) {
                        ...
                        if (selectedEvent != null) {
                            ...
                            try {
                                dlg = new FormVibratoConfig(selectedEvent.ID.VibratoHandle,
        ...
        if (e.Button == BMouseButtons.Left) {
            ...
            if (AppManager.keyWidth < e.X) {
                int clock = doQuantize(AppManager.clockFromXCoord(e.X),
                        AppManager.getPositionQuantizeClock());
    ...
    public void pictPianoRoll_MouseDown(Object sender, BMouseEventArgs e0) {
        ...
        BMouseEventArgs e = new BMouseEventArgs(btn0, e0.Clicks, e0.X, e0.Y,
                e0.Delta);

        mMouseMoved = false;

        if (!AppManager.isPlaying() && (0 <= e.X) &&
        ...
        if ((e.Button == BMouseButtons.Left) && AppManager.mCurveOnPianoroll &&
                ((selected_tool == EditTool.PENCIL) ||
                (selected_tool == EditTool.LINE))) {
        ...
        if (item == null) {
            ...
            if ((modefier & s_modifier_key) == s_modifier_key) {
                ...
                if ((selected_tool == EditTool.LINE) ||
                        (selected_tool == EditTool.PENCIL)) {
                    // ビブラート範囲の編集
                    ...
                    for (int i = 0; i < count; i++) {
                        ...
                        if (((dobj.mRectangleInPixel.x + key_width +
                                dobj.mRectangleInPixel.width) - stdx) < 0) {
                            continue;
                        } else if (pictPianoRoll.getWidth() < ((dobj.mRectangleInPixel.x +
                                key_width) - stdx)) {
                        ...
                        Rectangle rc = new Rectangle((dobj.mRectangleInPixel.x +
                                key_width + dobj.mVibratoDelayInPixel) - stdx -
                                (_EDIT_HANDLE_WIDTH / 2),
                                (dobj.mRectangleInPixel.y +
                                (int) (100 * controller.getScaleY())) - stdy,
                                _EDIT_HANDLE_WIDTH,
                                (int) (100 * controller.getScaleY()));
                        ...
                        if (Utility.isInRect(new Point(e.X, e.Y), rc)) {
                            ...
                            pxFound.x += key_width;
                            px_vibrato_length = dobj.mRectangleInPixel.width -
                                dobj.mVibratoDelayInPixel;
                    ...
                    if (vibrato_dobj != null) {
                        int clock = AppManager.clockFromXCoord((pxFound.x +
                                pxFound.width) - px_vibrato_length - stdx);
                        int note = vibrato_dobj.mNote - 1; // AppManager.noteFromYCoord( pxFound.y + (int)(100 * AppManager.getScaleY()) - stdy );
                        int length = (vibrato_dobj.mClock +
                            vibrato_dobj.mLength) - clock; // (int)(pxFound.width * AppManager.getScaleXInv());
                        AppManager.mAddingEvent = new VsqEvent(clock,
                                new VsqID(0));
                        AppManager.mAddingEvent.ID.type = VsqIDType.Anote;
                        ...
                        AppManager.mAddingEvent.ID.VibratoDelay = length -
                            (int) (px_vibrato_length * controller.getScaleXInv());
                ...
                if (vibrato_dobj == null) {
                    if (((selected_tool == EditTool.PENCIL) ||
                        ...
                        if ((AppManager.getVsqFile().getPreMeasureClocks() -
                                (AppManager.editorConfig.PxTolerance * controller.getScaleXInv())) <= clock) {
                            //10ピクセルまでは許容範囲
                            if (AppManager.getVsqFile().getPreMeasureClocks() > clock) { //だけど矯正するよ。
                                clock = AppManager.getVsqFile()
                                                  .getPreMeasureClocks();
                            }
                            ...
                            AppManager.mAddingEvent = new VsqEvent(new_clock,
                                    new VsqID(0));
                            // デフォルトの歌唱スタイルを適用する
                        ...
                        AppManager.setWholeSelectedIntervalEnabled(false);
                        AppManager.itemSelection.clearEvent();
                        AppManager.mMouseDownLocation = new Point(e.X + stdx,
                                e.Y + stdy);
                        AppManager.mIsPointerDowned = true;
                    }
                }
            ...
            if ((e.Button == BMouseButtons.Right) &&
                    !AppManager.editorConfig.PlayPreviewWhenRightClick) {
                start_mouse_hover_generator = false;
            }
        } else {
            if (AppManager.itemSelection.isEventContains(selected,
                        item.InternalID)) {
                executeLyricChangeCommand();
            }
            ...
            if ((item.ID.type != VsqIDType.Aicon) ||
                    ...
                    !item.ID.IconDynamicsHandle.isDynaffType())) {
                if ((selected_tool != EditTool.ERASER) &&
                        (e.Button == BMouseButtons.Left)) {
                    ...
                    for (Iterator<DrawObject> itr = AppManager.mDrawObjects.get(selected -
                        ...
                        Rectangle rc = new Rectangle(dobj.mRectangleInPixel.x -
                                stdx + key_width,
                                dobj.mRectangleInPixel.y - stdy,
                                edit_handle_width, dobj.mRectangleInPixel.height);
                        ...
                        // 右端の糊代にマウスがあるかどうか
                        rc = new Rectangle((dobj.mRectangleInPixel.x +
                                key_width + dobj.mRectangleInPixel.width) -
                                stdx - edit_handle_width,
                                dobj.mRectangleInPixel.y - stdy,
                                edit_handle_width, dobj.mRectangleInPixel.height);
    ...
    public void pictPianoRoll_MouseMove(Object sender, BMouseEventArgs e) {
        if (mFormActivated) {
            if ((AppManager.mInputTextBox != null) &&
                    !AppManager.mInputTextBox.isVisible() &&
                    !AppManager.propertyPanel.isEditing()) {
                focusPianoRoll();
            }
        }
        ...
        if ((mExtDragX == ExtDragXMode.RIGHT) ||
                (mExtDragX == ExtDragXMode.LEFT)) {
        ...
        if (AppManager.mIsPointerDowned) {
            if (AppManager.isWholeSelectedIntervalEnabled()) {
                ...
                for (Iterator<DrawObject> itr = AppManager.mDrawObjects.get(selected -
                    ...
                    int x1 = dobj.mRectangleInPixel.x + AppManager.keyWidth +
                        dobj.mRectangleInPixel.width;
                    int y0 = dobj.mRectangleInPixel.y;
                    int y1 = dobj.mRectangleInPixel.y +
                        dobj.mRectangleInPixel.height;
                    internal_id = dobj.mInternalID;
                ...
                for (Iterator<SelectedEventEntry> itr = AppManager.itemSelection.getEventIterator();
                    ...
                    if (!add_required.contains(
                                selectedEvent.original.InternalID)) {
                        remove_required.add(selectedEvent.original.InternalID);
                    }
                }

                if (remove_required.size() > 0) {
                    AppManager.itemSelection.removeEventRange(PortUtil.convertIntArray(
                            remove_required.toArray(new Integer[] {  })));
                }

                for (Iterator<Integer> itr = add_required.iterator();
                        itr.hasNext();) {
                    int id = itr.next();
        ...
        if (edit_mode == EditMode.MIDDLE_DRAG) {
            ...
            if (AppManager.itemSelection.getEventCount() > 0) {
                ...
                int dnote = (edit_mode == EditMode.MOVE_ENTRY)
                    ? (note - note_init) : 0;
            ...
            for (Iterator<SelectedEventEntry> itr = AppManager.itemSelection.getEventIterator();
                    itr.hasNext();) {
                SelectedEventEntry item = itr.next();
                int end_clock = item.original.Clock +
                    item.original.ID.getLength();
                int new_clock = item.original.Clock + dclock;
            ...
            for (Iterator<SelectedEventEntry> itr = AppManager.itemSelection.getEventIterator();
                    itr.hasNext();) {
                SelectedEventEntry item = itr.next();
                int new_length = doQuantize(item.original.ID.getLength() +
                        dlength, unit);
            ...
            int old_vibrato_end = AppManager.mAddingEvent.Clock +
                AppManager.mAddingEvent.ID.getLength();
            int new_vibrato_length = old_vibrato_end - new_vibrato_start;
            int max_length = (int) (AppManager.mAddingEventLength -
                (_PX_ACCENT_HEADER * controller.getScaleXInv()));
        ...
        // カーソルの形を決める
        if (!mMouseDowned && (edit_mode != EditMode.CURVE_ON_PIANOROLL) &&
                !(AppManager.mCurveOnPianoroll &&
                ((selected_tool == EditTool.PENCIL) ||
                (selected_tool == EditTool.LINE)))) {
            ...
            for (Iterator<DrawObject> itr = AppManager.mDrawObjects.get(selected -
                ...
                if (dobj.mType != DrawObjectType.Dynaff) {
                    ...
                    rc = new Rectangle((dobj.mRectangleInPixel.x +
                            AppManager.keyWidth) - stdx,
                            dobj.mRectangleInPixel.y - stdy, edit_handle_width,
                            (int) (100 * controller.getScaleY()));
                    ...
                    // 音符右側の編集領域
                    rc = new Rectangle((dobj.mRectangleInPixel.x +
                            AppManager.keyWidth + dobj.mRectangleInPixel.width) -
                            stdx - edit_handle_width,
                            dobj.mRectangleInPixel.y - stdy, edit_handle_width,
                            (int) (100 * controller.getScaleY()));
        ...
        if (edit_mode == EditMode.CURVE_ON_PIANOROLL) {
            if (pictPianoRoll.mMouseTracer.size() > 1) {
                ...
                for (Iterator<VsqEvent> itr = vsq_track.getNoteEventIterator();
                    ...
                    for (Iterator<Integer> itr2 = pit.keyClockIterator();
                            itr2.hasNext();) {
                        int clock = itr2.next();

                        if ((cl_remove_start <= clock) &&
                                (clock <= cl_remove_end)) {
                            remove.add(clock);
                        }
                    }

                    for (Iterator<Integer> itr2 = remove.iterator();
                            itr2.hasNext();) {
                        int clock = itr2.next();
                        pit.remove(clock);
                    }
                    ...
                    int px_item_start = AppManager.xCoordFromClocks(cl_item_start) +
                        stdx;
                    int px_item_end = AppManager.xCoordFromClocks(cl_item_end) +
                        stdx;
                    ...
                    for (Iterator<Point> itr2 = pictPianoRoll.mMouseTracer.iterator();
                            itr2.hasNext();) {
                        Point p = itr2.next();
                        ...
                        double note = AppManager.noteFromYCoordDoublePrecision(p.y -
                                stdy - half_track_height);
                        int v_pit = (int) (d2_13 / (double) pbs.getValue(clock) * (note -
                            item.ID.Note));
                        ...
                        if ((cl_item_start < clock) && !cl_item_start_added &&
                                ...
                                (cl_item_start < cl_end)) {
                            // これから追加しようとしているデータ点の時刻が、音符の開始時刻よりも後なんだけれど、
                            // 音符の開始時刻におけるデータをまだ書き込んでない場合
                            double a = (p.y - last_py) / (double) (p.x -
                                last_px);
                            double x_at_clock = AppManager.xCoordFromClocks(cl_item_start) +
                                stdx;
                            double ext_y = last_py +
                                (a * (x_at_clock - last_px));
                            double tnote = AppManager.noteFromYCoordDoublePrecision((int) (ext_y -
                                    stdy - half_track_height));
                            int t_vpit = (int) (d2_13 / (double) pbs.getValue(cl_item_start) * (tnote -
                                item.ID.Note));
                    ...
                    if (!cl_item_end_added && (cl_start <= cl_item_end) &&
                            (cl_item_end <= cl_end)) {
        ...
        if (edit_mode == EditMode.MIDDLE_DRAG) {
            ...
            if (AppManager.getSelected() >= 0) {
                if ((edit_mode == EditMode.ADD_FIXED_LENGTH_ENTRY) ||
                        ((edit_mode == EditMode.ADD_ENTRY) &&
                        ((mButtonInitial.x != e.X) ||
                        (mButtonInitial.y != e.Y)) &&
                        (AppManager.mAddingEvent.ID.getLength() > 0))) {
            ...
            if (AppManager.itemSelection.getEventCount() > 0) {
                ...
                if ((original.Clock != last_selected_event.editing.Clock) ||
                    ...
                    for (Iterator<SelectedEventEntry> itr = AppManager.itemSelection.getEventIterator();
                        ...
                        if ((ev.editing.ID.Note < 0) ||
                                (128 < ev.editing.ID.Note)) {
                            out_of_range = true;

                            break;
                        }

                        for (Iterator<VsqEvent> itr2 = copied.getEventIterator();
                                itr2.hasNext();) {
                    ...
                    if (out_of_range) {
                        ...
                        CadenciiCommand run = VsqFileEx.generateCommandTrackReplace(selected,
                                copied, vsq.AttachedCurves.get(selected - 1));
                        AppManager.editHistory.register(vsq.executeCommand(run));
            ...
            if (mMouseMoved) {
                ...
                for (Iterator<SelectedEventEntry> itr = AppManager.itemSelection.getEventIterator();
                    ...
                    Utility.editLengthOfVsqEvent(ev.editing,
                        ev.editing.ID.getLength(),
                        AppManager.vibratoLengthEditingRule);
                ...
                if (contains_aicon) {
                    ...
                    VsqTrack copied = (VsqTrack) copied_vsq.Track.get(selected)
                                                                 .clone();
                    copied.reflectDynamics();
                    run = VsqFileEx.generateCommandTrackReplace(selected,
                            copied, vsq.AttachedCurves.get(selected - 1));
                } else {
                    run = new CadenciiCommand(VsqCommand.generateCommandEventChangeClockAndIDContaintsRange(
                                selected, ids, clocks, values));
                }
            ...
            if (mMouseMoved) {
                ...
                if (item != null) {
                    ...
                    CadenciiCommand run = new CadenciiCommand(VsqCommand.generateCommandEventChangeIDContaints(
                                selected, mVibratoEditingId, item.ID));
                    AppManager.editHistory.register(vsq.executeCommand(run));
                    setEdited(true);
                }
            }
            ...
            int dst_clock_end = dst_clock_start +
                (src_clock_end - src_clock_start);
            ...
            for (Iterator<SelectedEventEntry> itr = AppManager.itemSelection.getEventIterator();
                ...
                for (Iterator<VsqEvent> itr2 = work.getNoteEventIterator();
                        itr2.hasNext();) {
            ...
            for (int i = 0; i < Utility.CURVE_USAGE.length; i++) {
                ...
                VsqBPList copied = new VsqBPList(bplist.getName(),
                        bplist.getDefault(), bplist.getMinimum(),
                        bplist.getMaximum());
            ...
            // コマンドを作成＆実行
            CadenciiCommand run = VsqFileEx.generateCommandTrackReplace(selected,
                    work, vsq.AttachedCurves.get(selected - 1));
            AppManager.editHistory.register(vsq.executeCommand(run));
...
heaven: 
        ...
        if ((modifier & InputEvent.CTRL_MASK) == InputEvent.CTRL_MASK) {
            ...
            if (horizontal) {
                ...
                if (old_tbv != draft) {
                    ...
                    int stdx1 = (int) ((clock_at_mouse * (scale1 - scale0)) +
                        stdx0);
            ...
            // スクロール操作
            if ((e.X <= AppManager.keyWidth) ||
                    (pictPianoRoll.getWidth() < e.X)) {
                horizontal = false;
            }
    ...
    public void pictPianoRoll_PreviewKeyDown(Object sender,
        BPreviewKeyDownEventArgs e) {
    ...
    public void menuVisualNoteProperty_CheckedChanged(Object sender,
        BEventArgs e) {
    ...
    public void menuVisualControlTrack_CheckedChanged(Object sender,
        BEventArgs e) {
    ...
    public void menuVisualPluginUiVocaloidCommon_Click(Object sender,
        BEventArgs e) {
    ...
    public void mPropertyPanelContainer_StateChangeRequired(Object sender,
        PanelState arg) {
        updatePropertyPanelState(arg);
    }

    public void propertyPanel_CommandExecuteRequired(Object sender,
        CadenciiCommand command) {
        AppManager.editHistory.register(AppManager.getVsqFile()
    ...
    public void propertyWindow_FormClosing(Object sender,
    ...
    public void propertyWindow_LocationOrSizeChanged(Object sender, BEventArgs e) {
        if (AppManager.editorConfig.PropertyWindowStatus.State == PanelState.Window) {
            if (AppManager.propertyWindow.getExtendedState() != BForm.ICONIFIED) {
                ...
                AppManager.editorConfig.PropertyWindowStatus.Bounds = new XmlRectangle(proeprty.x -
                        parent.x, proeprty.y - parent.y,
    ...
    public void handleDragOver(int screen_x, int screen_y) {
        ...
        if (!mIconPaletteOnceDragEntered) {
            int keywidth = AppManager.keyWidth;
            Rectangle rc = new Rectangle(pt.x + keywidth, pt.y,
        ...
        BMouseEventArgs e0 = new BMouseEventArgs(BMouseButtons.Left, 1,
                screen_x - pt.x, screen_y - pt.y, 0);
    ...
    /// </summary>
    public void handleDragDrop(IconDynamicsHandle handle, int screen_x,
        int screen_y) {
        if (handle == null) {
            return;
        }
    ...
    public boolean handleFormClosing() {
        if (isEdited()) {
            ...
            BDialogResult ret = AppManager.showMessageBox(gettext(
                        "Save this sequence?"), gettext("Affirmation"),
                    org.kbinani.windows.forms.Utility.MSGBOX_YES_NO_CANCEL_OPTION,
                    org.kbinani.windows.forms.Utility.MSGBOX_QUESTION_MESSAGE);
            ...
            if (ret == BDialogResult.YES) {
                if (AppManager.getFileName().equals("")) {
                    int dr = AppManager.showModalDialog(saveXmlVsqDialog,
                            false, this);
    ...
    public void FormGenerateKeySound_FormClosed(Object sender,
        BFormClosedEventArgs e) {
        try {
            KeySoundPlayer.init();
        } catch (Exception ex) {
            Logger.write(FormMain.class +
                ".FormGenerateKeySound_FormClosed; ex=" + ex + "\n");
    ...
    public void FormMain_WindowStateChanged(Object sender, BEventArgs e) {
        ...
        if ((state == BForm.NORMAL) || (state == BForm.MAXIMIZED_BOTH)) {
            ...
            // アイコンパレットの状態を更新
            if ((AppManager.iconPalette != null) &&
                    menuVisualIconPalette.isSelected()) {
    ...
    public void FormMain_PreviewKeyDown(Object sender,
        BPreviewKeyDownEventArgs e) {
    ...
    public void menuFileSaveNamed_Click(Object sender, BEventArgs e) {
        for (int track = 1; track < AppManager.getVsqFile().Track.size();
                track++) {
    ...
    public void menuFileExport_DropDownOpening(Object sender, BEventArgs e) {
        menuFileExportWave.setEnabled((AppManager.getVsqFile().Track.get(
                AppManager.getSelected()).getEventCount() > 0));
    }
    ...
    public void menuFileExportMidi_Click(Object sender, BEventArgs e) {
        ...
        for (int i = 0; i < vsq.Track.size(); i++) {
            ...
            mDialogMidiImportAndExport.listTrack.addRow(new String[] {
                    i + "", track.getName(), notes + ""
                }, true);
        }

        mDialogMidiImportAndExport.setMode(FormMidiImExport.FormMidiMode.EXPORT);
        mDialogMidiImportAndExport.setLocation(getFormPreferedLocation(
                mDialogMidiImportAndExport));

        BDialogResult dr = AppManager.showModalDialog(mDialogMidiImportAndExport,
                this);
        ...
        if (dr == BDialogResult.OK) {
            ...
            for (int i = 0;
                    i < mDialogMidiImportAndExport.listTrack.getItemCountRow();
                    i++) {
            ...
            int dialog_result = AppManager.showModalDialog(saveMidiDialog,
                    false, this);
            ...
            if (dialog_result == BFileChooser.APPROVE_OPTION) {
                ...
                try {
                    ...
                    for (int i = 0;
                            i < mDialogMidiImportAndExport.listTrack.getItemCountRow();
                            i++) {
                        if (!mDialogMidiImportAndExport.listTrack.isRowChecked(
                                    i)) {
                            continue;
                        }
                        ...
                        byte[] track_name = PortUtil.getEncodedByte("Shift_JIS",
                                track.getName());
                        ...
                        if (mDialogMidiImportAndExport.isLyric()) {
                            for (Iterator<VsqEvent> itr = track.getNoteEventIterator();
                                ...
                                byte[] lyric = PortUtil.getEncodedByte("Shift_JIS",
                                        ve.ID.LyricHandle.L0.Phrase);
                        ...
                        if (mDialogMidiImportAndExport.isVocaloidMetatext() &&
                                (i > 0)) {
                        ...
                        if (mDialogMidiImportAndExport.isVocaloidNrpn() &&
                                (i > 0)) {
                            VsqNrpn[] vsqnrpn = VsqFileEx.generateNRPN((VsqFile) vsq,
                                    i, AppManager.editorConfig.PreSendTime);
                        ...
                        if (events_count > 0) {
                            for (int j = 0; j < events_count; j++) {
                                if ((events.get(j).clock > 0) &&
                                        (meta.size() > 0)) {
                                    for (int k = 0; k < meta.size(); k++) {
                                        VsqFile.writeFlexibleLengthUnsignedLong(fs,
                                            0);
                                ...
                                while ((vocaloid_nrpn_midievent.size() > 0) &&
                                        (vocaloid_nrpn_midievent.get(0).clock < clock)) {
                                    VsqFile.writeFlexibleLengthUnsignedLong(fs,
                                        (long) (vocaloid_nrpn_midievent.get(0).clock -
                                        last_clock));
                                ...
                                VsqFile.writeFlexibleLengthUnsignedLong(fs,
                                    (long) (events.get(j).clock - last_clock));
                    ...
                    Logger.write(FormMain.class +
                        ".menuFileExportMidi_Click; ex=" + ex + "\n");
                } finally {
                    if (fs != null) {
                        try {
                            fs.close();
                            ...
                            Logger.write(FormMain.class +
                                ".menuFileExportMidi_Click; ex=" + ex2 + "\n");
                        }
                    }
                }
            }
    ...
    public void menuFileExportMusicXml_Click(Object sender, BEventArgs e) {
        ...
        try {
            ...
            Logger.write(FormMain.class + ".menuFileExportMusicXml_Click; ex=" +
                ex + "\n");
            ...
            if (dialog != null) {
                try {
                    ...
                    Logger.write(FormMain.class +
                        ".menuFileExportMusicXml_Click; ex=" + ex2 + "\n");
                    serr.println("FormMain#menuFileExportMusicXml_Click; ex2=" +
                        ex2);
                }
            }
        }
    ...
    public void menuFileExportParaWave_Click(Object sender, BEventArgs e) {
        ...
        try {
            ...
            String initial_dir = AppManager.editorConfig.getLastUsedPathOut(
                    "wav");
        ...
        int clockStart = vsq.config.StartMarkerEnabled ? vsq.config.StartMarker
                                                       : 0;
        int clockEnd = vsq.config.EndMarkerEnabled ? vsq.config.EndMarker
                                                   : (vsq.TotalClocks + 240);

        if (clockStart > clockEnd) {
            AppManager.showMessageBox(gettext(
                    "invalid rendering region; start>=end"), gettext("Error"),
                PortUtil.OK_OPTION,
                org.kbinani.windows.forms.Utility.MSGBOX_INFORMATION_MESSAGE);
        ...
        try {
            ...
            for (int i = 0; i < queue.size(); i++) {
                ...
                fw.addJob(worker, "processQueue", q.getMessage(),
                    q.getJobAmount(), q);
            }
    ...
    public void menuFileExportUst_Click(Object sender, BEventArgs e) {
        ...
        try {
            ...
            if (dialog != null) {
                try {
                    ...
                    Logger.write(FormMain.class +
                        ".menuFileExportUst_Click; ex=" + ex2 + "\n");
                }
            }
        }
        ...
        if ((0 <= resampler_index) &&
                (resampler_index < AppManager.editorConfig.getResamplerCount())) {
            ust.setResampler(AppManager.editorConfig.getResamplerAt(
                    resampler_index));
        }
        ...
        try {
            ...
            if (dialog != null) {
                try {
                    ...
                    Logger.write(FormMain.class +
                        ".menuFileExportVsq_Click; ex=" + ex2 + "\n");
                }
            }
        }
    ...
    public void menuFileExportVxt_Click(Object sender, BEventArgs e) {
        ...
        if (AppManager.editorConfig.UtauSingers.size() <= 0) {
            BDialogResult dr = AppManager.showMessageBox(gettext(
                        "UTAU singer not registered yet.\nContinue ?"),
                    gettext("Info"),
                    org.kbinani.windows.forms.Utility.MSGBOX_YES_NO_OPTION,
                    org.kbinani.windows.forms.Utility.MSGBOX_INFORMATION_MESSAGE);
        ...
        try {
            ...
            if (dialog != null) {
                try {
                    ...
                    Logger.write(FormMain.class +
                        ".menuFileExportVxt_Click; ex=" + ex2 + "\n");
                }
            }
        }
        ...
        try {
            ...
            if (singer != null) {
                ...
                if ((0 <= indx) &&
                        (indx < AppManager.editorConfig.UtauSingers.size())) {
            ...
            // 出力
            VConnectWaveGenerator.prepareMetaText(bw, vsq_track, oto_ini,
                vsq.TotalClocks, false);
        } catch (Exception ex) {
            Logger.write(FormMain.class + ".menuFileExportVxt_Click; ex=" + ex +
                "\n");
    ...
    public void menuFileExportWave_Click(Object sender, BEventArgs e) {
        ...
        try {
            ...
            Logger.write(FormMain.class + ".menuFileExportWave_Click; ex=" +
                ex + "\n");
        } finally {
            if (sfd != null) {
                try {
                    ...
                    Logger.write(FormMain.class +
                        ".menuFileExportWave_Click; ex=" + ex2 + "\n");
                }
            }
        }
        ...
        Vector<PatchWorkQueue> queue = AppManager.patchWorkCreateQueue(other_tracks);
        PatchWorkQueue q = new PatchWorkQueue();
        q.track = selected;
        q.clockStart = clockStart;
        q.clockEnd = clockEnd;
        ...
        try {
            ...
            for (PatchWorkQueue qb : queue) {
                fs.addJob(worker, "processQueue", qb.getMessage(),
                    qb.getJobAmount(), qb);
            }
    ...
    public void menuFileImportMidi_Click(Object sender, BEventArgs e) {
        ...
        int dialog_result = AppManager.showModalDialog(openMidiDialog, true,
                this);
        ...
        try {
            ...
            Logger.write(FormMain.class + ".menuFileImportMidi_Click; ex=" +
                ex + "\n");
            AppManager.showMessageBox(gettext("Invalid MIDI file."),
                gettext("Error"),
                org.kbinani.windows.forms.Utility.MSGBOX_DEFAULT_OPTION,
                org.kbinani.windows.forms.Utility.MSGBOX_WARNING_MESSAGE);
        ...
        for (int i = 0; i < count; i++) {
            ...
            for (int j = 0; j < events_count; j++) {
                ...
                if ((item.firstByte == 0xff) && (item.data.length >= 2) &&
                        (item.data[0] == 0x03)) {
                    ...
                    track_name = PortUtil.getDecodedString("Shift_JIS", d, 1,
                            item.data.length - 1);
            ...
            for (int j = 0; j < events_count; j++) {
                ...
                if (((item.firstByte & 0xf0) == 0x90) &&
                        (item.data.length > 1) && (item.data[1] > 0x00)) {
                    notes++;
                }
            }
        ...
        for (int i = 0; i < mf_getTrackCount; i++) {
            ...
            for (int j = 0; j < events_Count; j++) {
                ...
                if (!tempo_added && (itemj.firstByte == 0xff) &&
                        (itemj.data.length >= 4) && (itemj.data[0] == 0x51)) {
                    ...
                    if (!contains_same_clock) {
                        int vtempo = (itemj.data[1] << 16) |
                            (itemj.data[2] << 8) | itemj.data[3];
                        tempo.TempoTable.add(new TempoTableEntry(
                                (int) itemj.clock, vtempo, 0.0));
                        t_tempo_added = true;
                    }
                }

                if (!timesig_added && (itemj.firstByte == 0xff) &&
                        (itemj.data.length >= 5) && (itemj.data[0] == 0x58)) {
                    ...
                    int barcount_at_itemj = last_barcount +
                        (((int) itemj.clock - last_timesig_clock) / clock_per_bar);
                    ...
                    if (!contains_same_clock) {
                        tempo.TimesigTable.add(new TimeSigTableEntry(
                                (int) itemj.clock, num, den, barcount_at_itemj));
        ...
        if (import_tempo) {
            ...
            for (int i = 0; i < list_count; i++) {
                ...
                work.TempoTable.add(new TempoTableEntry(item.Clock, item.Tempo,
                        item.Time));
            }
        ...
        if (mDialogMidiImportAndExport.isTimesig()) {
            ...
            for (int i = 0; i < list_count; i++) {
                ...
                work.TimesigTable.add(new TimeSigTableEntry(item.Clock,
                        item.Numerator, item.Denominator, item.BarCount));
            }
        ...
        for (int i = 0;
            ...
            VsqTrack work_track = new VsqTrack(mDialogMidiImportAndExport.listTrack.getItemAt(
                        i, 1), "Miku");
            ...
            if (mDialogMidiImportAndExport.isNotes()) {
                ...
                for (int j = 0; j < events_count; j++) {
                    ...
                    if (((itemj.firstByte & 0xf0) == 0x90) &&
                            (itemj.data.length >= 2) && (itemj.data[1] > 0)) {
                        for (int m = 0; m < 128; m++) {
                    ...
                    if ((((itemj.firstByte & 0xf0) == 0x90) &&
                        ...
                        if (onclock_each_note[note] >= 0) {
                            ...
                            if (secondBasis) {
                                double time_clock_on = tempo.getSecFromClock(onclock_each_note[note]) +
                                    sec_at_premeasure + offsetSeconds;
                                ...
                                add_clock_on += ((importFromPremeasure
                                ? preMeasureClocks : 0) + offsetClocks);
                                add_clock_off += ((importFromPremeasure
                                ? preMeasureClocks : 0) + offsetClocks);
                            }
                            ...
                            if (mDialogMidiImportAndExport.isLyric()) {
                                for (int k = 0; k < events_count; k++) {
                                    ...
                                    if ((onclock_each_note[note] <= (int) itemk.clock) &&
                                            ((int) itemk.clock <= clock_off)) {
                                        if ((itemk.firstByte == 0xff) &&
                                                (itemk.data.length >= 2) &&
                                                (itemk.data[0] == 0x05)) {
                                            int[] d = new int[itemk.data.length -
                                                1];
                                            ...
                                            phrase = PortUtil.getDecodedString("Shift_JIS",
                                                    d, 0, itemk.data.length);
                            ...
                            if (AppManager.editorConfig.EnableAutoVibrato) {
                                ...
                                if (note_length >= threshold) {
                                    ...
                                    vid.VibratoHandle = AppManager.editorConfig.createAutoVibrato(SynthesizerType.VOCALOID2,
                                            vibrato_clocks);
                                    vid.VibratoDelay = note_length -
                                        vibrato_clocks;
                                }
                            }
                ...
                CadenciiCommand run_add = VsqFileEx.generateCommandAddTrack(work_track,
                        new VsqMixerEntry(0, 0, 0, 0), track, new BezierCurves());
    ...
    public void menuFileImportUst_Click(Object sender, BEventArgs e) {
        ...
        try {
            ...
            if (singer_id == null) {
                ...
                singer_id.IconHandle.IconID = "$0401" +
                    PortUtil.toHexString(0, 4);
            }
            ...
            for (int j = 1; j < vec.size(vsq.Track); j++) {
                ...
                for (int i = 0;
                        i < AppManager.editorConfig.getResamplerCount(); i++) {
                    String resampler = AppManager.editorConfig.getResamplerAt(i);
    ...
    public void menuFileImportVsq_Click(Object sender, BEventArgs e) {
        ...
        try {
            ...
            Logger.write(FormMain.class + ".menuFileImportVsq_Click; ex=" + ex +
                "\n");
            AppManager.showMessageBox(gettext("Invalid VSQ/VOCALOID MIDI file"),
                gettext("Error"),
                org.kbinani.windows.forms.Utility.MSGBOX_DEFAULT_OPTION,
                org.kbinani.windows.forms.Utility.MSGBOX_WARNING_MESSAGE);
        ...
        for (int track = 1; track < vsq.Track.size(); track++) {
            mDialogMidiImportAndExport.listTrack.addRow(new String[] {
                    track + "", vsq.Track.get(track).getName(),
        ...
        if (mDialogMidiImportAndExport.isTempo()) {
            shiftClockToMatchWith(replace, vsq,
                premeasure_sec_replace - premeasure_sec_vsq);
            // テンポテーブルを置き換え
            replace.TempoTable.clear();

            for (int i = 0; i < vsq.TempoTable.size(); i++) {
                replace.TempoTable.add((TempoTableEntry) vsq.TempoTable.get(i)
                                                                       .clone());
            }
        ...
        if (mDialogMidiImportAndExport.isTimesig()) {
            ...
            for (int i = 0; i < vsq.TimesigTable.size(); i++) {
                replace.TimesigTable.add((TimeSigTableEntry) vsq.TimesigTable.get(
                        i).clone());
            }
        ...
        for (Iterator<Integer> itr = add_track.iterator(); itr.hasNext();) {
            ...
            if (!mDialogMidiImportAndExport.isTempo()) {
                ...
                for (Iterator<VsqEvent> itr2 = vsq.Track.get(track)
                                                        .getEventIterator();
                        itr2.hasNext();) {
                    VsqEvent item = itr2.next();
                    ...
                    double sec_start = vsq.getSecFromClock(clock) -
                        premeasure_sec_vsq + premeasure_sec_replace;
                    double sec_end = vsq.getSecFromClock(clock +
                            item.ID.getLength()) - premeasure_sec_vsq +
                        premeasure_sec_replace;
                    ...
                    if (item.ID.VibratoHandle != null) {
                        double sec_vib_start = vsq.getSecFromClock(clock +
                                item.ID.VibratoDelay) - premeasure_sec_vsq +
                            premeasure_sec_replace;
                ...
                for (CurveType ct : Utility.CURVE_USAGE) {
                    ...
                    VsqBPList repl = new VsqBPList(item.getName(),
                            item.getDefault(), item.getMinimum(),
                            item.getMaximum());
                ...
                // ベジエカーブをシフト
                for (CurveType ct : Utility.CURVE_USAGE) {
                    Vector<BezierChain> list = vsq.AttachedCurves.get(track -
                            1).get(ct);
                    ...
                    for (Iterator<BezierChain> itr2 = list.iterator();
                            itr2.hasNext();) {
                        BezierChain chain = itr2.next();

                        for (Iterator<BezierPoint> itr3 = chain.points.iterator();
                                itr3.hasNext();) {
                            BezierPoint point = itr3.next();
                            PointD bse = new PointD(replace.getClockFromSec(vsq.getSecFromClock(
                                            point.getBase().getX()) -
                                        premeasure_sec_vsq +
                                        premeasure_sec_replace),
                                    point.getBase().getY());
                            PointD ctrl_r = new PointD(replace.getClockFromSec(vsq.getSecFromClock(
                                            point.controlLeft.getX()) -
                                        premeasure_sec_vsq +
                                        premeasure_sec_replace),
                                    point.controlLeft.getY());
                            PointD ctrl_l = new PointD(replace.getClockFromSec(vsq.getSecFromClock(
    ...
    public void menuSettingDefaultSingerStyle_Click(Object sender, BEventArgs e) {
        ...
        try {
                ...
                if (dlg.getApplyCurrentTrack()) {
                    ...
                    for (int i = 0; i < copy.getEventCount(); i++) {
                        if (copy.getEvent(i).ID.type == VsqIDType.Anote) {
                            AppManager.editorConfig.applyDefaultSingerStyle(copy.getEvent(
                                    i).ID);
                            changed = true;
                        }
                    }
                    ...
                    if (changed) {
                        CadenciiCommand run = VsqFileEx.generateCommandTrackReplace(selected,
                                copy, vsq.AttachedCurves.get(selected - 1));
                        AppManager.editHistory.register(vsq.executeCommand(run));
                        updateDrawObjectList();
                        refreshScreen();
                    }
            ...
            Logger.write(FormMain.class +
                ".menuSettingDefaultSingerStyle_Click; ex=" + ex + "\n");
        } finally {
            if (dlg != null) {
                try {
                    dlg.close();
                    ...
                    Logger.write(FormMain.class +
                        ".menuSettingDefaultSingerStyle_Click; ex=" + ex2 +
                        "\n");
                }
            }
        }
    ...
    public void menuSettingGameControlerSetting_Click(Object sender,
        BEventArgs e) {
        ...
        try {
            ...
            Logger.write(FormMain.class +
                ".menuSettingGrameControlerSetting_Click; ex=" + ex + "\n");
        } finally {
            if (dlg != null) {
                try {
                    dlg.close();
                    ...
                    Logger.write(FormMain.class +
                        ".menuSettingGameControlerSetting_Click; ex=" + ex2 +
                        "\n");
                }
            }
        }
    ...
    public void menuSettingPreference_Click(Object sender, BEventArgs e) {
        try {
            ...
            mDialogPreference.setBaseFont(new Font(
                    AppManager.editorConfig.BaseFontName, java.awt.Font.PLAIN,
                    AppManager.FONT_SIZE9));
            mDialogPreference.setScreenFont(new Font(
                    AppManager.editorConfig.ScreenFontName,
                    java.awt.Font.PLAIN, AppManager.FONT_SIZE9));
            ...
            mDialogPreference.setLocation(getFormPreferedLocation(
                    mDialogPreference));

            BDialogResult dr = AppManager.showModalDialog(mDialogPreference,
                    this);
            ...
            if (dr == BDialogResult.OK) {
                ...
                if (!old_super_font_name.equals(new_super_font.getName()) ||
                    ...
                    AppManager.editorConfig.BaseFontName = mDialogPreference.getBaseFont()
                                                                            .getName();
                    AppManager.editorConfig.BaseFontSize = mDialogPreference.getBaseFont()
                                                                            .getSize2D();
                    updateMenuFonts();
                }

                AppManager.editorConfig.ScreenFontName = mDialogPreference.getScreenFont()
                                                                          .getName();
                ...
                if (!Messaging.getLanguage()
                                  .equals(AppManager.editorConfig.Language)) {
                    Messaging.setLanguage(AppManager.editorConfig.Language);
                    applyLanguage();
                ...
                for (Iterator<SingerConfig> itr = mDialogPreference.getUtausingers()
                                                                   .iterator();
                        itr.hasNext();) {
                ...
                if (AppManager.editorConfig.UseProjectCache &&
                        !mDialogPreference.isUseProjectCache()) {
                    ...
                    if ((file != null) && !file.equals("")) {
                        String dir = PortUtil.getDirectoryName(file);
                        String name = PortUtil.getFileNameWithoutExtension(file);
                        String projectCacheDir = fsys.combine(dir,
                                name + ".cadencii");
                        String commonCacheDir = fsys.combine(AppManager.getCadenciiTempDir(),
                                AppManager.getID());
                        ...
                        if (fsys.isDirectoryExists(projectCacheDir)) {
                            ...
                            for (int i = 1; i < vsq.Track.size(); i++) {
                                // wavを移動
                                String wavFrom = fsys.combine(projectCacheDir,
                                        i + ".wav");
                                String wavTo = fsys.combine(commonCacheDir,
                                        i + ".wav");
                                ...
                                if (fsys.isFileExists(wavTo)) {
                                    try {
                                        ...
                                        Logger.write(FormMain.class +
                                            ".menuSettingPreference_Click; ex=" +
                                            ex + "\n");
                                        serr.println(
                                            "FormMain#menuSettingPreference_Click; ex=" +
                                            ex);
                                ...
                                // xmlを移動
                                String xmlFrom = fsys.combine(projectCacheDir,
                                        i + ".xml");
                                String xmlTo = fsys.combine(commonCacheDir,
                                        i + ".xml");
                ...
                if (!str.compare(old_wine_prefix,
                            AppManager.editorConfig.WinePrefix) ||
                        !str.compare(old_wine_top,
                            AppManager.editorConfig.getWineTop())) {
                    VSTiDllManager.restartVocaloidrvDaemon();
                }

                trackSelector.prepareSingerMenu(VsqFileEx.getTrackRendererKind(
                        AppManager.getVsqFile().Track.get(
                ...
                controller.setStartToDrawY(calculateStartToDrawY(
                        vScroll.getValue()));
            ...
            Logger.write(FormMain.class + ".menuSettingPreference_Click; ex=" +
                ex + "\n");
            AppManager.debugWriteLine(
                "FormMain#menuSettingPreference_Click; ex=" + ex);
            ex.printStackTrace();
        }
    }
    ...
    public void menuSettingShortcut_Click(Object sender, BEventArgs e) {
        ...
        for (Iterator<String> itr = configured.keySet().iterator();
                itr.hasNext();) {
            ...
            dict.put(parent + s1,
                new ValuePair<String, BKeys[]>(name, configured.get(name)));
        }
        ...
        dict.put(gettext("Go to the first"),
            new ValuePair<String, BKeys[]>("SpecialShortcutGoToFirst",
                keysGoToFirst));
        ...
        try {
            ...
            if (dr == BDialogResult.OK) {
                ...
                for (Iterator<String> itr = res.keySet().iterator();
                        itr.hasNext();) {
                    ...
                    if (name.equals("SpecialShortcutGoToFirst")) {
                        ...
                        for (int i = 0;
                                i < AppManager.editorConfig.ShortcutKeys.size();
                                i++) {
                            if (AppManager.editorConfig.ShortcutKeys.get(i).Key.equals(
                                        name)) {
                        ...
                        if (!found) {
                            AppManager.editorConfig.ShortcutKeys.add(new ValuePairOfStringArrayOfKeys(
                                    name, keys));
                        }
                    }
                }
            ...
            Logger.write(FormMain.class + ".menuSettingShortcut_Click; ex=" +
                ex + "\n");
        } finally {
            if (form != null) {
                try {
                    ...
                    Logger.write(FormMain.class +
                        ".menuSettingSHortcut_Click; ex=" + ex2 + "\n");
                }
            }
        }
    }
    ...
    public void menuSettingVibratoPreset_Click(Object sender, BEventArgs e) {
        ...
        try {
            ...
            Logger.write(FormMain.class +
                ".menuSettingVibratoPreset_Click; ex=" + ex + "\n");
        } finally {
            if (dialog != null) {
                try {
                } catch (Exception ex2) {
    ...
    public void menuLyric_DropDownOpening(Object sender, BEventArgs e) {
        ...
        SelectedEventEntry item = AppManager.itemSelection.getEventIterator()
                                                          .next();
    ...
    public void menuLyricPhonemeTransformation_Click(Object sender, BEventArgs e) {
        ...
        CadenciiCommand run = new CadenciiCommand(VsqCommand.generateCommandEventChangeIDContaintsRange(
                    selected,
                    PortUtil.convertIntArray(internal_ids.toArray(
                            new Integer[] {  })), ids.toArray(new VsqID[] {  })));
        AppManager.editHistory.register(vsq.executeCommand(run));
        setEdited(true);
    }
    ...
    public void menuLyricApplyUtauParameters_Click(Object sender, BEventArgs e) {
        ...
        // コマンドを発行
        CadenciiCommand run = new CadenciiCommand(VsqCommand.generateCommandEventReplaceRange(
                    selected, replace.toArray(new VsqEvent[] {  })));
        // コマンドを実行
        AppManager.editHistory.register(vsq.executeCommand(run));
        setEdited(true);
    }
    ...
    public void menuLyricDictionary_Click(Object sender, BEventArgs e) {
        ...
        try {
            ...
            Logger.write(FormMain.class + ".menuLyricDictionary_Click; ex=" +
                ex + "\n");
            ...
            if (dlg != null) {
                try {
                    ...
                    Logger.write(FormMain.class +
                        ".menuLyricDictionary_Click; ex=" + ex2 + "\n");
                }
            }
        }
    }
    ...
    public void menuJob_DropDownOpening(Object sender, BEventArgs e) {
        if (AppManager.itemSelection.getEventCount() <= 1) {
            ...
            for (int i = 0;
                    i < AppManager.getVsqFile().Track.get(
                        AppManager.getSelected()).getEventCount(); i++) {
                int count = -1;
                ...
                for (Iterator<SelectedEventEntry> itr = AppManager.itemSelection.getEventIterator();
                    ...
                    if (key == AppManager.getVsqFile().Track.get(
                                AppManager.getSelected()).getEvent(i).InternalID) {
                        list[count] = i;
    ...
    public void menuJobConnect_Click(Object sender, BEventArgs e) {
        ...
        CadenciiCommand run = new CadenciiCommand(VsqCommand.generateCommandEventChangeIDContaintsRange(
                    AppManager.getSelected(), internalids, ids));
        AppManager.editHistory.register(AppManager.getVsqFile()
                                                  .executeCommand(run));
        setEdited(true);
        repaint();
    ...
    public void menuJobInsertBar_Click(Object sender, BEventArgs e) {
        ...
        int total_barcount = AppManager.getVsqFile()
                                       .getBarCountFromClock(total_clock) + 1;
        ...
        try {
            ...
            int barcount = AppManager.getVsqFile()
                                     .getBarCountFromClock(current_clock);
            ...
            if (dr == BDialogResult.OK) {
                int pos = (dlg.getPosition() +
                    AppManager.getVsqFile().getPreMeasure()) - 1;
                int length = dlg.getLength();

                int clock_start = AppManager.getVsqFile()
                                            .getClockFromBarCount(pos);
                int clock_end = AppManager.getVsqFile()
                                          .getClockFromBarCount(pos + length);
                ...
                for (int track = 1; track < temp.Track.size(); track++) {
                    ...
                    for (CurveType ct : Utility.CURVE_USAGE) {
                        ...
                        for (Iterator<BezierChain> itr = temp.AttachedCurves.get(track -
                                    1).get(ct).iterator(); itr.hasNext();) {
                            BezierChain bc = itr.next();
                            ...
                            int chain_start = (int) bc.points.get(0).getBase()
                                                             .getX();
                            int chain_end = (int) bc.points.get(bc.points.size() -
                                    1).getBase().getX();
                            ...
                            if (clock_start <= chain_start) {
                                for (int i = 0; i < bc.points.size(); i++) {
                                    ...
                                    bc.points.get(i)
                                             .setBase(new PointD(t.getX() +
                                            dclock, t.getY()));
                                }

                                list.add(bc);
                            } else if ((chain_start < clock_start) &&
                                    (clock_start < chain_end)) {
                                BezierChain adding1 = bc.extractPartialBezier(chain_start,
                                        clock_start);
                                BezierChain adding2 = bc.extractPartialBezier(clock_start,
                                        chain_end);

                                for (int i = 0; i < adding2.points.size();
                                        i++) {
                                    PointD t = adding2.points.get(i).getBase();
                                    adding2.points.get(i)
                                                  .setBase(new PointD(t.getX() +
                                            dclock, t.getY()));
                                }

                                adding1.points.get(adding1.points.size() - 1)
                                              .setControlRightType(BezierControlType.None);
                                adding2.points.get(0)
                ...
                for (int track = 1;
                        track < AppManager.getVsqFile().Track.size();
                        track++) {
                    for (int i = 0; i < temp.Track.get(track).getEventCount();
                            i++) {
                    ...
                    for (CurveType curve : Utility.CURVE_USAGE) {
                        ...
                        VsqBPList target = temp.Track.get(track)
                                                     .getCurve(curve.getName());
                        VsqBPList src = AppManager.getVsqFile().Track.get(track)
                                                                     .getCurve(curve.getName());
                        target.clear();

                        for (Iterator<Integer> itr = src.keyClockIterator();
                                itr.hasNext();) {
                            int key = itr.next();
                ...
                for (int i = 0; i < temp.TempoTable.size(); i++) {
                    if (temp.TempoTable.get(i).Clock >= clock_start) {
                        temp.TempoTable.get(i).Clock = temp.TempoTable.get(i).Clock +
                            dclock;
                    }
                }
                ...
                for (int i = 0; i < temp.TimesigTable.size(); i++) {
                    if (temp.TimesigTable.get(i).Clock >= clock_start) {
                        temp.TimesigTable.get(i).Clock = temp.TimesigTable.get(i).Clock +
                            dclock;
                    }
                }
        ...
        try {
            ...
            if (ret == BDialogResult.OK) {
                ...
                if (old_pre_measure != result) {
                    CadenciiCommand run = new CadenciiCommand(VsqCommand.generateCommandChangePreMeasure(
                                result));
                    AppManager.editHistory.register(AppManager.getVsqFile()
                                                              .executeCommand(run));
                    AppManager.getVsqFile().updateTotalClocks();
    ...
    public void menuSettingSequence_Click(Object sender, BEventArgs e) {
        ...
        CadenciiCommand run = VsqFileEx.generateCommandChangeSequenceConfig(new_sample_rate,
                new_channels, new_output_master, new_pre_measure);
        AppManager.editHistory.register(vsq.executeCommand(run));
        setEdited(true);
    }
                ...
                for (int track = 1; track < temp.Track.size(); track++) {
                    ...
                    for (int j = 0; j < Utility.CURVE_USAGE.length; j++) {
                        ...
                        for (Iterator<BezierChain> itr = temp.AttachedCurves.get(track -
                            ...
                            if ((clock_start < chain_start) &&
                                    (chain_start < clock_end) &&
                                    (clock_end < chain_end)) {
                                BezierChain adding = bc.extractPartialBezier(clock_end,
                                        chain_end);
                                adding.id = bc.id;

                                for (int i = 0; i < adding.points.size();
                                        i++) {
                                ...
                                BezierChain adding2 = bc.extractPartialBezier(clock_end,
                                        chain_end);
                                adding2.points.get(0)
                                              .setControlLeftType(BezierControlType.None);
                                ...
                                for (int i = 1; i < adding2.points.size();
                                        i++) {
                                ...
                                list.add(adding1);
                                    ...
                                    (clock_start < chain_end) &&
                                    (chain_end < clock_end)) {
                                BezierChain adding = bc.extractPartialBezier(chain_start,
                                        clock_start);
                                adding.id = bc.id;
                                list.add(adding);
                            } else if ((clock_end <= chain_start) ||
                                    (chain_end <= clock_start)) {
                                if (clock_end <= chain_start) {
                                    for (int i = 0; i < bc.points.size();
                                            i++) {
                                        PointD t = bc.points.get(i).getBase();
                                        bc.points.get(i)
                                                 .setBase(new PointD(t.getX() -
    ...
    public void menuJobNormalize_Click(Object sender, BEventArgs e) {
        ...
        while (changed) {
            ...
            for (int i = 0; i < (work.Track.get(track).getEventCount() - 1);
                    i++) {
                int clock = work.Track.get(track).getEvent(i).Clock;
                int id = work.Track.get(track).getEvent(i).InternalID;

                for (int j = i + 1; j < work.Track.get(track).getEventCount();
                        j++) {
        ...
        while (changed) {
            ...
            for (int i = 0; i < (work.Track.get(track).getEventCount() - 1);
                ...
                int end_clock = work.Track.get(track).getEvent(i).ID.getLength() +
                    start_clock;
                ...
                for (int j = i + 1; j < work.Track.get(track).getEventCount();
                    ...
                    if (this_start_clock < end_clock) {
                        work.Track.get(track).getEvent(i).ID.setLength(this_start_clock -
                            start_clock);
                        changed = true;
                        total_changed = true;
                    }
        ...
        if (total_changed) {
            CadenciiCommand run = new CadenciiCommand(VsqCommand.generateCommandReplace(
                        work));
            AppManager.editHistory.register(AppManager.getVsqFile()
                                                      .executeCommand(run));
            setEdited(true);
    ...
    public void menuJobRandomize_Click(Object sender, BEventArgs e) {
        ...
        try {
            ...
            if (dr == BDialogResult.OK) {
                ...
                int startClock = startBarClock +
                    ((startBeat * 480 * 4) / startTimesig.denominator);
                int endClock = endBarClock +
                    ((endBeat * 480 * 4) / endTimesig.denominator);
                ...
                if (dlg.isPositionRandomizeEnabled()) {
                    ...
                    int sigma = sigmaPreset[dlg.getPositionRandomizeValue() -
                        1]; // 標準偏差
                    ...
                    while (true) {
                        ...
                        if (thisItemIndex >= 0) {
                            // ここにメインの処理
                            VsqEvent lastItem = (lastItemIndex >= 0)
                                ? work.getEvent(lastItemIndex) : null;
                            VsqEvent thisItem = work.getEvent(thisItemIndex);
                            VsqEvent nextItem = (nextItemIndex >= 0)
                                ? work.getEvent(nextItemIndex) : null;
                            int lastItemClock = (lastItem == null) ? 0
                                                                   : lastItem.Clock;
                            int lastItemLength = (lastItem == null) ? 0
                                                                    : lastItem.ID.getLength();

                            int clock = thisItem.Clock;
                            int length = thisItem.ID.getLength();

                            if ((startClock <= thisItem.Clock) &&
                                    ((thisItem.Clock + thisItem.ID.getLength()) <= endClock)) {
                                int draftClock = 0;
                                int draftLength = 0;
                                ...
                                while (true) {
                                    ...
                                    draftClock = clock + x;
                                    draftLength = (clock + length) -
                                        draftClock;

                                    if (lastItem != null) {
                                        if (clock == (lastItemClock +
                                                lastItemLength)) {
                                            // 音符が連続していた場合
                                            draftLastItemLength = lastItem.ID.getLength() +
                                                x;
                                        }
                                    }
                                    ...
                                    if (lastItem != null) {
                                        if (clock != (lastItemClock +
                                            ...
                                            if ((draftClock + draftLength) < (lastItem.Clock +
                                                    lastItem.ID.getLength())) {
                                                continue;
                                            }
                                        }
                        ...
                        if ((lastItemIndex == -2) && (thisItemIndex == -2) &&
                                (nextItemIndex == -2)) {
                ...
                if (dlg.isPitRandomizeEnabled()) {
                    ...
                    int[] patternPreset = (pattern == 1)
                        ? Utility.getRandomizePitPattern1()
                        : ((pattern == 2) ? Utility.getRandomizePitPattern2()
                                          : Utility.getRandomizePitPattern3());
                    ...
                    for (int clock = startClock; clock < endClock;
                            clock += resolution) {
    ...
    public void waveView_MouseDoubleClick(Object sender, BMouseEventArgs e) {
        if (e.Button == BMouseButtons.Middle) {
            // ツールをポインター <--> 鉛筆に切り替える
            if (e.Y < (trackSelector.getHeight() -
                    (TrackSelector.OFFSET_TRACK_TAB * 2))) {
                if (AppManager.getSelectedTool() == EditTool.ARROW) {
                    AppManager.setSelectedTool(EditTool.PENCIL);
                } else {
                    AppManager.setSelectedTool(EditTool.ARROW);
    ...
    public void picturePositionIndicator_MouseWheel(Object sender,
        BMouseEventArgs e) {
        hScroll.setValue(computeScrollValueFromWheelDelta(e.Delta));
    }

    public void picturePositionIndicator_MouseClick(Object sender,
        BMouseEventArgs e) {
        if ((e.Button == BMouseButtons.Right) && (0 < e.Y) && (e.Y <= 18) &&
                (AppManager.keyWidth < e.X)) {
            // クリックされた位置でのクロックを保存
            int clock = AppManager.clockFromXCoord(e.X);
            int unit = AppManager.getPositionQuantizeClock();
    ...
    public void picturePositionIndicator_MouseDoubleClick(Object sender,
        BMouseEventArgs e) {
            ...
            if ((18 < e.Y) && (e.Y <= 32)) {
                ...
                if (AppManager.itemSelection.getTempoCount() > 0) {
                    ...
                    if (index >= 0) {
                        if (AppManager.getSelectedTool() == EditTool.ERASER) {
                            if (vsq.TempoTable.get(index).Clock == 0) {
                                String msg = gettext(
                                        "Cannot remove first symbol of track!");
                                statusLabel.setText(msg);

                                return;
                            }

                            CadenciiCommand run = new CadenciiCommand(VsqCommand.generateCommandUpdateTempo(
                                        vsq.TempoTable.get(index).Clock,
                                        vsq.TempoTable.get(index).Clock, -1));
                            AppManager.editHistory.register(vsq.executeCommand(
                                    run));
                            setEdited(true);
                        } else {
                            ...
                            int beat_in_bar = (clocks_in_bar / clock_per_beat) +
                                1;
                            int clocks_in_beat = clocks_in_bar -
                                ((beat_in_bar - 1) * clock_per_beat);
                            FormTempoConfig dlg = null;

                            try {
                                dlg = new FormTempoConfig(bar_count,
                                        beat_in_bar, timesig.numerator,
                                        clocks_in_beat, clock_per_beat,
                                        (float) (6e7 / tte.Tempo),
                                ...
                                if (dr == BDialogResult.OK) {
                                    ...
                                    int new_clock = bar_top_clock +
                                        ((new_beat - 1) * clock_per_beat) +
                                        new_clocks_in_beat;
                                    CadenciiCommand run = new CadenciiCommand(VsqCommand.generateCommandUpdateTempo(
                                                new_clock, new_clock,
                                                (int) (6e7 / (double) dlg.getTempo())));
                                    AppManager.editHistory.register(vsq.executeCommand(
                                            run));
                                    setEdited(true);
                                    refreshScreen();
                                ...
                                Logger.write(FormMain.class +
                                    ".picturePositionIndicator_MouseDoubleClick; ex=" +
                                    ex + "\n");
                                serr.println(
                                    "FormMain#picturePositionIndicator_MouseDoubleClick; ex=" +
                                    ex);
                            } finally {
                                if (dlg != null) {
                                    try {
                                        ...
                                        Logger.write(FormMain.class +
                                            ...
                                            ex2 + "\n");
                                        serr.println(
                                            "FormMain#picturePositionIndicator_MouseDoubleClick; ex2=" +
                                            ex2);
                                    }
                                }
                            }
                    ...
                    if ((selected == EditTool.PENCIL) ||
                        ...
                        if (index2 >= 1) {
                            local_denominator = vsq.TimesigTable.get(index2 -
                                    1).Denominator;
                        ...
                        try {
                            dlg = new FormTempoConfig(bar_count -
                                    vsq.getPreMeasure() + 1, beat_in_bar,
                                    local_numerator, clocks_in_beat,
                                    clock_per_beat,
                ...
                mPositionIndicatorMouseDownMode = PositionIndicatorMouseDownMode.NONE;
                    ...
                    (e.Y <= (picturePositionIndicator.getHeight() - 1))) {
                AppManager.itemSelection.clearEvent();
                AppManager.itemSelection.clearTempo();
                ...
                if (AppManager.itemSelection.getTimesigCount() > 0) {
                    ...
                    if (AppManager.getSelectedTool() == EditTool.ERASER) {
                        ...
                        CadenciiCommand run = new CadenciiCommand(VsqCommand.generateCommandUpdateTimesig(
                        ...
                        try {
                            dlg = new FormBeatConfigController(bar_count -
                                    pre_measure + 1, timesig.numerator,
                                    timesig.denominator, num_enabled,
                                    pre_measure);

                            Point p = getFormPreferedLocation(dlg.getWidth(),
                                    dlg.getHeight());
                            dlg.setLocation(p.x, p.y);

                            int dr = AppManager.showModalDialog(dlg.getUi(),
                                    this);
                            ...
                            if (dr == 1) {
                                if (dlg.isEndSpecified()) {
                                    ...
                                    new_barcounts[0] = (dlg.getStart() +
                                        pre_measure) - 1;
                                    new_barcounts[1] = (dlg.getEnd() +
                                        pre_measure) - 1;
                                    ...
                                    barcounts[1] = (dlg.getEnd() + pre_measure) -
                                        1;

                                    CadenciiCommand run = new CadenciiCommand(VsqCommand.generateCommandUpdateTimesigRange(
                                                barcounts, new_barcounts,
                            ...
                            if (dlg != null) {
                                try {
                                    ...
                                    Logger.write(FormMain.class +
                                        ...
                                        ex2 + "\n");
                                    serr.println(
                                        "FormMain#picturePositionIndicator_MouseDoubleClic; ex2=" +
                                        ex2);
                                }
                            }
                        }
                    ...
                    if ((selected == EditTool.PENCIL) ||
                        ...
                        int clock = AppManager.clockFromXCoord(e.X);
                        int bar_count = AppManager.getVsqFile()
                                                  .getBarCountFromClock(clock);
                        int numerator;
                        int denominator;
                        Timesig timesig = AppManager.getVsqFile()
                                                    .getTimesigAt(clock);
                        int total_clock = AppManager.getVsqFile().TotalClocks;
                        ...
                        try {
                            dlg = new FormBeatConfigController(bar_count -
                                    pre_measure + 1, timesig.numerator,
                                    timesig.denominator, true, pre_measure);
                            ...
                            Logger.write(FormMain.class +
                                ".picutrePositionIndicator_MouseDoubleClick; ex=" +
                                ex + "\n");
                        } finally {
                            if (dlg != null) {
                                try {
    ...
    public void picturePositionIndicator_MouseDown(Object sender,
        BMouseEventArgs e) {
        if ((e.X < AppManager.keyWidth) || ((getWidth() - 3) < e.X)) {
            return;
        }
        ...
        if (e.Button == BMouseButtons.Left) {
            if ((0 <= e.Y) && (e.Y <= 18)) {
                ...
                int start_marker_width = Resources.get_start_marker()
                                                  .getWidth(this);
                ...
                for (int i = 0; i < count; i++) {
                    ...
                    String s = PortUtil.formatDecimal("#.00",
                            60e6 / (float) AppManager.getVsqFile().TempoTable.get(
                                i).Tempo);
                    Dimension size = Util.measureString(s,
                            new Font(AppManager.editorConfig.ScreenFontName,
                                java.awt.Font.PLAIN, AppManager.FONT_SIZE8));

                    if (Utility.isInRect(new Point(e.X, e.Y),
                                new Rectangle(x, 14, (int) size.width, 14))) {
                        index = i;
                ...
                if (index >= 0) {
                    ...
                    if ((modifiers & InputEvent.SHIFT_MASK) == InputEvent.SHIFT_MASK) {
                        if (AppManager.itemSelection.getTempoCount() > 0) {
                            ...
                            for (int i = 0;
                                    i < AppManager.getVsqFile().TempoTable.size();
                                    i++) {
                ...
                for (int i = 0;
                        i < AppManager.getVsqFile().TimesigTable.size(); i++) {
                    String s = AppManager.getVsqFile().TimesigTable.get(i).Numerator +
                        "/" +
                        AppManager.getVsqFile().TimesigTable.get(i).Denominator;
                    int x = AppManager.xCoordFromClocks(AppManager.getVsqFile().TimesigTable.get(
                                i).Clock);
                    Dimension size = Util.measureString(s,
                            new Font(AppManager.editorConfig.ScreenFontName,
                                java.awt.Font.PLAIN, AppManager.FONT_SIZE8));
                    ...
                    if (Utility.isInRect(new Point(e.X, e.Y),
                                new Rectangle(x, 28, (int) size.width, 14))) {
                        index = i;
                ...
                if (index >= 0) {
                    ...
                    if (AppManager.getSelectedTool() != EditTool.ERASER) {
                        int barcount_clock = AppManager.getVsqFile()
                                                       .getClockFromBarCount(barcount);
                        int mouse_clock = AppManager.clockFromXCoord(e.X);
                        mTimesigDraggingDeltaClock = mouse_clock -
                            barcount_clock;
                    ...
                    if ((modifiers & InputEvent.SHIFT_MASK) == InputEvent.SHIFT_MASK) {
                        if (AppManager.itemSelection.getTimesigCount() > 0) {
                            ...
                            for (int i = 0;
                                    i < AppManager.getVsqFile().TimesigTable.size();
                                    i++) {
                                ...
                                if ((start <= tbarcount) && (tbarcount <= end)) {
                                    AppManager.itemSelection.addTimesig(AppManager.getVsqFile().TimesigTable.get(
                                            i).BarCount);
                                }
                            }
                        } else {
                        ...
                        if (!AppManager.itemSelection.isTimesigContains(
                                    barcount)) {
                            AppManager.itemSelection.clearTimesig();
                        }
    ...
    public void picturePositionIndicator_MouseUp(Object sender,
        BMouseEventArgs e) {
        int modifiers = PortUtil.getCurrentModifierKey();
            ...
            if (mPositionIndicatorMouseDownMode == PositionIndicatorMouseDownMode.NONE) {
                if ((4 <= e.Y) && (e.Y <= 18)) {
                    ...
                    if (AppManager.itemSelection.getTempoCount() > 0) {
                        ...
                        if ((index >= 0) &&
                                (AppManager.getSelectedTool() == EditTool.ERASER)) {
                            if (vsq.TempoTable.get(index).Clock == 0) {
                                String msg = gettext(
                                        "Cannot remove first symbol of track!");
                                statusLabel.setText(msg);
                ...
                if (contains_first_bar) {
                    ...
                    CadenciiCommand run = new CadenciiCommand(VsqCommand.generateCommandUpdateTimesigRange(
                                barcounts, new_barcounts, numerators,
                                denominators));
                    AppManager.editHistory.register(vsq.executeCommand(run));
                    setEdited(true);
                }
    ...
    public void picturePositionIndicator_MouseMove(Object sender,
        BMouseEventArgs e) {
        VsqFileEx vsq = AppManager.getVsqFile();

        if (mPositionIndicatorMouseDownMode == PositionIndicatorMouseDownMode.TEMPO) {
            int clock = AppManager.clockFromXCoord(e.X) -
                mTempoDraggingDeltaClock;
            ...
            for (Iterator<ValuePair<Integer, SelectedTempoEntry>> itr = AppManager.itemSelection.getTempoIterator();
                ...
                ValuePair<Integer, SelectedTempoEntry> item = itr.next();
                int key = item.getKey();
                AppManager.itemSelection.getTempo(key).editing.Clock = AppManager.itemSelection.getTempo(key).original.Clock +
                    dclock;
            }
            ...
            for (Iterator<ValuePair<Integer, SelectedTimesigEntry>> itr = AppManager.itemSelection.getTimesigIterator();
                ...
                ValuePair<Integer, SelectedTimesigEntry> item = itr.next();
                int bar = item.getKey();
                AppManager.itemSelection.getTimesig(bar).editing.BarCount = AppManager.itemSelection.getTimesig(bar).original.BarCount +
                    dbarcount;
            }
    ...
    public void picturePositionIndicator_PreviewKeyDown(Object sender,
        BPreviewKeyDownEventArgs e) {
        BKeyEventArgs e0 = new BKeyEventArgs(e.getRawEvent());
        processSpecialShortcutKey(e0, true);
    }
    ...
    public void menuHelpManual_Click(Object sender, BEventArgs e) {
        ...
        String pdf = fsys.combine(PortUtil.getApplicationStartupPath(),
                "manual_" + lang + ".pdf");

        if (!fsys.isFileExists(pdf)) {
            // 無ければ英語版のマニュアルを表示することにする
            pdf = fsys.combine(PortUtil.getApplicationStartupPath(),
                    "manual_en.pdf");
        }

        if (!fsys.isFileExists(pdf)) {
            AppManager.showMessageBox(gettext("file not found"), _APP_NAME,
                org.kbinani.windows.forms.Utility.MSGBOX_DEFAULT_OPTION,
                org.kbinani.windows.forms.Utility.MSGBOX_WARNING_MESSAGE);
    ...
    public void menuHelpLogOpen_Click(Object sender, BEventArgs e) {
        ...
        if ((file == null) || ((file != null) && (!fsys.isFileExists(file)))) {
            // ログがまだできてないのでダイアログ出す
            AppManager.showMessageBox(gettext("Log file has not generated yet."),
                gettext("Info"), PortUtil.OK_OPTION,
                org.kbinani.windows.forms.Utility.MSGBOX_INFORMATION_MESSAGE);
    ...
    public void trackSelector_MouseClick(Object sender, BMouseEventArgs e) {
        if (e.Button == BMouseButtons.Right) {
            if ((AppManager.keyWidth < e.X) &&
                    (e.X < trackSelector.getWidth())) {
                if (((trackSelector.getHeight() -
                        TrackSelector.OFFSET_TRACK_TAB) <= e.Y) &&
                        (e.Y <= trackSelector.getHeight())) {
    ...
    public void trackSelector_MouseMove(Object sender, BMouseEventArgs e) {
        ...
        if (mEditCurveMode == CurveEditMode.MIDDLE_DRAG) {
            ...
            if (mExtDragXTrackSelector != ExtDragXMode.NONE) {
                ...
                double d_draft = hScroll.getValue() +
                    (px_move * controller.getScaleXInv());
    ...
    public void trackSelector_PreferredMinHeightChanged(Object sender,
        BEventArgs e) {
        if (menuVisualControlTrack.isSelected()) {
            splitContainer1.setPanel2MinSize(trackSelector.getPreferredMinSize());
        }
    ...
    public void trackSelector_PreviewKeyDown(Object sender,
        BPreviewKeyDownEventArgs e) {
        BKeyEventArgs e0 = new BKeyEventArgs(e.getRawEvent());
        processSpecialShortcutKey(e0, true);
    }
    ...
    public void cMenuPianoExpression_Click(Object sender, BEventArgs e) {
        if (AppManager.itemSelection.getEventCount() > 0) {
            ...
            try {
                ...
                Logger.write(FormMain.class +
                    ".cMenuPianoExpression_Click; ex=" + ex + "\n");
            } finally {
                if (dlg != null) {
                    try {
                        dlg.close();
                        ...
                        Logger.write(FormMain.class +
                            ".cMenuPianoExpression_Click; ex=" + ex2 + "\n");
                    }
                }
            }
        }
    ...
    //BOOKMARK: menuHidden
    public void menuHiddenVisualForwardParameter_Click(Object sender,
        BEventArgs e) {
        trackSelector.SelectNextCurve();
    }

    public void menuHiddenVisualBackwardParameter_Click(Object sender,
        BEventArgs e) {
        trackSelector.SelectPreviousCurve();
    }

    public void menuHiddenTrackNext_Click(Object sender, BEventArgs e) {
        if (AppManager.getSelected() == (AppManager.getVsqFile().Track.size() -
                1)) {
            AppManager.setSelected(1);
        } else {
    ...
    public void menuHiddenFlipCurveOnPianorollMode_Click(Object sender,
        BEventArgs e) {
    ...
    public void menuHiddenEditFlipToolPointerPencil_Click(Object sender,
        BEventArgs e) {
        if (AppManager.getSelectedTool() == EditTool.ARROW) {
            AppManager.setSelectedTool(EditTool.PENCIL);
        } else {
    ...
    public void menuHiddenEditFlipToolPointerEraser_Click(Object sender,
        BEventArgs e) {
        if (AppManager.getSelectedTool() == EditTool.ARROW) {
            AppManager.setSelectedTool(EditTool.ERASER);
        } else {
    ...
    public void menuHiddenEditLyric_Click(Object sender, BEventArgs e) {
        ...
        if (!input_enabled && (AppManager.itemSelection.getEventCount() > 0)) {
            ...
            Point pos = new Point(AppManager.xCoordFromClocks(clock),
                    AppManager.yCoordFromNote(note));
            ...
            showInputTextBox(original.ID.LyricHandle.L0.Phrase,
                original.ID.LyricHandle.L0.getPhoneticSymbol(), pos,
                mLastSymbolEditMode);
            refreshScreen();
    ...
    public void cMenuTrackTabRenderer_DropDownOpening(Object sender,
        BEventArgs e) {
        updateRendererMenu();
    }

    public void cMenuPositionIndicatorStartMarker_Click(Object sender,
        BEventArgs e) {
    ...
    public void cMenuPositionIndicatorEndMarker_Click(Object sender,
        BEventArgs e) {
        int clock = mPositionIndicatorPopupShownClock;
        VsqFileEx vsq = AppManager.getVsqFile();
    ...
    public void cMenuTrackSelectorDeleteBezier_Click(Object sender, BEventArgs e) {
        for (Iterator<SelectedBezierPoint> itr = AppManager.itemSelection.getBezierIterator();
                itr.hasNext();) {
            ...
            VsqFileEx vsq = AppManager.getVsqFile();
            int selected = AppManager.getSelected();
            BezierChain chain = (BezierChain) vsq.AttachedCurves.get(selected -
                    1).getBezierChain(trackSelector.getSelectedCurve(), chain_id)
                                                                .clone();
            int index = -1;
            ...
            if (index >= 0) {
                ...
                if (chain.points.size() == 0) {
                    CadenciiCommand run = VsqFileEx.generateCommandDeleteBezierChain(selected,
                            trackSelector.getSelectedCurve(), chain_id,
                    ...
                    CadenciiCommand run = VsqFileEx.generateCommandReplaceBezierChain(selected,
                            trackSelector.getSelectedCurve(), chain_id, chain,
                            AppManager.editorConfig.getControlCurveResolutionValue());
                    AppManager.editHistory.register(vsq.executeCommand(run));
                }
    ...
    public void pictKeyLengthSplitter_MouseMove(Object sender, BMouseEventArgs e) {
        ...
        int dx = PortUtil.getMousePosition().x -
            mKeyLengthSplitterInitialMouse.x;
        ...
        if (current >= mKeyLengthTrackSelectorRowsPerColumn) {
            int max_divider_location = splitContainer1.getHeight() -
                splitContainer1.getDividerSize() -
    ...
    public void handleStripPaletteTool_Click(Object sender, BEventArgs e) {
        ...
        for (int i = 0; i < sub_cmenu_track_selectro_palette_tool.length;
                i++) {
    ...
    public void handleTrackOn_Click(Object sender, BEventArgs e) {
        ...
        CadenciiCommand run = new CadenciiCommand(VsqCommand.generateCommandTrackChangePlayMode(
                    selected, new_status ? last_play_mode : PlayMode.Off,
                    last_play_mode));
        AppManager.editHistory.register(AppManager.getVsqFile()
                                                  .executeCommand(run));
    ...
    public void handleEditorConfig_QuantizeModeChanged(Object sender,
        BEventArgs e) {
        applyQuantizeMode();
    }
    ...
    public void handleFileSave_Click(Object sender, BEventArgs e) {
        ...
        if (file.equals("")) {
            String last_file = AppManager.editorConfig.getLastUsedPathOut(
                    "xvsq");
    ...
    public void handleFileOpen_Click(Object sender, BEventArgs e) {
        ...
        int dialog_result = AppManager.showModalDialog(openXmlVsqDialog, true,
                this);
        ...
        if (openVsqCor(file)) {
            AppManager.showMessageBox(gettext("Invalid XVSQ file"),
                gettext("Error"),
                org.kbinani.windows.forms.Utility.MSGBOX_DEFAULT_OPTION,
                org.kbinani.windows.forms.Utility.MSGBOX_WARNING_MESSAGE);
    ...
    public void handleFileNew_Click(Object sender, BEventArgs e) {
        ...
        VsqFileEx vsq = new VsqFileEx(AppManager.editorConfig.DefaultSingerName,
                1, 4, 4, 500000);
        ...
        AppManager.setTempWaveDir(fsys.combine(
                AppManager.getCadenciiTempDir(), AppManager.getID()));
    ...
    public void handleMenuMouseEnter(Object sender, BEventArgs e) {
        ...
        if (sender == menuEditUndo) {
            ...
            text = gettext(
                    "Select all items and control curves of current track.");
            ...
            text = gettext(
                    "Open configuration dialog for phonetic symnol dictionaries");
        } else if (sender == menuLyricCopyVibratoToPreset) {
            text = gettext(
                    "Copy vibrato config of selected item into vibrato preset");
        } else if (sender == menuScriptUpdate) {
            text = gettext(
                    "Read and compile all scripts and update the list of them");
    ...
    public void handleChangeRenderer(Object sender, BEventArgs e) {
        ...
        if ((sender == cMenuTrackTabRendererAquesTone) ||
                (sender == menuTrackRendererAquesTone)) {
        ...
        } else if ((sender == cMenuTrackTabRendererVOCALOID2) ||
                (sender == menuTrackRendererVOCALOID2)) {
        ...
        if (changed) {
            ...
            if (singers == null) {
                serr.println(
                    "FormMain#changeRendererCor; singers instanceof null");
            ...
            CadenciiCommand run = VsqFileEx.generateCommandTrackReplace(selected,
                    item, vsq.AttachedCurves.get(selected - 1));
            AppManager.editHistory.register(vsq.executeCommand(run));
            ...
            for (int i = 0; i < menuTrackRendererUtau.getComponentCount();
                    i++) {
    ...
    public void handleBgmOffsetSeconds_Click(Object sender, BEventArgs e) {
        ...
        try {
            ...
            try {
                ...
                Logger.write(FormMain.class +
                    ".handleBgmOffsetSeconds_Click; ex=" + ex3 + "\n");
            }
            ...
            Logger.write(FormMain.class + ".handleBgmOffsetSeconds_Click; ex=" +
                ex + "\n");
        } finally {
            if (ib != null) {
                try {
                    ...
                    Logger.write(FormMain.class +
                        ".handleBgmOffsetSeconds_Click; ex=" + ex2 + "\n");
                }
            }
        }
    }

    public void handleBgmStartAfterPremeasure_CheckedChanged(Object sender,
        BEventArgs e) {
        if (!(sender instanceof BgmMenuItem)) {
            return;
        }
    ...
    public void handleBgmAdd_Click(Object sender, BEventArgs e) {
        ...
        if (found) {
            AppManager.showMessageBox(PortUtil.formatMessage(gettext(
                        "file '{0}' instanceof already registered as BGM."),
                    file), gettext("Error"),
                org.kbinani.windows.forms.Utility.MSGBOX_DEFAULT_OPTION,
                org.kbinani.windows.forms.Utility.MSGBOX_WARNING_MESSAGE);
    ...
    public void mMidiIn_MidiReceived(Object sender,
        ...
        if (code == 0x80) {
            ...
            if (AppManager.mAddingEvent.ID.LyricHandle == null) {
                AppManager.mAddingEvent.ID.LyricHandle = new LyricHandle("a",
                        "a");
            }
            ...
            // 音符の長さを計算
            int length = QuantizeModeUtil.getQuantizeClock(AppManager.editorConfig.getLengthQuantize(),
                    AppManager.editorConfig.isLengthQuantizeTriplet());

            // 音符の長さを設定
            Utility.editLengthOfVsqEvent(AppManager.mAddingEvent, length,
                AppManager.vibratoLengthEditingRule);
    ...
    public static void shiftClockToMatchWith(VsqFileEx target, VsqFile tempo,
        double shift_seconds) {
        // テンポをリプレースする場合。
        // まずクロック値を、リプレース後のモノに置き換え
        for (int track = 1; track < target.Track.size(); track++) {
            // ノート・歌手イベントをシフト
            for (Iterator<VsqEvent> itr = target.Track.get(track)
                                                      .getEventIterator();
                    itr.hasNext();) {
                VsqEvent item = itr.next();
                ...
                double sec_start = target.getSecFromClock(clock) +
                    shift_seconds;
                double sec_end = target.getSecFromClock(clock +
                        item.ID.getLength()) + shift_seconds;
                ...
                if (item.ID.VibratoHandle != null) {
                    double sec_vib_start = target.getSecFromClock(clock +
                            item.ID.VibratoDelay) + shift_seconds;
            ...
            for (int j = 0; j < Utility.CURVE_USAGE.length; j++) {
                CurveType ct = Utility.CURVE_USAGE[j];
                Vector<BezierChain> list = target.AttachedCurves.get(track - 1)
                                                                .get(ct);
                ...
                for (Iterator<BezierChain> itr = list.iterator();
                    ...
                    for (Iterator<BezierPoint> itr2 = chain.points.iterator();
                        ...
                        PointD bse = new PointD(tempo.getClockFromSec(target.getSecFromClock(
                                        point.getBase().getX()) +
                                    shift_seconds), point.getBase().getY());
                        double rx = point.getBase().getX() +
                            point.controlRight.getX();
                        double new_rx = tempo.getClockFromSec(target.getSecFromClock(
                                    rx) + shift_seconds);
                        ...
                        double lx = point.getBase().getX() +
                            point.controlLeft.getX();
                        double new_lx = tempo.getClockFromSec(target.getSecFromClock(
                                    lx) + shift_seconds);
    ...
    private BMenuItem getMenuHiddenFlipCurveOnPianorollMode() {
        if (menuHiddenFlipCurveOnPianorollMode == null) {
            ...
            menuHiddenFlipCurveOnPianorollMode.setText(
                "Change pitch drawing mode");
        }
    ...
    private BMenu getMenuLyricCopyVibratoToPreset() {
        if (menuLyricCopyVibratoToPreset == null) {
            ...
            menuLyricCopyVibratoToPreset.setText(
                "Copy vibrato config to preset");
        }
    ...
    private BPanel getM_property_panel_container() {
        if (m_property_panel_container == null) {
            ...
            m_property_panel_container.setBorder(BorderFactory.createEmptyBorder(
                    0, 0, 0, 0));
        }
    ...
    private BPanel getPicturePositionIndicator() {
        if (picturePositionIndicator == null) {
            ...
            picturePositionIndicator.setBorder(BorderFactory.createEmptyBorder(
                    0, 0, 0, 0));
    ...
    private BMenuItem getMenuHiddenEditFlipToolPointerPencil() {
        if (menuHiddenEditFlipToolPointerPencil == null) {
            ...
            menuHiddenEditFlipToolPointerPencil.setText(
                "Change Tool Pointer / Pencil");
        }
    ...
    private BMenuItem getMenuHiddenEditFlipToolPointerEraser() {
        if (menuHiddenEditFlipToolPointerEraser == null) {
            ...
            menuHiddenEditFlipToolPointerEraser.setText(
                "Change Tool Pointer/ Eraser");
        }
    ...
    private WaveformZoomUiImpl getPanel2() {
        if (panelWaveformZoom == null) {
            ...
            panelWaveformZoom.setBorder(BorderFactory.createEmptyBorder(0, 0,
                    0, 0));
    ...
    enum ExtDragXMode {RIGHT,
        LEFT,
        NONE;
    }
    enum ExtDragYMode {UP,
        DOWN,
        NONE;
    }
    enum GameControlMode {DISABLED,
        NORMAL,
        KEYBOARD,
        CURSOR;
    }
    enum PositionIndicatorMouseDownMode {NONE,
        MARK_START,
        MARK_END,
        TEMPO,
        TIMESIG;
