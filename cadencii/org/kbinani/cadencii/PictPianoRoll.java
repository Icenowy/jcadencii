...
new Color( 181, 126, 123 ) };
        ...
        private final Font FONT_9PT = new Font( "SansSerif", java.awt.Font.PLAIN, AppManager.FONT_SIZE9 );
        /// <summary>
        /// 表情線の先頭部分のピクセル幅
        /// </summary>
...
try {
    ...
    for ( int i = 0; i <= 127; i++ ) {
        ...
        if ( odd2 == 0 || hilighted ) {
            ...
            g.drawString( VsqNote.getNoteString( i ), 42, y + half_track_height - AppManager.superFont8OffsetHeight + 1 );
        }
    ...
    if ( AppManager.drawOverSynthNameOnPianoroll ) {
        ...
        g.drawString( str, key_width + 10, 10 + AppManager.superFont50Height / 2 - AppManager.superFont50OffsetHeight + 1 );
    }
                ...
                if ( selected - 1 < AppManager.mDrawObjects.size() ) {
                    ...
                    for ( int j = j_start; j < c; j++ ) {
                        ...
                        if ( dobj.mType == DrawObjectType.Note ) {
                            ...
                            Font lyric_font = dobj.mIsSymbolProtected ? AppManager.superFont10Bold : AppManager.superFont10;
                            if ( dobj.mIsOverlapped ) {
                                ...
                                if ( show_lyrics ) {
                                    ...
                                    g.drawString( dobj.mText, x + 1, y + half_track_height - AppManager.superFont10OffsetHeight + 1 );
                                }
                            } else {
                                g.setColor( COLOR_R125G123B124 );
                                g.drawRect( x, y + 1, lyric_width, track_height - 1 );
                            ...
                            g.drawString( str, x + 1, y + half_track_height - AppManager.superFont10OffsetHeight + 1 );
                        } else {
                            ...
                            g.setFont( AppManager.superFont10 );
                            String str = dobj.mText;
                            g.drawString( str, x + 1, y + track_height + half_track_height - AppManager.superFont10OffsetHeight + 1 );
    ...
    if ( edit_mode == EditMode.ADD_ENTRY ) {
        ...
        String percent = rate + "%";
        Dimension size = Util.measureString( percent, AppManager.superFont9 );
        ...
        g.drawString(
            percent,
            pxArea.x + 3,
            pxArea.y + AppManager.superFont9Height / 2 - AppManager.superFont9OffsetHeight + 2 );
    }
