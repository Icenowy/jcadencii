        ...
        try {
            ...
            if ( fsys.isFileExists( path ) ) {
                try {
                    ...
                    Logger.write( FormGenerateKeySound.class + ".bgWork_DoWork; ex=" + ex0 + "\n" );
                }
            }
        } catch ( Exception ex ) {
            Logger.write( FormGenerateKeySound.class + ".bgWork_DoWork; ex=" + ex + "\n" );
...
if ( !fsys.isDirectoryExists( tempdir ) ) {
    try {
        ...
        Logger.write( FormGenerateKeySound.class + ".GenerateSinglePhone; ex=" + ex + "\n" );
...
try {
    ...
    if ( ww != null ) {
        try {
            ...
            Logger.write( FormGenerateKeySound.class + ".GenerateSinglePhone; ex=" + ex2 + "\n" );
