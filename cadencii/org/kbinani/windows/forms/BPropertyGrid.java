...
public class BPropertyGrid extends BPanel {
    ...
    public final BEvent<BPropertyValueChangedEventHandler> propertyValueChangedEvent =
        new BEvent<BPropertyValueChangedEventHandler>();
    ...
    private void updateGridComponent(Class<?> cls) {
        ...
        if (mCachedControllers.containsKey(cls.getName()) &&
                (mCachedControllers.get(cls.getName()) != null)) {
...
class BPropertyGridController {
    ...
    public void updateValue() {
        Object[] objs = (mView != null) ? mView.getSelectedObjects()
                                        : new Object[] {  };
     ...
     * @param descriptor
     */
    private int prepareCategory(int row_start_index, String category,
        Vector<XmlMember> members, PropertyDescriptor descriptor,
        ...
        if ((title_text == null) ||
                ((title_text != null) && title_text.equals(""))) {
            title_text = "Other";
        }
        ...
        splitter.setCursor(new Cursor(Cursor.W_RESIZE_CURSOR |
        ...
        for (XmlMember xm : members) {
            internal_rows += prepareRowComponent(this, mRoot, left, right, xm,
                descriptor, i);
            i++;
        }
        ...
        g.weighty = 0.0D;
        g.fill = GridBagConstraints.BOTH;
        left.setPreferredSize(new Dimension((mView == null) ? 60
                                                            : mView.getColumnWidth(),
                4));
        p.add(left, g);
        g.gridx = 1;
        g.gridy = 0;
        ...
        plus.leftSpacerConfig = new BPropertyGridExpandComponentConfig(mContentPane,
                sp, g_sp);
        plus.leftComponentConfig = new BPropertyGridExpandComponentConfig(mContentPane,
                p, g_p);
     ...
     *
     */
    private int prepareRowComponent(BPropertyGridController controller,
        BGridItem tree, Container left, Container right, XmlMember xm,
        PropertyDescriptor pd, int row_index) {
        ...
        if (child.converter != null) {
            if (child.converter.isStandardValuesSupported()) {
                ...
                cbox.setUnitSize(BPropertyGrid.WIDTH,
                    BPropertyGrid.DEFAULT_ROW_HEIGHT);
                // イベントハンドラ
                cbox.addItemListener(new ItemListener() {
                        ...
                        public void itemStateChanged(ItemEvent arg0) {
                            ...
                            if (!((indx < 0) &&
                                    (state_change == ItemEvent.DESELECTED)) &&
                                    (state_change != ItemEvent.SELECTED)) {
                                return;
                            }
            ...
            comp = cbox;
        } else if (cli_name.equals("boolean")) {
            final BPropertyGridComboBox cbox = new BPropertyGridComboBox(controller);
            cbox.addItem("True");
            cbox.addItem("False");
            cbox.setUnitSize(BPropertyGrid.WIDTH,
            ...
            comp = cbox;
                ...
                str.compare(cli_name, "int") || str.compare(cli_name, "long") ||
        ...
        if (comp != null) {
            ...
            sp.setPreferredSize(new Dimension(BPropertyGrid.SPACE,
                    BPropertyGrid.DEFAULT_ROW_HEIGHT));
            ...
            title.setPreferredSize(new Dimension(4,
                    BPropertyGrid.DEFAULT_ROW_HEIGHT));
            ...
            // 値を格納するコンポーネント
            comp.setPreferredSize(new Dimension(4,
                    BPropertyGrid.DEFAULT_ROW_HEIGHT));
            ...
            // 左側
            // ▶
            BPropertyGridExpandMark n_plus = new BPropertyGridExpandMark(controller,
                    false);
            ...
            n_title.setPreferredSize(new Dimension(4,
                    BPropertyGrid.DEFAULT_ROW_HEIGHT));
            ...
            n_value.setPreferredSize(new Dimension(4,
                    BPropertyGrid.DEFAULT_ROW_HEIGHT));
            ...
            // サブプロパティ用のプロパティ名
            GridBagConstraints g_sp = new GridBagConstraints();
            BPropertyGridLeftSpacer sp = new BPropertyGridLeftSpacer(controller,
                    n_plus);
            sp.setPreferredSize(new Dimension(4,
                    BPropertyGrid.DEFAULT_ROW_HEIGHT));
            controller.registPreferredHeightSpecified(sp);
            g_sp.gridx = 0;
            g_sp.gridy = 1;
            ...
            n_plus.leftComponentConfig = new BPropertyGridExpandComponentConfig(i_left,
                    n_left, g_n_left);
            n_plus.rightComponentConfig = new BPropertyGridExpandComponentConfig(i_right,
                    n_right, g_n_right);
            n_plus.leftSpacerConfig = new BPropertyGridExpandComponentConfig(i_left,
                    sp, g_sp);
            // サブアイテム
            controller.nextRow();
            ...
            for (XmlMember n_xm : n_member) {
                ...
                rows += prepareRowComponent(controller, child, n_left, n_right,
                    n_xm, n_pd, i);
                i++;
            }
    ...
    public void updateBackground(boolean force) {
        ...
        for (Iterator<Integer> itr = mComponents.keySet().iterator();
                itr.hasNext();) {
            ...
            Color c = ((actrow % 2) == 0) ? mView.getBackgroundEven()
                                          : mView.getBackgroundOdd();
    ...
    public void updateView() {
        ...
        // 高さの+1は最下段のスペーサの分
        mView.setPreferredSize(new Dimension(4,
                (mViewingRows * BPropertyGrid.DEFAULT_ROW_HEIGHT) + 1));
        doLayoutRecurse(mView);
        mView.revalidate();
    }
...
class BPropertyGridExpandComponentConfig {
    ...
    public BPropertyGridExpandComponentConfig(Container container,
        Component component, GridBagConstraints constraints) {
...
class BPropertyGridBottomSpacer extends JPanel {
    ...
    public void paint(Graphics g) {
        ...
        int width = getWidth();
        Color even = (view == null) ? BPropertyGrid.DEFAULT_BACKGROUND_EVEN
                                    : view.getBackgroundEven();
        Color odd = (view == null) ? BPropertyGrid.DEFAULT_BACKGROUND_ODD
                                   : view.getBackgroundOdd();
...
class BPropertyGridHeaderBase extends JPanel {
    ...
    private static int getStringDrawOffset(java.awt.Font font) {
        ...
        try {
            ...
            int w = size.width * 4;
            int h = size.height * 4;
            b = new java.awt.image.BufferedImage(w, h,
...
class BPropertyGridLeftSpacer extends JPanel {
    ...
    public BPropertyGridLeftSpacer(BPropertyGridController controller,
        BPropertyGridExpandMark owner) {
        mController = controller;
        mOwner = owner;
    }
...
class BPropertyGridExpandMark extends BPropertyGridHeaderBase {
     ...
     * ▶▼などと書かれたラベルを作る
     */
    public BPropertyGridExpandMark(final BPropertyGridController controller,
        ...
        setIcon(mIconExpand);
        this.setPreferredSize(new Dimension(BPropertyGrid.SPACE,
                BPropertyGrid.DEFAULT_ROW_HEIGHT));
        ...
        try {
            return ImageIO.read(new ByteArrayInputStream(
                    new byte[] {
                        ...
                        (byte) 82, (byte) 0, (byte) 0, (byte) 0, (byte) 9,
                        (byte) 0, (byte) 0, (byte) 0, (byte) 11, (byte) 8,
                        (byte) 6, (byte) 0, (byte) 0, (byte) 0, (byte) 173,
                        (byte) 89, (byte) 167, (byte) 27, (byte) 0, (byte) 0,
                        (byte) 0, (byte) 1, (byte) 115, (byte) 82, (byte) 71,
                        (byte) 66, (byte) 0, (byte) 174, (byte) 206, (byte) 28,
                        (byte) 233, (byte) 0, (byte) 0, (byte) 0, (byte) 4,
                        (byte) 103, (byte) 65, (byte) 77, (byte) 65, (byte) 0,
                        (byte) 0, (byte) 177, (byte) 143, (byte) 11, (byte) 252,
                        (byte) 97, (byte) 5, (byte) 0, (byte) 0, (byte) 0,
                        (byte)
(byte) 0, (byte) 0, (byte) 0, (byte) 0,
                        (byte) 73, (byte) 69, (byte) 78, (byte) 68, (byte) 174,
        ...
        try {
            return ImageIO.read(new ByteArrayInputStream(
                    new byte[] {
                        ...
                        (byte) 0, (byte) 58, (byte) 152, (byte) 0, (byte) 0,
                        (byte) 23, (byte) 112, (byte) 156, (byte) 186, (byte) 81,
                        (byte) 60, (byte) 0, (byte) 0, (byte) 0, (byte) 130,
                        (byte) 73, (byte) 68, (byte) 65, (byte) 84, (byte) 40,
                        (byte) 83, (byte) 99, (byte) 252, (byte) 255, (byte) 255,
                        (byte) 63, (byte) 3, (byte) 16, (byte) 51, (byte) 49,
                        (byte) 50, (byte) 50, (byte) 254, (byte) 99, (byte) 192,
                        (byte) 5, (byte) 254, (byte) 252, (byte) 249, (byte) 195,
                        (byte) 190, (byte) 116, (byte) 233, (byte) 210,
                        (byte) 59, (byte) 15, (byte) 31, (byte) 62, (byte) 244,
                        (byte) 132, (byte) 106, (byte) 0, (byte) 105, (byte) 66,
                        (byte) 193, (byte) 12, (byte) 32, (byte) 69, (byte) 51,
                        (byte) 102, (byte) 204, (byte) 248, (byte) 3, (byte) 194,
                        (byte) 59, (byte) 118, (byte) 236, (byte) 88, (byte) 247,
                        (byte) 233, (byte) 211, (byte) 39, (byte) 121,
                        (byte) 188, (byte) 138, (byte) 64, (byte) 10, (byte) 103,
                        (byte) 207, (byte) 158, (byte) 253, (byte) 245,
                        (byte) 194, (byte) 133, (byte) 11, (byte) 197,
                        (byte) 127, (byte) 255, (byte) 254, (byte) 101,
                        (byte) 129, (byte) 41, (byte) 70, (byte) 49, (byte) 9,
                        (byte) 102, (byte) 34, (byte) 136, (byte) 94, (byte) 181,
                        (byte) 106, (byte) 213, (byte) 133, (byte) 231,
                        (byte) 207, (byte) 159, (byte) 91, (byte) 129, (byte) 20,
                        (byte) 226, (byte) 84, (byte) 4, (byte) 82, (byte) 56,
                        (byte) 125, (byte) 250, (byte) 244, (byte) 255,
                        (byte) 15, (byte) 30, (byte) 60, (byte) 240, (byte) 33,
                        (byte) 207, (byte) 36, (byte) 130, (byte) 110,
                        (byte) 194, (byte) 235, (byte) 59, (byte) 130,
                        (byte) 225, (byte) 4, (byte) 114, (byte) 253, (byte) 191,
                        (byte) 127, (byte) 255, (byte) 152, (byte) 112, (byte) 5,
                        (byte) 36, (byte) 72, (byte) 28, (byte) 0, (byte) 0,
                        (byte) 152, (byte) 11, (byte) 213, (byte) 45, (byte) 224,
                        (byte) 5, (byte) 144, (byte) 0, (byte) 0, (byte) 0,
                        (byte) 0, (byte) 73, (byte) 69, (byte) 78, (byte) 68,
                        (byte) 174, (byte) 66, (byte) 96, (byte) 130,
                    }));
        } catch (Exception ex) {
            return null;
        }
...
class BPropertyGridComboBox extends JPanel implements ActionListener,
        ...
        this.addComponentListener(new ComponentListener() {
                ...
                public void componentResized(ComponentEvent arg0) {
                    if (windowDropdown.isVisible()) {
                        windowDropdown.setSize(getWidth(),
                            windowDropdown.getHeight());
                    }
                }
        ...
        try {
            return ImageIO.read(new ByteArrayInputStream(
                    new byte[] {
                        ...
                        (byte) 10, (byte) 26, (byte) 10, (byte) 0, (byte) 0,
                        (byte) 0, (byte) 13, (byte) 73, (byte) 72, (byte) 68,
                        (byte) 82, (byte) 0, (byte) 0, (byte) 0, (byte) 7,
                        (byte) 0, (byte) 0, (byte) 0, (byte) 6, (byte) 8,
                        (byte) 6, (byte) 0, (byte) 0, (byte) 0, (byte) 15,
                        (byte) 14, (byte) 132, (byte) 118, (byte) 0, (byte) 0,
                        (byte) 0, (byte) 1, (byte) 115, (byte) 82, (byte) 71,
                        (byte) 66, (byte) 0, (byte) 174, (byte) 206, (byte) 28,
                        (byte) 233, (byte) 0, (byte) 0, (byte) 0, (byte) 4,
                        (byte) 103, (byte) 65, (byte) 77, (byte) 65, (byte) 0,
                        ...
                        (byte) 0, (byte) 58, (byte) 152, (byte) 0, (byte) 0,
                        (byte) 23, (byte) 112, (byte) 156, (byte) 186, (byte) 81,
                        (byte) 60, (byte) 0, (byte) 0, (byte) 0, (byte) 100,
                        (byte) 73, (byte) 68, (byte) 65, (byte) 84, (byte) 24,
                        (byte) 87, (byte) 99, (byte) 252, (byte) 255, (byte) 255,
                        (byte) 63, (byte) 3, (byte) 78, (byte) 112, (byte) 247,
                        (byte) 238, (byte) 93, (byte) 199, (byte) 230,
                        (byte) 230, (byte) 230, (byte) 247, (byte) 245,
                        (byte) 245, (byte) 245, (byte) 223, (byte) 97,
                        (byte) 184, (byte) 165, (byte) 165, (byte) 229,
                        (byte) 237, (byte) 253, (byte) 7, (byte) 15, (byte) 108,
                        (byte) 25, (byte) 64, (byte) 58, (byte) 15, (byte) 28,
                        (byte) 56, (byte) 80, (byte) 89, (byte) 93, (byte) 93,
                        (byte) 253, (byte) 31, (byte) 134, (byte) 143, (byte) 28,
                        (byte) 57, (byte) 82, (byte) 8, (byte) 54, (byte) 17,
                        (byte) 68, (byte) 128, (byte) 240, (byte) 194,
                        (byte) 133, (byte) 11, (byte) 183, (byte) 130, (byte) 36,
                        (byte) 151, (byte) 47, (byte) 95, (byte) 190, (byte) 10,
                        (byte) 38, (byte) 6, (byte) 151, (byte) 124, (byte) 244,
                        (byte) 232, (byte) 145, (byte) 197, (byte) 244,
                        (byte) 233, (byte) 211, (byte) 79, (byte) 60, (byte) 121,
                        (byte) 242, (byte) 196, (byte) 4, (byte) 67, (byte) 18,
                        (byte) 36, (byte) 240, (byte) 234, (byte) 213, (byte) 43,
                        (byte) 13, (byte) 152, (byte) 4, (byte) 136, (byte) 6,
                        (byte) 0, (byte) 228, (byte) 53, (byte) 100, (byte) 110,
                        (byte) 59, (byte) 11, (byte) 255, (byte) 234, (byte) 0,
                        (byte) 0, (byte) 0, (byte) 0, (byte) 73, (byte) 69,
                        (byte) 78, (byte) 68, (byte) 174, (byte) 66, (byte) 96,
                        (byte) 130,
                    }));
        } catch (Exception ex) {
            return null;
    ...
    public void setSelectedIndex(int value) {
        ...
        if (old != mSelectedIndex) {
            ...
            if ((0 <= mSelectedIndex) &&
                    (mSelectedIndex < windowDropdown.getItemCount())) {
            ...
            if (oldv != null) {
                for (ItemListener l : mItemListeners) {
                    ItemEvent ie = new ItemEvent(this,
                            ItemEvent.ITEM_STATE_CHANGED, oldv,
            ...
            if (newv != null) {
                for (ItemListener l : mItemListeners) {
                    ItemEvent ie = new ItemEvent(this,
                            ItemEvent.ITEM_STATE_CHANGED, newv,
                            ItemEvent.SELECTED);
                    l.itemStateChanged(ie);
                }
            }
